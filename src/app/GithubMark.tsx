// Logo GitHub (mark officiel) — lucide-react ne fournit plus les icônes de MARQUES, et une icône
// générique de type « branche » ne se reconnaît pas d'un coup d'œil. `currentColor` : il suit le
// thème. `aria-hidden` car le lien qui l'entoure porte toujours son propre libellé.
// Extrait dans son fichier pour être partagé par l'en-tête de l'app et le hub de documentation.
