...
const RELEASES: Release[] = [
  {
    ...
    tagline: {
      en: 'embed() now returns a handle, so a widget can be unmounted, driven and observed — and an answer says which of your notes produced it. The SDK demo is bilingual too, with English as its default, and the widget’s own labels follow the page instead of always speaking French.',
      fr: 'embed() rend désormais une poignée : un widget se démonte, se pilote et s’observe — et une réponse dit laquelle de vos fiches l’a produite. La démo du SDK est bilingue par ailleurs, avec l’anglais en défaut, et les libellés du widget suivent la page au lieu de parler français en toutes circonstances.',
    },
    groups: [
      {
