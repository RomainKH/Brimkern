      ...
      <div className="docs-shell" style={{ maxWidth: 880 }}>
        ...
        <main style={{ marginTop: 28 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 14, margin: '0 0 44px' }}>
            <div className="card" style={{ padding: '18px 20px', background: '#161514', border: '1px solid rgba(255, 255, 255, 0.1)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
                <Zap size={18} style={{ color: '#ef4444' }} />
                <h3 style={{ margin: 0, fontSize: 15, fontWeight: 700, color: '#fbfaf7' }}>{t('Zero Token Cost', 'Zéro Coût de Token')}</h3>
              </div>
              <p style={{ margin: 0, fontSize: 13, lineHeight: 1.55, color: '#dcd8cf' }}>
            ...
            <div className="card" style={{ padding: '18px 20px', background: '#161514', border: '1px solid rgba(255, 255, 255, 0.1)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
                ...
                <h3 style={{ margin: 0, fontSize: 15, fontWeight: 700, color: '#fbfaf7' }}>{t('Native Stdio MCP', 'Serveur MCP Stdio')}</h3>
              </div>
              <p style={{ margin: 0, fontSize: 13, lineHeight: 1.55, color: '#dcd8cf' }}>
            ...
            <div className="card" style={{ padding: '18px 20px', background: '#161514', border: '1px solid rgba(255, 255, 255, 0.1)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
                ...
                <h3 style={{ margin: 0, fontSize: 15, fontWeight: 700, color: '#fbfaf7' }}>{t('Offline & Private', 'Privé & Hors-ligne')}</h3>
              </div>
              <p style={{ margin: 0, fontSize: 13, lineHeight: 1.55, color: '#dcd8cf' }}>
          ...
          <section style={{ margin: '48px 0', borderTop: '1px solid rgba(255, 255, 255, 0.08)', paddingTop: 32 }}>
            <span style={{ fontFamily: 'var(--font-mono)', fontSize: 11, fontWeight: 700, color: '#ef4444', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
              01 · {t('Model Context Protocol', 'Protocole MCP')}
            </span>
            <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: 24, fontWeight: 800, margin: '8px 0 12px', color: '#fbfaf7' }}>
              {t('Plug Brimkern as an MCP Tool Server', 'Connectez Brimkern comme serveur d’outils MCP')}
            </h2>
            <p style={{ color: '#dcd8cf', fontSize: 14.5, lineHeight: 1.6, margin: '0 0 16px' }}>
              {t(
            ...
            <p style={{ color: '#dcd8cf', fontSize: 13.5, margin: '14px 0 8px', fontWeight: 600 }}>
            ...
            <div style={{ background: '#121211', border: '1px solid rgba(255, 255, 255, 0.08)', borderRadius: 8, padding: '14px 18px', marginTop: 14 }}>
              <p style={{ margin: 0, fontSize: 13, color: '#fbfaf7', fontWeight: 600 }}>{t('Exposed MCP Tools:', 'Outils MCP exposés :')}</p>
              <ul style={{ margin: '8px 0 0', paddingLeft: 20, color: '#dcd8cf', fontSize: 13, lineHeight: 1.6 }}>
