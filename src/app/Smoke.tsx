...
// Fumée néon WebGL GPU réactive au défilement.
//
...
// Toile FIXE plein écran, le défilement entre dans le shader (`scroll`) : la fumée dérive vers le haut
// quand on descend.
// Garde-fous :
// - au plus 40 % de la résolution CSS et ~220 000 pixels, 4 octaves, ~24-60 i/s ;
