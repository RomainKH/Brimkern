...
status()  // 'unavailable' (${t('no WebGPU', 'pas de WebGPU')}) | 'idle' | 'loading' | 'ready' | 'error'`}</Code>
      ...
      <Section id="pinning" title={t('Versions & CDNs', 'Versions & CDN')}>
        ...
        <Code lang="url">{`${SITE_URL}/sdk-0.4.1.js   ${t('instead of', 'au lieu de')}   ${SITE_URL}/sdk.js

<!-- ${t('or from the npm CDNs', 'ou depuis les CDN npm')} -->
https://unpkg.com/brimkern@0.4.1/dist/brimkern.iife.js
https://cdn.jsdelivr.net/npm/brimkern@0.4.1/dist/brimkern.iife.js`}</Code>
      </Section>
