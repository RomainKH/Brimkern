// Minimal ZIP (store-only, no compression) so a converted BWP can be downloaded as a single
// .bwp.zip and re-imported later — dependency-free, on purpose (this project ships its own
