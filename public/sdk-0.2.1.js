"use strict";(()=>{var Pn=Object.defineProperty;var ae=(c,e,r)=>()=>{if(r)throw r[0];try{return c&&(e=c(c=0)),e}catch(t){throw r=[t],t}};var lr=(c,e)=>{for(var r in e)Pn(c,r,{get:e[r],enumerable:!0})};function Be(c){let e=new Float32Array(1),r=new Uint32Array(e.buffer);e[0]=c;let t=r[0],n=t>>16&32768,s=(t>>23&255)-127+15,a=t&8388607;return s<=0?n:s>=31?n|31743:(a=(a>>13)+(a>>12&1),a===1024&&(a=0,s+=1),n|s<<10|a&1023)}function pe(c){let e=c>>15&1,r=c>>10&31,t=c&1023,n;return r===0?n=t*59604645e-15:r===31?n=t?NaN:1/0:n=(1+t/1024)*2**(r-15),e===1?-n:n}var He=ae(()=>{"use strict"});function ke(c){let e=c.length;if(e%ye!==0)throw new Error(`q4web: length ${e} not a multiple of ${ye}`);let r=e/ye,t=new Uint8Array(e/2),n=new Uint16Array(r),s=new Uint16Array(r);for(let a=0;a<r;a++){let i=a*ye,o=1/0,u=-1/0;for(let m=0;m<ye;m++){let b=c[i+m];b<o&&(o=b),b>u&&(u=b)}let l=(u-o)/15||1e-8,d=Be(l),f=Be(o);n[a]=d,s[a]=f;let p=pe(d)||1e-8,g=pe(f);for(let m=0;m<ye;m++){let b=Math.round((c[i+m]-g)/p);b=b<0?0:b>15?15:b;let A=i+m;(m&1)===0?t[A>>1]=b:t[A>>1]|=b<<4}}return{nibbles:t,scales:n,mins:s,nElems:e}}function qe(c,e){let r=e/ye,t=e/2,n=c.slice(0,t),s=new Uint16Array(r),a=new Uint16Array(r),i=new DataView(c.buffer,c.byteOffset);for(let o=0;o<r;o++)s[o]=i.getUint16(t+o*2,!0);for(let o=0;o<r;o++)a[o]=i.getUint16(t+r*2+o*2,!0);return{nibbles:n,scales:s,mins:a,nElems:e}}function ge(c){let e=new Float32Array(c.nElems),r=c.nElems/ye;for(let t=0;t<r;t++){let n=pe(c.scales[t]),s=pe(c.mins[t]),a=t*ye;for(let i=0;i<ye;i++){let o=a+i,u=c.nibbles[o>>1],l=(i&1)===0?u&15:u>>4;e[o]=l*n+s}}return e}var ye,Pt=ae(()=>{"use strict";He();ye=32});function Pe(c){let e=c.length;if(e%Ae!==0)throw new Error(`q8web: length ${e} not a multiple of ${Ae}`);let r=e/Ae,t=new Int8Array(e),n=new Uint16Array(r);for(let s=0;s<r;s++){let a=s*Ae,i=0;for(let d=0;d<Ae;d++){let f=Math.abs(c[a+d]);f>i&&(i=f)}let o=i/127||1e-8,u=Be(o);n[s]=u;let l=pe(u)||1e-8;for(let d=0;d<Ae;d++){let f=Math.round(c[a+d]/l);f=f<-127?-127:f>127?127:f,t[a+d]=f}}return{codes:t,scales:n,nElems:e}}function Oe(c,e){let r=e/Ae,t=new Int8Array(c.buffer.slice(c.byteOffset,c.byteOffset+e)),n=new Uint16Array(r),s=new DataView(c.buffer,c.byteOffset);for(let a=0;a<r;a++)n[a]=s.getUint16(e+a*2,!0);return{codes:t,scales:n,nElems:e}}function he(c){let e=new Float32Array(c.nElems),r=c.nElems/Ae;for(let t=0;t<r;t++){let n=pe(c.scales[t]),s=t*Ae;for(let a=0;a<Ae;a++)e[s+a]=c.codes[s+a]*n}return e}var Ae,xt=ae(()=>{"use strict";He();Ae=32});function yr(c){let e=c.length;if(e%xe!==0)throw new Error(`q3web: length ${e} not a multiple of ${xe}`);let r=e/xe,t=new Uint32Array(e/16),n=new Uint32Array(e/32),s=new Uint16Array(r),a=new Uint16Array(r);for(let i=0;i<r;i++){let o=i*xe,u=1/0,l=-1/0;for(let b=0;b<xe;b++){let A=c[o+b];A<u&&(u=A),A>l&&(l=A)}let d=(l-u)/7||1e-8,f=Be(d),p=Be(u);s[i]=f,a[i]=p;let g=pe(f)||1e-8,m=pe(p);for(let b=0;b<xe;b++){let A=Math.round((c[o+b]-m)/g);A=A<0?0:A>7?7:A;let q=o+b;t[q>>4]|=(A&3)<<(q&15)*2,n[q>>5]|=A>>2<<(q&31)}}return{lo:t,hi:n,scales:s,mins:a,nElems:e}}function Le(c,e){let r=e/xe,t=e/16,n=e/32,s=t*4,a=n*4,i=new DataView(c.buffer,c.byteOffset),o=new Uint32Array(t),u=new Uint32Array(n),l=new Uint16Array(r),d=new Uint16Array(r);for(let g=0;g<t;g++)o[g]=i.getUint32(g*4,!0);for(let g=0;g<n;g++)u[g]=i.getUint32(s+g*4,!0);let f=s+a,p=f+r*2;for(let g=0;g<r;g++)l[g]=i.getUint16(f+g*2,!0);for(let g=0;g<r;g++)d[g]=i.getUint16(p+g*2,!0);return{lo:o,hi:u,scales:l,mins:d,nElems:e}}function De(c){let e=new Float32Array(c.nElems),r=c.nElems/xe;for(let t=0;t<r;t++){let n=pe(c.scales[t]),s=pe(c.mins[t]),a=t*xe;for(let i=0;i<xe;i++){let o=a+i,u=c.lo[o>>4]>>(o&15)*2&3|(c.hi[o>>5]>>(o&31)&1)<<2;e[o]=u*n+s}}return e}var xe,Ut=ae(()=>{"use strict";He();xe=32});var kr,Ar,Pr=ae(()=>{"use strict";kr={matmul:`
...
No reference note matches this question. Say that you do not have this information: do not guess.`;let t=c.map((s,a)=>`[${a+1}]${s.title?` ${s.title}`:""}
${s.text}`).join(`
...
${d}`:l,sources:[],conversationnel:!1}),pinned:n([...s,...c.examples||[]])};let a=pr(mr(c.knowledge)),i=c.knowledgeBudget??1200,o=Ie(c),u=o?t+`
...
The user message may include reference notes between --- markers. When it does, answer from those notes and quote their figures exactly. When it says no note matches, say you do not have that information.`;return{system:()=>u,userTurn:(l,d)=>{let f=gr(l,a,i);if(d&&!f.length)return{text:`${l}
...
- Size EU 41: 26.0 cm (US 8.0)`)],"I wear a 41, what is that in cm?"),assistant:"A size 41 is 26.0 cm."},{user:r([e("Returns","Returns are free within 14 days. Refunds are issued within 3 working days.")],"How long do I have to return an item?"),assistant:"You have 14 days to return an item."},{user:r([],"Who won the 1998 World Cup?"),assistant:"I do not have that information in my notes."},{user:t([],"Are you a robot?"),assistant:"I am an automated assistant, yes. How can I help?"}]}function bn(c={}){Ht(c);let e=We(c.model),r=c.maxTokens||220,t=c.knowledge,n=ft(c),s=Ie(c),a=Ve(c.history),i=[],o=hn(),u=!1,l=!1,d=!1,f=()=>c.temperature??(t?.25:.55),p=et(c.tools),g=m=>{if(u)throw new Error(`brimkern: ${m} impossible pendant une g\xE9n\xE9ration`)};return{async ask(m,b={}){if(l)throw new Error("session d\xE9truite");if(u)throw new Error("g\xE9n\xE9ration d\xE9j\xE0 en cours sur cette session");u=!0,a.push({role:"user",content:m}),o.emit("message",{role:"user",content:m});try{let A=await At(p,m,s);for(let v of A)o.emit("tool",v);let{text:q,sources:O,conversationnel:F}=n.userTurn(m,tt(A,s));i=O,b.onSources?.(O);let R=[...a.slice(0,-1),{role:"user",content:q}],K=await $e();await K.preload(e,(v,h)=>o.emit("progress",v,h)),d||(d=!0,o.emit("ready"));let k={url:e,history:R,system:n.system(m),maxTokens:r,temperature:f(),pinned:n.pinned},w=await K.turn(k,b.onToken,b.signal);return b.signal?.aborted?(a.pop(),""):(F&&kt(w,s)&&(w=vn[s?"fr":"en"].aide),a.push({role:"assistant",content:w}),o.emit("message",{role:"assistant",content:w,sources:O}),w)}catch(A){throw a.pop(),o.emit("error",A instanceof Error?A:new Error(String(A))),A}finally{u=!1}},reset(){a=[],i=[]},destroy(){l=!0,a=[],i=[],o.clear()},get history(){return a.slice()},get lastSources(){return i.slice()},setHistory(m){g("setHistory"),a=Ve(m)},setKnowledge(m){g("setKnowledge"),t=m,n=ft({...c,knowledge:m}),i=[]},on:o.on}}function Gs(){if(document.getElementById("bk-style"))return;let c=document.createElement("style");c.id="bk-style",c.textContent=`
