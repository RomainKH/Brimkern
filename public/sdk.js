"use strict";(()=>{var Ir=Object.defineProperty;var ne=(d,e,r)=>()=>{if(r)throw r[0];try{return d&&(e=d(d=0)),e}catch(t){throw r=[t],t}};var Qt=(d,e)=>{for(var r in e)Ir(d,r,{get:e[r],enumerable:!0})};function xe(d){let e=new Float32Array(1),r=new Uint32Array(e.buffer);e[0]=d;let t=r[0],n=t>>16&32768,a=(t>>23&255)-127+15,s=t&8388607;return a<=0?n:a>=31?n|31743:(s=(s>>13)+(s>>12&1),s===1024&&(s=0,a+=1),n|a<<10|s&1023)}function de(d){let e=d>>15&1,r=d>>10&31,t=d&1023,n;return r===0?n=t*59604645e-15:r===31?n=t?NaN:1/0:n=(1+t/1024)*2**(r-15),e===1?-n:n}var Re=ne(()=>{"use strict"});function Ge(d){let e=d.length;if(e%ye!==0)throw new Error(`q4web: length ${e} not a multiple of ${ye}`);let r=e/ye,t=new Uint8Array(e/2),n=new Uint16Array(r),a=new Uint16Array(r);for(let s=0;s<r;s++){let i=s*ye,o=1/0,u=-1/0;for(let m=0;m<ye;m++){let b=d[i+m];b<o&&(o=b),b>u&&(u=b)}let c=(u-o)/15||1e-8,l=xe(c),f=xe(o);n[s]=l,a[s]=f;let g=de(l)||1e-8,p=de(f);for(let m=0;m<ye;m++){let b=Math.round((d[i+m]-p)/g);b=b<0?0:b>15?15:b;let k=i+m;(m&1)===0?t[k>>1]=b:t[k>>1]|=b<<4}}return{nibbles:t,scales:n,mins:a,nElems:e}}function _e(d,e){let r=e/ye,t=e/2,n=d.slice(0,t),a=new Uint16Array(r),s=new Uint16Array(r),i=new DataView(d.buffer,d.byteOffset);for(let o=0;o<r;o++)a[o]=i.getUint16(t+o*2,!0);for(let o=0;o<r;o++)s[o]=i.getUint16(t+r*2+o*2,!0);return{nibbles:n,scales:a,mins:s,nElems:e}}function pe(d){let e=new Float32Array(d.nElems),r=d.nElems/ye;for(let t=0;t<r;t++){let n=de(d.scales[t]),a=de(d.mins[t]),s=t*ye;for(let i=0;i<ye;i++){let o=s+i,u=d.nibbles[o>>1],c=(i&1)===0?u&15:u>>4;e[o]=c*n+a}}return e}var ye,st=ne(()=>{"use strict";Re();ye=32});function Be(d){let e=d.length;if(e%ke!==0)throw new Error(`q8web: length ${e} not a multiple of ${ke}`);let r=e/ke,t=new Int8Array(e),n=new Uint16Array(r);for(let a=0;a<r;a++){let s=a*ke,i=0;for(let l=0;l<ke;l++){let f=Math.abs(d[s+l]);f>i&&(i=f)}let o=i/127||1e-8,u=xe(o);n[a]=u;let c=de(u)||1e-8;for(let l=0;l<ke;l++){let f=Math.round(d[s+l]/c);f=f<-127?-127:f>127?127:f,t[s+l]=f}}return{codes:t,scales:n,nElems:e}}function Fe(d,e){let r=e/ke,t=new Int8Array(d.buffer.slice(d.byteOffset,d.byteOffset+e)),n=new Uint16Array(r),a=new DataView(d.buffer,d.byteOffset);for(let s=0;s<r;s++)n[s]=a.getUint16(e+s*2,!0);return{codes:t,scales:n,nElems:e}}function me(d){let e=new Float32Array(d.nElems),r=d.nElems/ke;for(let t=0;t<r;t++){let n=de(d.scales[t]),a=t*ke;for(let s=0;s<ke;s++)e[a+s]=d.codes[a+s]*n}return e}var ke,ot=ne(()=>{"use strict";Re();ke=32});function Xt(d){let e=d.length;if(e%Ae!==0)throw new Error(`q3web: length ${e} not a multiple of ${Ae}`);let r=e/Ae,t=new Uint32Array(e/16),n=new Uint32Array(e/32),a=new Uint16Array(r),s=new Uint16Array(r);for(let i=0;i<r;i++){let o=i*Ae,u=1/0,c=-1/0;for(let b=0;b<Ae;b++){let k=d[o+b];k<u&&(u=k),k>c&&(c=k)}let l=(c-u)/7||1e-8,f=xe(l),g=xe(u);a[i]=f,s[i]=g;let p=de(f)||1e-8,m=de(g);for(let b=0;b<Ae;b++){let k=Math.round((d[o+b]-m)/p);k=k<0?0:k>7?7:k;let B=o+b;t[B>>4]|=(k&3)<<(B&15)*2,n[B>>5]|=k>>2<<(B&31)}}return{lo:t,hi:n,scales:a,mins:s,nElems:e}}function ut(d,e){let r=e/Ae,t=e/16,n=e/32,a=t*4,s=n*4,i=new DataView(d.buffer,d.byteOffset),o=new Uint32Array(t),u=new Uint32Array(n),c=new Uint16Array(r),l=new Uint16Array(r);for(let p=0;p<t;p++)o[p]=i.getUint32(p*4,!0);for(let p=0;p<n;p++)u[p]=i.getUint32(a+p*4,!0);let f=a+s,g=f+r*2;for(let p=0;p<r;p++)c[p]=i.getUint16(f+p*2,!0);for(let p=0;p<r;p++)l[p]=i.getUint16(g+p*2,!0);return{lo:o,hi:u,scales:c,mins:l,nElems:e}}function We(d){let e=new Float32Array(d.nElems),r=d.nElems/Ae;for(let t=0;t<r;t++){let n=de(d.scales[t]),a=de(d.mins[t]),s=t*Ae;for(let i=0;i<Ae;i++){let o=s+i,u=d.lo[o>>4]>>(o&15)*2&3|(d.hi[o>>5]>>(o&31)&1)<<2;e[o]=u*n+a}}return e}var Ae,Zt=ne(()=>{"use strict";Re();Ae=32});var er,tr,rr=ne(()=>{"use strict";er={matmul:`
	...
	fn main(@builtin(global_invocation_id) gid: vec3<u32>) {
		...
		c[row * d.n + col] = acc.x + acc.y + acc.z + acc.w;
	}`});var Qe,nr=ne(()=>{"use strict";Qe=class{constructor(e){this.sets=[];this.cur=0;this.next=0;this.names=[];this.acc=new Map;this.dropped=0;this.pending=[];this.fenetre=0;this.device=e;let r=globalThis;for(let t=0;t<2;t++)this.sets.push({qs:e.createQuerySet({type:"timestamp",count:4096}),resolve:e.createBuffer({size:4096*8,usage:r.GPUBufferUsage.QUERY_RESOLVE|r.GPUBufferUsage.COPY_SRC}),read:e.createBuffer({size:4096*8,usage:r.GPUBufferUsage.COPY_DST|r.GPUBufferUsage.MAP_READ}),busy:!1})}slot(e){if(this.next+2>4096&&(this.rotate(),this.next+2>4096))return this.dropped++,null;let r=this.sets[this.cur];if(r.busy)return this.dropped++,null;let t=this.next;return this.next+=2,this.names.push(e),{querySet:r.qs,beginningOfPassWriteIndex:t,endOfPassWriteIndex:t+1}}rotate(){let e=this.cur,r=this.sets[e],t=this.names,n=this.next;if(this.cur=(this.cur+1)%2,this.next=0,this.names=[],!n||r.busy)return;r.busy=!0;let a=this.fenetre,s=this.device.createCommandEncoder();s.resolveQuerySet(r.qs,0,n,r.resolve,0),s.copyBufferToBuffer(r.resolve,0,r.read,0,n*8),this.device.queue.submit([s.finish()]);let i=globalThis,o=r.read.mapAsync(i.GPUMapMode.READ,0,n*8).then(()=>{let u=new BigUint64Array(r.read.getMappedRange(0,n*8).slice(0));if(r.read.unmap(),a===this.fenetre)for(let c=0;c<t.length;c++){let l=u[c*2],f=u[c*2+1];if(!l||!f||f<=l)continue;let g=Number(f-l),p=this.acc.get(t[c]);p?(p.calls++,p.ns+=g):this.acc.set(t[c],{calls:1,ns:g})}}).catch(()=>{}).finally(()=>{r.busy=!1});this.pending.push(o)}async report(){this.rotate();let e=this.pending;this.pending=[],await Promise.all(e);let r=0,t=0;for(let a of this.acc.values())r+=a.ns,t+=a.calls;return{passes:[...this.acc.entries()].map(([a,s])=>({name:a,calls:s.calls,totalMs:s.ns/1e6,meanUs:s.ns/s.calls/1e3,share:r?s.ns/r:0,reliable:s.calls>=50})).sort((a,s)=>s.totalMs-a.totalMs),totalMs:r/1e6,samples:t,dropped:this.dropped,quantumUs:100}}reset(){this.fenetre++,this.acc.clear(),this.dropped=0}destroy(){for(let e of this.sets)try{e.qs.destroy(),e.resolve.destroy(),e.read.destroy()}catch{}this.sets=[]}}});function en(){if(ar!==null)return ar;try{let d=globalThis.__brimkernSearch;if(typeof d=="string")return d}catch{}try{return typeof location<"u"?location.search:""}catch{return""}}function oe(d){try{return new URLSearchParams(en()).get(d)}catch{return null}}var ar,ir=ne(()=>{"use strict";ar=null});function be(d){let e=d>>15&1,r=d>>10&31,t=d&1023,n;return r===0?n=t*59604645e-15:r===31?n=65504:n=(1+t/1024)*2**(r-15),e===1?-n:n}function Se(d){let e=new Float32Array(1),r=new Uint32Array(e.buffer);e[0]=d;let t=r[0],n=t>>16&32768,a=(t>>23&255)-127+15,s=t&8388607;return a<=0?n:a>=31?n|31743:(s=(s>>13)+(s>>12&1),s===1024&&(s=0,a+=1),n|a<<10|s&1023)}function tn(d,e){let r=new Float32Array(e*256),t=new DataView(d.buffer,d.byteOffset);for(let n=0;n<e;n++){let a=n*144,s=be(t.getUint16(a,!0)),i=be(t.getUint16(a+2,!0)),o=f=>{let g=p=>d[a+4+p];return f<4?[g(f)&63,g(f+4)&63]:[g(f+4)&15|g(f-4)>>6<<4,g(f+4)>>4|g(f)>>6<<4]},u=n*256,c=0,l=0;for(let f=0;f<256;f+=64){let[g,p]=o(c),m=s*g,b=i*p,[k,B]=o(c+1),O=s*k,q=i*B;for(let C=0;C<32;C++){let j=d[a+16+l+C];r[u+f+C]=m*(j&15)-b,r[u+f+32+C]=O*(j>>4)-q}l+=32,c+=2}}return r}function De(d){return d>127?d-256:d}function rn(d,e){let r=new Float32Array(e*32),t=new DataView(d.buffer,d.byteOffset);for(let n=0;n<e;n++){let a=n*34,s=be(t.getUint16(a,!0));for(let i=0;i<32;i++)r[n*32+i]=s*De(d[a+2+i])}return r}function nn(d,e){let r=new Float32Array(e*32),t=new DataView(d.buffer,d.byteOffset);for(let n=0;n<e;n++){let a=n*22,s=be(t.getUint16(a,!0)),i=t.getUint32(a+2,!0);for(let o=0;o<16;o++){let u=d[a+6+o],c=i>>>o<<4&16,l=i>>>o+12&16;r[n*32+o]=s*((u&15|c)-16),r[n*32+o+16]=s*((u>>4|l)-16)}}return r}function an(d,e){let r=new Float32Array(e*32),t=new DataView(d.buffer,d.byteOffset);for(let n=0;n<e;n++){let a=n*18,s=be(t.getUint16(a,!0));for(let i=0;i<16;i++){let o=d[a+2+i];r[n*32+i]=s*((o&15)-8),r[n*32+i+16]=s*((o>>4)-8)}}return r}function sn(d,e){let r=new Float32Array(e*256),t=new DataView(d.buffer,d.byteOffset);for(let n=0;n<e;n++){let a=n*176,s=be(t.getUint16(a,!0)),i=be(t.getUint16(a+2,!0)),o=p=>{let m=b=>d[a+4+b];return p<4?[m(p)&63,m(p+4)&63]:[m(p+4)&15|m(p-4)>>6<<4,m(p+4)>>4|m(p)>>6<<4]},u=n*256,c=0,l=0,f=1,g=2;for(let p=0;p<256;p+=64){let[m,b]=o(c),k=s*m,B=i*b,[O,q]=o(c+1),C=s*O,j=i*q;for(let A=0;A<32;A++){let w=d[a+48+l+A],v=d[a+16+A];r[u+p+A]=k*((w&15)+(v&f?16:0))-B,r[u+p+32+A]=C*((w>>4)+(v&g?16:0))-j}l+=32,c+=2,f<<=2,g<<=2}}return r}function on(d,e){let r=new Float32Array(e*256),t=new DataView(d.buffer,d.byteOffset);for(let n=0;n<e;n++){let a=n*210,s=be(t.getUint16(a+208,!0)),i=n*256;for(let o=0;o<2;o++){let u=a+o*64,c=a+128+o*32,l=a+192+o*8,f=i+o*128;for(let g=0;g<32;g++){let p=g/16|0,m=d[u+g],b=d[u+g+32],k=d[c+g],B=(m&15|(k>>0&3)<<4)-32,O=(b&15|(k>>2&3)<<4)-32,q=(m>>4|(k>>4&3)<<4)-32,C=(b>>4|(k>>6&3)<<4)-32;r[f+g]=s*De(d[l+p])*B,r[f+g+32]=s*De(d[l+p+2])*O,r[f+g+64]=s*De(d[l+p+4])*q,r[f+g+96]=s*De(d[l+p+6])*C}}}return r}function Oe(d,e,r,t,n){let a=new Float32Array(r*n);for(let s=0;s<r;s++)for(let i=0;i<n;i++){let o=0;for(let u=0;u<t;u++)o+=d[s*t+u]*e[u*n+i];a[s*n+i]=o}return a}function qe(d,e,r,t,n=1e-5,a=!1){let s=new Float32Array(r*t);for(let i=0;i<r;i++){let o=0;for(let c=0;c<t;c++)o+=d[i*t+c]**2;let u=1/Math.sqrt(o/t+n);for(let c=0;c<t;c++)s[i*t+c]=d[i*t+c]*u*(a?1+e[c]:e[c])}return s}function un(d,e,r,t,n,a,s){let i=new Float32Array(d.length),o=t/2,u=a[0],c=a[0]+a[1];for(let l=0;l<r;l++){let f=Math.floor(l/n),g=l*t;for(let p=0;p<o;p++){let m=p<u?0:p<c?1:2,k=e[f*3+m]/s**(2*p/t),B=Math.cos(k),O=Math.sin(k),q=d[g+p],C=d[g+p+o];i[g+p]=q*B-C*O,i[g+p+o]=C*B+q*O}}return i}function Ve(d,e,r,t,n=0,a=1e4,s){let i=new Float32Array(d.length),o=r/2;for(let u=0;u<e;u++){let c=n+Math.floor(u/t),l=u*r;for(let f=0;f<o;f++){let g=c/(a**(2*f/r)*(s?s[f]:1)),p=Math.cos(g),m=Math.sin(g),b=d[l+2*f],k=d[l+2*f+1];i[l+2*f]=b*p-k*m,i[l+2*f+1]=k*p+b*m}}return i}function cn(d,e,r,t,n,a=0,s=1e4){let i=new Float32Array(d.length),o=t/2;for(let u=0;u<r;u++){let c=a+Math.floor(u/n),l=u*t;for(let f=0;f<o;f++){let g=c/(s**(2*f/t)*e[f]),p=Math.cos(g),m=Math.sin(g),b=d[l+f],k=d[l+f+o];i[l+f]=b*p-k*m,i[l+f+o]=k*p+b*m}}return i}function Le(d,e,r,t,n=0,a=1e4){let s=new Float32Array(d.length),i=r/2;for(let o=0;o<e;o++){let u=n+Math.floor(o/t),c=o*r;for(let l=0;l<i;l++){let f=u/a**(2*l/r),g=Math.cos(f),p=Math.sin(f),m=d[c+l],b=d[c+l+i];s[c+l]=m*g-b*p,s[c+l+i]=b*g+m*p}}return s}function ct(d,e,r){return d.map((t,n)=>t+e[n%r])}function lt(d,e,r,t=!0){let n=t?d.windowPerLayer?.[r]??d.window??0:0,a=d.ropeThetaPerLayer?.[r]??d.ropeTheta,s=d.skipRopePerLayer?.[r]??d.skipRope??!1;return{...d,seq:e,window:n,ropeTheta:a,skipRope:s}}function ve(d,e,r,t,n,a,s,i=0,o,u=0,c=0){let l=new Float32Array(t*n*s),f=o??1/Math.sqrt(s),g=m=>u>0?u*Math.tanh(m/u):m,p=n/a;for(let m=0;m<t;m++)for(let b=0;b<n;b++){let k=Math.floor(b/p),B=(m*n+b)*s,O=i+m,q=c>0?Math.max(0,O+1-c):0,C=[],j=-1/0;for(let w=q;w<=O;w++){let v=(w*a+k)*s,h=0;for(let y=0;y<s;y++)h+=d[B+y]*e[v+y];let x=g(h*f);C[w]=x,x>j&&(j=x)}let A=0;for(let w=q;w<=O;w++)C[w]=Math.exp(C[w]-j),A+=C[w];for(let w=q;w<=O;w++){let v=C[w]/A,h=(w*a+k)*s;for(let x=0;x<s;x++)l[B+x]+=v*r[h+x]}}return l}function sr(d){return .5*d*(1+Math.tanh(.7978845608*(d+.044715*d*d*d)))}function dt(d,e,r){let{seq:t,d:n,nHeads:a,nKvHeads:s,headDim:i,ffn:o,ropeTheta:u,eps:c}=e,l=s*i,f=a*i,g=e.rmsGainOnePlus===!0,p=e.attnLogitSoftcap??0,m=qe(d,r.attnNorm,t,n,c,g),b=Oe(m,r.wq,t,n,f),k=Oe(m,r.wk,t,n,l),B=Oe(m,r.wv,t,n,l);r.bq&&(b=ct(b,r.bq,f)),r.bk&&(k=ct(k,r.bk,l)),r.bv&&(B=ct(B,r.bv,l)),r.qNorm&&(b=qe(b,r.qNorm,t*a,i,c,g)),r.kNorm&&(k=qe(k,r.kNorm,t*s,i,c,g));let O=Le(b,t*a,i,a,0,u),q=Le(k,t*s,i,s,0,u),C=ve(O,q,B,t,a,s,i,0,e.attnScale,p),j=Oe(C,r.wo,t,f,n);r.postAttnNorm&&(j=qe(j,r.postAttnNorm,t,n,c,g));let A=d.map((P,U)=>P+j[U]),w=qe(A,r.ffnNorm,t,n,c,g),v=Oe(w,r.wgate,t,n,o),h=Oe(w,r.wup,t,n,o),x=e.act==="gelu"?v.map((P,U)=>sr(P)*h[U]):v.map((P,U)=>P/(1+Math.exp(-P))*h[U]),y=Oe(x,r.wdown,t,o,n);return r.postFfnNorm&&(y=qe(y,r.postFfnNorm,t,n,c,g)),A.map((P,U)=>P+y[U])}var te,X,$e,or=ne(()=>{"use strict";st();ot();Zt();rr();nr();ir();te=64,X=class X{constructor(){this.device=null;this.modules={};this.pipelines={};this.maxStorageBufferBindingSize=0;this.hasF16=!1;this.validationFailure=null;this.lost=!1;this.onLost=null;this.attnDecodeOk=!0;this.attnPrefillOk=!0;this.attnFullWgOk=!0;this.mropeOk=!0;this.rwkvWkv7Ok=!0;this.lfm2ShortConvOk=!0;this.lfm2ResidentOk=!0;this.lfm2BatchOk=!0;this.swaOk=!0;this.rwkvResidentOk=!0;this.videoOk=!0;this.videoResidentOk=!0;this.f16SharedOk=!0;this.qSharedOk=!0;this.qShared2Ok=!0;this.gemvOk=!0;this.rmsVecOk=!0;this.topKParOk=!0;this.profiler=null;this.bufferPool=new Map;this.poolSize=new WeakMap;this.pooled=new WeakSet;this.uniformPool=new Map;this.uniformSize=new WeakMap;this.convTiledOk=!0;this.convTiledQOk=!0;this.kvGpu=new Map;this.topKOk=!0;this.kvSession="";this.kvQuant=!1;this.lfm2KvGpu=new Map;this.lfm2ConvGpu=new Map;this.lfm2Session="";this.rwkvStateGpu=new Map;this.rwkvVFirst=null;this.rwkvSession=""}async init(){let e=navigator.gpu;if(!e)return!1;let r=await e.requestAdapter();if(!r)return!1;let t=r.limits,n={maxStorageBufferBindingSize:t.maxStorageBufferBindingSize,maxBufferSize:t.maxBufferSize},a=[];try{r.features?.has("shader-f16")&&a.push("shader-f16")}catch{}try{X.profileOn&&r.features?.has("timestamp-query")&&a.push("timestamp-query")}catch{}try{this.device=await r.requestDevice({requiredLimits:n,requiredFeatures:a})}catch{try{this.device=await r.requestDevice({requiredLimits:n})}catch{this.device=await r.requestDevice()}}this.maxStorageBufferBindingSize=this.device.limits?.maxStorageBufferBindingSize??134217728,this.hasF16=!!this.device.features?.has?.("shader-f16"),X.profileOn&&(this.device.features?.has?.("timestamp-query")?(this.profiler=new Qe(this.device),console.info("[webgpu] profilage par passe ACTIF (?gpuprofile=1) : __gpuProfile() pour le rapport")):console.warn("[webgpu] ?gpuprofile=1 demand\xE9 mais la feature timestamp-query est ABSENTE de cet adapter : aucune mesure ne sera prise."));try{oe("attndecode")==="0"&&(this.attnDecodeOk=!1,console.warn("[webgpu] attention d\xE9codage COUP\xC9E par ?attndecode=0 : kernels classiques")),oe("attnfullwg")==="0"&&(this.attnFullWgOk=!1,console.warn("[webgpu] attention_full workgroup COUP\xC9E par ?attnfullwg=0 : kernel classique")),oe("attnprefill")==="0"&&(this.attnPrefillOk=!1,console.warn("[webgpu] attention prefill tuil\xE9e COUP\xC9E par ?attnprefill=0 : kernel classique")),oe("rmsvec")==="0"&&(this.rmsVecOk=!1,console.warn("[webgpu] RMSNorm parall\xE8le COUP\xC9E par ?rmsvec=0 : kernel une-ligne-par-thread")),oe("topkpar")==="0"&&(this.topKParOk=!1,console.warn("[webgpu] top-K parall\xE8le COUP\xC9E par ?topkpar=0 : s\xE9lection finale sur un seul thread")),oe("rwkv")==="0"&&(this.rwkvWkv7Ok=!1,console.warn("[webgpu] kernel RWKV-7 WKV COUP\xC9 par ?rwkv=0")),oe("lfm2")==="0"&&(this.lfm2ShortConvOk=!1,console.warn("[webgpu] kernel shortconv LFM2 COUP\xC9 par ?lfm2=0")),oe("lfm2resident")==="0"&&(this.lfm2ResidentOk=!1,console.warn("[webgpu] LFM2 r\xE9sident COUP\xC9 par ?lfm2resident=0 : forwardToken JS+readback")),oe("lfm2batch")==="0"&&(this.lfm2BatchOk=!1,console.warn("[webgpu] prefill LFM2 batch\xE9 COUP\xC9 par ?lfm2batch=0 : token par token")),oe("swa")==="0"&&(this.swaOk=!1,console.warn("[webgpu] fen\xEAtre glissante COUP\xC9E par ?swa=0 : attention causale pleine sur toutes les couches")),oe("rwkvresident")==="0"&&(this.rwkvResidentOk=!1,console.warn("[webgpu] RWKV r\xE9sident COUP\xC9 par ?rwkvresident=0 : forwardToken JS+readback")),oe("video")==="0"&&(this.videoOk=!1,console.warn("[webgpu] chemin vid\xE9o (module motion) COUP\xC9 par ?video=0")),oe("f16shared")==="0"&&(this.f16SharedOk=!1,console.warn("[webgpu] GEMM f16 tuil\xE9 COUP\xC9 par ?f16shared=0 : matmul_t_f16w pour tous les m")),oe("gemv")==="0"&&(this.gemvOk=!1,console.warn("[webgpu] GEMV de d\xE9codage COUP\xC9 par ?gemv=0 : kernels par lignes")),oe("qshared")==="0"&&(this.qSharedOk=!1,console.warn("[webgpu] GEMM q8/q4 tuil\xE9s COUP\xC9S par ?qshared=0 : kernels 4 lignes/invocation")),oe("qshared2")==="0"&&(this.qShared2Ok=!1,console.warn("[webgpu] GEMM q8/q4 v2 (bloc 4\xD78 vec4) COUP\xC9S par ?qshared2=0 : tuile 32\xD764 v1")),oe("convtq")==="0"&&(this.convTiledQOk=!1,console.warn("[webgpu] conv 3\xD73 tuil\xE9 q8/q4 COUP\xC9 par ?convtq=0 : conv2d_direct_q8/q4 (plus lent, m\xEAme r\xE9sultat)")),oe("videoresident")==="0"&&(this.videoResidentOk=!1,console.warn("[webgpu] motion r\xE9sident COUP\xC9 par ?videoresident=0 : chemin JS+readback"))}catch{}this.device.lost?.then?.(s=>{this.lost=!0,console.warn("[webgpu] device GPU perdu :",s?.reason||"unknown",s?.message||""),this.onLost?.(s)});for(let[s,i]of Object.entries(er))this.modules[s]=this.device.createShaderModule({code:i});return this.hasF16&&(this.modules.matmul_t_f16w=this.device.createShaderModule({code:tr})),!0}buf(e,r){let t=this.device.createBuffer({size:e.byteLength,usage:r});return this.device.queue.writeBuffer(t,0,e),t}bufU32(e,r){let t=this.device.createBuffer({size:e.byteLength,usage:r});return this.device.queue.writeBuffer(t,0,e),t}async readBack(e,r){let t=globalThis,n=this.device.createBuffer({size:r,usage:t.GPUBufferUsage.COPY_DST|t.GPUBufferUsage.MAP_READ}),a=this.device.createCommandEncoder();a.copyBufferToBuffer(e,0,n,0,r),this.device.queue.submit([a.finish()]),await n.mapAsync(t.GPUMapMode.READ);let s=new Float32Array(n.getMappedRange().slice(0));return n.unmap(),n.destroy(),s}async readBackBytes(e,r){let t=globalThis,n=Math.ceil(r/4)*4,a=this.device.createBuffer({size:n,usage:t.GPUBufferUsage.COPY_DST|t.GPUBufferUsage.MAP_READ}),s=this.device.createCommandEncoder();s.copyBufferToBuffer(e,0,a,0,n),this.device.queue.submit([s.finish()]),await a.mapAsync(t.GPUMapMode.READ);let i=new Uint8Array(a.getMappedRange().slice(0,r));return a.unmap(),a.destroy(),i}async quantizeToBytes(e,r,t,n,a){let s=t/32,i=n==="q8"?new Uint8Array(t+s*2):new Uint8Array(t/2+s*4),o=X.BLOCK_ELEMS[e]??1,u=t/o,c=r.byteLength/u,l=(m,b)=>b===0?m:l(b,m%b),f=o*32/l(o,32),g=Math.floor(this.maxStorageBufferBindingSize*.9/4),p=a??g;p=Math.max(f,Math.floor(p/f)*f);for(let m=0;m<t;m+=p){let b=Math.min(p,t-m),k=r.slice(m/o*c,(m+b)/o*c),B=this.dequantizeToGpu(e,k,b);try{if(n==="q8"){let{codes:O,sc:q}=this.f32ToQ8Gpu(B,b),C=await this.readBackBytes(O,b),j=await this.readBackBytes(q,b/32*2);O.destroy?.(),q.destroy?.(),i.set(C,m),i.set(j,t+m/32*2)}else{let{nib:O,sc:q,mn:C}=this.f32ToQ4Gpu(B,b),j=await this.readBackBytes(O,b/2),A=await this.readBackBytes(q,b/32*2),w=await this.readBackBytes(C,b/32*2);O.destroy?.(),q.destroy?.(),C.destroy?.(),i.set(j,m/2),i.set(A,t/2+m/32*2),i.set(w,t/2+s*2+m/32*2)}}finally{B.destroy?.()}}return i}pipeline(e){let r=this.pipelines[e];return r||(r=this.device.createComputePipeline({layout:"auto",compute:{module:this.modules[e],entryPoint:"main"}}),this.pipelines[e]=r),r}grid1D(e){let r=Math.ceil(e/te);if(r<=X.MAX_WG_DIM)return[r,1,1];let t=X.MAX_WG_DIM;return[t,Math.ceil(r/t),1]}recordPass(e,r,t,n){let a=this.pipeline(r),s=this.device.createBindGroup({layout:a.getBindGroupLayout(0),entries:t.map((u,c)=>({binding:c,resource:{buffer:u}}))}),i=this.profiler?.slot(r),o=e.beginComputePass(i?{timestampWrites:i}:void 0);o.setPipeline(a),o.setBindGroup(0,s),o.dispatchWorkgroups(...n),o.end()}dispatch(e,r,t){let n=this.device.createCommandEncoder();this.recordPass(n,e,r,t),this.device.queue.submit([n.finish()])}async run(e,r,t,n,a){return this.dispatch(e,r,t),this.readBack(n,a)}isF32(e){return e instanceof Float32Array}async matmul(e,r,t,n,a){let s=globalThis,i=s.GPUBufferUsage.STORAGE|s.GPUBufferUsage.COPY_DST,o=this.device.createBuffer({size:16,usage:s.GPUBufferUsage.UNIFORM|s.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(o,0,new Uint32Array([t,n,a]));let u=this.isF32(r)?this.buf(r,i):r,c=this.device.createBuffer({size:t*a*4,usage:i|s.GPUBufferUsage.COPY_SRC});return this.run("matmul",[o,this.buf(e,i),u,c],[Math.ceil(t/8),Math.ceil(a/8),1],c,t*a*4)}async matmulT(e,r,t,n,a,s=!1){let i=globalThis,o=i.GPUBufferUsage.STORAGE|i.GPUBufferUsage.COPY_DST,u=this.device.createBuffer({size:16,usage:i.GPUBufferUsage.UNIFORM|i.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(u,0,new Uint32Array([t,n,a]));let c=this.isF32(r)?this.buf(r,o):r,l=this.device.createBuffer({size:t*a*4,usage:o|i.GPUBufferUsage.COPY_SRC}),f=this.matmulTPlan(t,n,a,s);return this.run(f.shader,[u,this.buf(e,o),c,l],f.grid,l,t*a*4)}matmulTPlan(e,r,t,n){return n&&this.hasF16?this.f16SharedOk&&e>=32&&r%4===0?{shader:"matmul_t_f16w_shared",grid:[Math.ceil(t/64),Math.ceil(e/32),1]}:{shader:"matmul_t_f16w",grid:[Math.ceil(e/8),Math.ceil(t/8),1]}:{shader:r%4===0?"matmul_t_vec4":"matmul_t",grid:[Math.ceil(e/8),Math.ceil(t/8),1]}}async rmsnorm(e,r,t,n,a=1e-5,s=!1){let i=globalThis,o=i.GPUBufferUsage.STORAGE|i.GPUBufferUsage.COPY_DST,u=this.device.createBuffer({size:16,usage:i.GPUBufferUsage.UNIFORM|i.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(u,0,new Uint32Array([t,n])),this.device.queue.writeBuffer(u,8,new Float32Array([a])),this.device.queue.writeBuffer(u,12,new Uint32Array([s?1:0]));let c=this.device.createBuffer({size:e.byteLength,usage:o|i.GPUBufferUsage.COPY_SRC});return this.run("rmsnorm",[u,this.buf(e,o),this.buf(r,o),c],[Math.ceil(t/te),1,1],c,e.byteLength)}async topKReadback(e,r,t){let n=globalThis,a=n.GPUBufferUsage.STORAGE|n.GPUBufferUsage.COPY_DST,s=this.device.createBuffer({size:8,usage:n.GPUBufferUsage.UNIFORM|n.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(s,0,new Uint32Array([e.length,r]));let i=this.device.createBuffer({size:r*2*4,usage:a|n.GPUBufferUsage.COPY_SRC}),o=this.device.createBuffer({size:r*2*4,usage:n.GPUBufferUsage.COPY_DST|n.GPUBufferUsage.MAP_READ}),u=this.device.createCommandEncoder(),c=this.buf(e,a);this.recordPass(u,t,[s,c,i],[1,1,1]),u.copyBufferToBuffer(i,0,o,0,r*2*4),this.device.queue.submit([u.finish()]),await o.mapAsync(n.GPUMapMode.READ);let l=new Uint32Array(o.getMappedRange().slice(0));return o.unmap(),o.destroy(),i.destroy?.(),s.destroy?.(),c.destroy?.(),l}async rmsnormVec(e,r,t,n,a=1e-5,s=!1){let i=globalThis,o=i.GPUBufferUsage.STORAGE|i.GPUBufferUsage.COPY_DST,u=this.device.createBuffer({size:16,usage:i.GPUBufferUsage.UNIFORM|i.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(u,0,new Uint32Array([t,n])),this.device.queue.writeBuffer(u,8,new Float32Array([a])),this.device.queue.writeBuffer(u,12,new Uint32Array([s?1:0]));let c=this.device.createBuffer({size:e.byteLength,usage:o|i.GPUBufferUsage.COPY_SRC});return this.run("rmsnorm_vec",[u,this.buf(e,o),this.buf(r,o),c],[t,1,1],c,e.byteLength)}async binary(e,r,t){let n=globalThis,a=n.GPUBufferUsage.STORAGE|n.GPUBufferUsage.COPY_DST,s=this.device.createBuffer({size:r.byteLength,usage:a|n.GPUBufferUsage.COPY_SRC});return this.run(e,[this.buf(r,a),this.buf(t,a),s],this.grid1D(r.length),s,r.byteLength)}swiglu(e,r){return this.binary("swiglu",e,r)}geglu(e,r){return this.binary("geglu",e,r)}add(e,r){return this.binary("add",e,r)}async silu(e){let r=globalThis,t=r.GPUBufferUsage.STORAGE|r.GPUBufferUsage.COPY_DST,n=this.device.createBuffer({size:e.byteLength,usage:t|r.GPUBufferUsage.COPY_SRC});return this.run("silu",[this.buf(e,t),n],this.grid1D(e.length),n,e.byteLength)}async groupNorm(e,r,t,n,a,s,i=1e-5){let o=globalThis,u=o.GPUBufferUsage.STORAGE|o.GPUBufferUsage.COPY_DST,c=this.device.createBuffer({size:16,usage:o.GPUBufferUsage.UNIFORM|o.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(c,0,new Uint32Array([n,a,s])),this.device.queue.writeBuffer(c,12,new Float32Array([i]));let l=this.device.createBuffer({size:e.byteLength,usage:u|o.GPUBufferUsage.COPY_SRC});return this.run("group_norm",[c,this.buf(e,u),this.buf(r,u),this.buf(t,u),l],[s,1,1],l,e.byteLength)}async conv2d(e,r,t,n,a,s,i,o,u,c=1,l=0){let f=globalThis,g=f.GPUBufferUsage.STORAGE|f.GPUBufferUsage.COPY_DST,p=Math.floor((a+2*l-o)/c)+1,m=Math.floor((s+2*l-u)/c)+1,b=n*o*u,k=p*m;if(b*k*4>this.maxStorageBufferBindingSize*.9)return this.conv2dDirect(e,r,t,n,a,s,i,o,u,c,l);let B=this.device.createBuffer({size:48,usage:f.GPUBufferUsage.UNIFORM|f.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(B,0,new Uint32Array([n,a,s,o,u,c,l,p,m]));let O=this.device.createBuffer({size:b*k*4,usage:g|f.GPUBufferUsage.COPY_SRC});this.dispatch("im2col",[B,this.buf(e,g),O],this.grid1D(b*k));let q=await this.matmul(r,O,i,b,k);if(O.destroy?.(),B.destroy?.(),t)for(let C=0;C<i;C++){let j=t[C];for(let A=0;A<k;A++)q[C*k+A]+=j}return q}async conv2dDirect(e,r,t,n,a,s,i,o,u,c=1,l=0){let f=globalThis,g=f.GPUBufferUsage.STORAGE|f.GPUBufferUsage.COPY_DST,p=Math.floor((a+2*l-o)/c)+1,m=Math.floor((s+2*l-u)/c)+1,b=i*p*m,k=this.device.createBuffer({size:48,usage:f.GPUBufferUsage.UNIFORM|f.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(k,0,new Uint32Array([n,a,s,i,o,u,c,l,p,m]));let B=t??new Float32Array(i),O=this.device.createBuffer({size:b*4,usage:g|f.GPUBufferUsage.COPY_SRC});return this.run("conv2d_direct",[k,this.buf(e,g),this.buf(r,g),this.buf(B,g),O],this.grid1D(b),O,b*4)}async layernorm(e,r,t,n,a,s=1e-5){let i=globalThis,o=i.GPUBufferUsage.STORAGE|i.GPUBufferUsage.COPY_DST,u=this.device.createBuffer({size:16,usage:i.GPUBufferUsage.UNIFORM|i.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(u,0,new Uint32Array([n,a])),this.device.queue.writeBuffer(u,8,new Float32Array([s]));let c=this.device.createBuffer({size:e.byteLength,usage:o|i.GPUBufferUsage.COPY_SRC});return this.run("layernorm",[u,this.buf(e,o),this.buf(r,o),this.buf(t,o),c],[Math.ceil(n/te),1,1],c,e.byteLength)}async quickGelu(e){let r=globalThis,t=r.GPUBufferUsage.STORAGE|r.GPUBufferUsage.COPY_DST,n=this.device.createBuffer({size:e.byteLength,usage:t|r.GPUBufferUsage.COPY_SRC});return this.run("quick_gelu",[this.buf(e,t),n],this.grid1D(e.length),n,e.byteLength)}async gelu(e){let r=globalThis,t=r.GPUBufferUsage.STORAGE|r.GPUBufferUsage.COPY_DST,n=this.device.createBuffer({size:e.byteLength,usage:t|r.GPUBufferUsage.COPY_SRC});return this.run("gelu",[this.buf(e,t),n],this.grid1D(e.length),n,e.byteLength)}async relu(e){let r=globalThis,t=r.GPUBufferUsage.STORAGE|r.GPUBufferUsage.COPY_DST,n=this.device.createBuffer({size:e.byteLength,usage:t|r.GPUBufferUsage.COPY_SRC});return this.run("relu",[this.buf(e,t),n],this.grid1D(e.length),n,e.byteLength)}async upsampleNearest(e,r,t,n,a=2){let s=globalThis,i=s.GPUBufferUsage.STORAGE|s.GPUBufferUsage.COPY_DST,o=t*a,u=n*a,c=r*o*u,l=this.device.createBuffer({size:16,usage:s.GPUBufferUsage.UNIFORM|s.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(l,0,new Uint32Array([r,t,n,a]));let f=this.device.createBuffer({size:c*4,usage:i|s.GPUBufferUsage.COPY_SRC});return this.run("upsample_nearest",[l,this.buf(e,i),f],this.grid1D(c),f,c*4)}async rope(e,r,t,n,a=0,s=1e4,i=!1){let o=globalThis,u=o.GPUBufferUsage.STORAGE|o.GPUBufferUsage.COPY_DST,c=this.device.createBuffer({size:32,usage:o.GPUBufferUsage.UNIFORM|o.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(c,0,new Uint32Array([r,t,n,a])),this.device.queue.writeBuffer(c,16,new Float32Array([s]));let l=this.device.createBuffer({size:e.byteLength,usage:u|o.GPUBufferUsage.COPY_SRC});return this.device.queue.writeBuffer(c,20,new Uint32Array([i?1:0])),this.run("rope",[c,this.buf(e,u),l],[Math.ceil(r/te),1,1],l,e.byteLength)}async ropeFactors(e,r,t,n,a,s=0,i=1e4,o=!1){let u=globalThis,c=u.GPUBufferUsage.STORAGE|u.GPUBufferUsage.COPY_DST,l=this.device.createBuffer({size:32,usage:u.GPUBufferUsage.UNIFORM|u.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(l,0,new Uint32Array([t,n,a,s])),this.device.queue.writeBuffer(l,16,new Float32Array([i]));let f=this.device.createBuffer({size:r.byteLength,usage:c});this.device.queue.writeBuffer(f,0,r);let g=this.device.createBuffer({size:e.byteLength,usage:c|u.GPUBufferUsage.COPY_SRC});return this.device.queue.writeBuffer(l,20,new Uint32Array([o?1:0])),this.run("rope_factors",[l,this.buf(e,c),f,g],[Math.ceil(t/te),1,1],g,e.byteLength)}async ropeMrope(e,r,t,n,a,s,i=1e4){let o=globalThis,u=o.GPUBufferUsage.STORAGE|o.GPUBufferUsage.COPY_DST,c=this.device.createBuffer({size:32,usage:o.GPUBufferUsage.UNIFORM|o.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(c,0,new Uint32Array([t,n,a,s[0],s[0]+s[1]])),this.device.queue.writeBuffer(c,20,new Float32Array([i]));let l=this.device.createBuffer({size:r.byteLength,usage:u});this.device.queue.writeBuffer(l,0,r);let f=this.device.createBuffer({size:e.byteLength,usage:u|o.GPUBufferUsage.COPY_SRC});return this.run("rope_mrope",[c,this.buf(e,u),l,f],[Math.ceil(t/te),1,1],f,e.byteLength)}async rope2d(e,r,t,n,a,s=1e4){let i=globalThis,o=i.GPUBufferUsage.STORAGE|i.GPUBufferUsage.COPY_DST,u=this.device.createBuffer({size:32,usage:i.GPUBufferUsage.UNIFORM|i.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(u,0,new Uint32Array([t,n,a,0])),this.device.queue.writeBuffer(u,16,new Float32Array([s]));let c=this.device.createBuffer({size:r.byteLength,usage:o});this.device.queue.writeBuffer(c,0,r);let l=this.device.createBuffer({size:e.byteLength,usage:o|i.GPUBufferUsage.COPY_SRC});return this.run("rope_2d",[u,this.buf(e,o),c,l],[Math.ceil(t/te),1,1],l,e.byteLength)}async attention(e,r,t,n,a,s,i,o=0,u,c=0,l=0){let f=globalThis,g=f.GPUBufferUsage.STORAGE|f.GPUBufferUsage.COPY_DST,p=o+n,m=this.attnUniform(n,a,s,i,p,o,u??1/Math.sqrt(i),c,l),b=n*a*i*4,k=this.device.createBuffer({size:b,usage:g|f.GPUBufferUsage.COPY_SRC});return this.run("attention",[m,this.buf(e,g),this.buf(r,g),this.buf(t,g),k],[Math.ceil(n*a/te),1,1],k,b)}async attentionDecode(e,r,t,n,a,s,i,o=0,u,c=0,l=0){let f=globalThis,g=f.GPUBufferUsage.STORAGE|f.GPUBufferUsage.COPY_DST,p=o+n,m=this.attnUniform(n,a,s,i,p,o,u??1/Math.sqrt(i),c,l),b=n*a*i*4,k=this.device.createBuffer({size:b,usage:g|f.GPUBufferUsage.COPY_SRC});return this.run("attention_decode",[m,this.buf(e,g),this.buf(r,g),this.buf(t,g),k],[n*a,1,1],k,b)}async attentionPrefill(e,r,t,n,a,s,i,o=0,u,c=0,l=0){let f=globalThis,g=f.GPUBufferUsage.STORAGE|f.GPUBufferUsage.COPY_DST,p=o+n,m=this.attnUniform(n,a,s,i,p,o,u??1/Math.sqrt(i),c,l),b=n*a*i*4,k=this.device.createBuffer({size:b,usage:g|f.GPUBufferUsage.COPY_SRC});return this.run("attention_prefill",[m,this.buf(e,g),this.buf(r,g),this.buf(t,g),k],[Math.ceil(n/4)*a,1,1],k,b)}async attentionFull(e,r,t,n,a,s,i,o,u,c=0){let l=globalThis,f=l.GPUBufferUsage.STORAGE|l.GPUBufferUsage.COPY_DST,g=this.device.createBuffer({size:32,usage:l.GPUBufferUsage.UNIFORM|l.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(g,0,new Uint32Array([n,a,s,i,o,0])),this.device.queue.writeBuffer(g,24,new Float32Array([u??1/Math.sqrt(i),c]));let p=n*a*i*4,m=this.device.createBuffer({size:p,usage:f|l.GPUBufferUsage.COPY_SRC});return this.run("attention_full",[g,this.buf(e,f),this.buf(r,f),this.buf(t,f),m],[Math.ceil(n*a/te),1,1],m,p)}async attentionFullWg(e,r,t,n,a,s,i,o,u,c=0){let l=globalThis,f=l.GPUBufferUsage.STORAGE|l.GPUBufferUsage.COPY_DST,g=this.device.createBuffer({size:32,usage:l.GPUBufferUsage.UNIFORM|l.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(g,0,new Uint32Array([n,a,s,i,o,0])),this.device.queue.writeBuffer(g,24,new Float32Array([u??1/Math.sqrt(i),c]));let p=n*a*i*4,m=this.device.createBuffer({size:p,usage:f|l.GPUBufferUsage.COPY_SRC});return this.run("attention_full_wg",[g,this.buf(e,f),this.buf(r,f),this.buf(t,f),m],[n*a,1,1],m,p)}async quantizeKvReadback(e,r,t,n){let a=globalThis,s=a.GPUBufferUsage.STORAGE|a.GPUBufferUsage.COPY_DST|a.GPUBufferUsage.COPY_SRC,i=t*n,o=this.device.createBuffer({size:16,usage:a.GPUBufferUsage.UNIFORM|a.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(o,0,new Uint32Array([r,t,n,0]));let u=this.device.createBuffer({size:r*i,usage:s}),c=this.device.createBuffer({size:r*t*4,usage:s});this.dispatch("quantize_kv",[o,this.buf(e,s),u,c],this.grid1D(r*t));let l=await this.readBack(u,r*i),f=new Uint32Array(l.buffer,0,r*i/4),g=await this.readBack(c,r*t*4);return u.destroy?.(),c.destroy?.(),{codes:f,scales:g}}async attentionQ8Kv(e,r,t,n,a,s,i,o,u,c=0,l,f=0,g=0){let p=globalThis,m=p.GPUBufferUsage.STORAGE|p.GPUBufferUsage.COPY_DST,b=c+s,k=this.attnUniform(s,i,o,u,b,c,l??1/Math.sqrt(u),f,g),B=s*i*u*4,O=this.device.createBuffer({size:B,usage:m|p.GPUBufferUsage.COPY_SRC});return this.run("attention_q8kv",[k,this.buf(e,m),this.bufU32(r,m),this.buf(t,m),this.bufU32(n,m),this.buf(a,m),O],[Math.ceil(s*i/te),1,1],O,B)}async attentionQ8KvDecode(e,r,t,n,a,s,i,o,u,c=0,l,f=0,g=0){let p=globalThis,m=p.GPUBufferUsage.STORAGE|p.GPUBufferUsage.COPY_DST,b=c+s,k=this.attnUniform(s,i,o,u,b,c,l??1/Math.sqrt(u),f,g),B=s*i*u*4,O=this.device.createBuffer({size:B,usage:m|p.GPUBufferUsage.COPY_SRC});return this.run("attention_decode_q8kv",[k,this.buf(e,m),this.bufU32(r,m),this.buf(t,m),this.bufU32(n,m),this.buf(a,m),O],[s*i,1,1],O,B)}async attentionQ8KvPrefill(e,r,t,n,a,s,i,o,u,c=0,l,f=0,g=0){let p=globalThis,m=p.GPUBufferUsage.STORAGE|p.GPUBufferUsage.COPY_DST,b=c+s,k=this.attnUniform(s,i,o,u,b,c,l??1/Math.sqrt(u),f,g),B=s*i*u*4,O=this.device.createBuffer({size:B,usage:m|p.GPUBufferUsage.COPY_SRC});return this.run("attention_prefill_q8kv",[k,this.buf(e,m),this.bufU32(r,m),this.buf(t,m),this.bufU32(n,m),this.buf(a,m),O],[Math.ceil(s/4)*i,1,1],O,B)}async addBias(e,r,t,n){let a=globalThis,s=a.GPUBufferUsage.STORAGE|a.GPUBufferUsage.COPY_DST,i=this.device.createBuffer({size:8,usage:a.GPUBufferUsage.UNIFORM|a.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(i,0,new Uint32Array([t,n]));let o=this.device.createBuffer({size:e.byteLength,usage:s|a.GPUBufferUsage.COPY_SRC});return this.run("addbias",[i,this.buf(e,s),this.buf(r,s),o],this.grid1D(e.length),o,e.byteLength)}async dequantBlocked(e,r,t,n){let a=globalThis,s=a.GPUBufferUsage.STORAGE|a.GPUBufferUsage.COPY_DST,i=t/n;if(!Number.isInteger(i))throw new Error(`${e}: nElems ${t} not a multiple of ${n}`);let o=r.byteLength%4===0?r:(()=>{let f=new Uint8Array(Math.ceil(r.byteLength/4)*4);return f.set(r),f})(),u=new Uint32Array(o.buffer,o.byteOffset,o.byteLength/4),c=this.device.createBuffer({size:16,usage:a.GPUBufferUsage.UNIFORM|a.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(c,0,new Uint32Array([i]));let l=this.device.createBuffer({size:t*4,usage:s|a.GPUBufferUsage.COPY_SRC});return this.run(e,[c,this.bufU32(u,s),l],this.grid1D(i),l,t*4)}async dequantizeQ4K(e,r){return this.dequantBlocked("dequant_q4k",e,r,256)}async dequantizeByType(e,r,t){if(e==="F32")return new Float32Array(r.buffer,r.byteOffset,t);if(e==="F16"){let s=new DataView(r.buffer,r.byteOffset),i=new Float32Array(t);for(let o=0;o<t;o++)i[o]=be(s.getUint16(o*2,!0));return i}if(e==="Q4W")return pe(_e(r,t));if(e==="Q8W")return me(Fe(r,t));if(e==="Q3W")return We(ut(r,t));let n=X.DEQUANT_SHADER[e],a=X.BLOCK_ELEMS[e];if(!n||!a)throw new Error(`dequant: unsupported GGML type ${e}`);return this.dequantBlocked(n,r,t,a)}dequantBlockedGpu(e,r,t,n){let a=globalThis,s=a.GPUBufferUsage.STORAGE|a.GPUBufferUsage.COPY_DST,i=t/n;if(!Number.isInteger(i))throw new Error(`${e}: nElems ${t} not a multiple of ${n}`);let o=r.byteLength%4===0?r:(()=>{let f=new Uint8Array(Math.ceil(r.byteLength/4)*4);return f.set(r),f})(),u=new Uint32Array(o.buffer,o.byteOffset,o.byteLength/4),c=this.device.createBuffer({size:16,usage:a.GPUBufferUsage.UNIFORM|a.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(c,0,new Uint32Array([i]));let l=this.device.createBuffer({size:t*4,usage:s});return this.dispatch(e,[c,this.bufU32(u,s),l],this.grid1D(i)),l}dequantizeToGpu(e,r,t){let n=globalThis,a=n.GPUBufferUsage.STORAGE|n.GPUBufferUsage.COPY_DST;if(e==="F32")return this.buf(new Float32Array(r.buffer,r.byteOffset,t),a);if(e==="F16"){let o=new DataView(r.buffer,r.byteOffset),u=new Float32Array(t);for(let c=0;c<t;c++)u[c]=be(o.getUint16(c*2,!0));return this.buf(u,a)}if(e==="Q4W")return this.buf(pe(_e(r,t)),a);if(e==="Q8W")return this.buf(me(Fe(r,t)),a);if(e==="Q3W")return this.buf(We(ut(r,t)),a);let s=X.DEQUANT_SHADER[e],i=X.BLOCK_ELEMS[e];if(!s||!i)throw new Error(`dequant: unsupported GGML type ${e}`);return this.dequantBlockedGpu(s,r,t,i)}async layerForward(e,r,t,n=!1){let{seq:a,d:s,nHeads:i,nKvHeads:o,headDim:u,ffn:c,ropeTheta:l,eps:f}=r,g=o*u,p=n?(F,M,R,T,D)=>this.matmulT(F,M,R,T,D):(F,M,R,T,D)=>this.matmul(F,M,R,T,D),m=i*u,b=r.rmsGainOnePlus===!0,k=r.attnLogitSoftcap??0,B=(F,M)=>r.act==="gelu"?this.geglu(F,M):this.swiglu(F,M),O=await this.rmsnorm(e,t.attnNorm,a,s,f,b),q=await p(O,t.wq,a,s,m),C=await p(O,t.wk,a,s,g),j=await p(O,t.wv,a,s,g);t.bq&&(q=await this.addBias(q,t.bq,a,m)),t.bk&&(C=await this.addBias(C,t.bk,a,g)),t.bv&&(j=await this.addBias(j,t.bv,a,g)),t.qNorm&&(q=await this.rmsnorm(q,t.qNorm,a*i,u,f,b)),t.kNorm&&(C=await this.rmsnorm(C,t.kNorm,a*o,u,f,b));let A=await this.rope(q,a*i,u,i,0,l),w=await this.rope(C,a*o,u,o,0,l),v=await this.attention(A,w,j,a,i,o,u,0,r.attnScale,k),h=await p(v,t.wo,a,m,s);t.postAttnNorm&&(h=await this.rmsnorm(h,t.postAttnNorm,a,s,f,b));let x=await this.add(e,h),y=await this.rmsnorm(x,t.ffnNorm,a,s,f,b),P=await p(y,t.wgate,a,s,c),U=await p(y,t.wup,a,s,c),_=await B(P,U),G=await p(_,t.wdown,a,c,s);return t.postFfnNorm&&(G=await this.rmsnorm(G,t.postFfnNorm,a,s,f,b)),this.add(x,G)}async layerForwardKV(e,r,t,n,a,s,i=!1){let{seq:o,d:u,nHeads:c,nKvHeads:l,headDim:f,ffn:g,ropeTheta:p,eps:m}=r,b=l*f,k=i?($,V,Y,N,S)=>this.matmulT($,V,Y,N,S):($,V,Y,N,S)=>this.matmul($,V,Y,N,S),B=($,V)=>{let Y=new Float32Array($.length+V.length);return Y.set($),Y.set(V,$.length),Y},O=c*f,q=r.rmsGainOnePlus===!0,C=r.attnLogitSoftcap??0,j=($,V)=>r.act==="gelu"?this.geglu($,V):this.swiglu($,V),A=await this.rmsnorm(e,t.attnNorm,o,u,m,q),w=await k(A,t.wq,o,u,O),v=await k(A,t.wk,o,u,b),h=await k(A,t.wv,o,u,b);t.bq&&(w=await this.addBias(w,t.bq,o,O)),t.bk&&(v=await this.addBias(v,t.bk,o,b)),t.bv&&(h=await this.addBias(h,t.bv,o,b)),t.qNorm&&(w=await this.rmsnorm(w,t.qNorm,o*c,f,m,q)),t.kNorm&&(v=await this.rmsnorm(v,t.kNorm,o*l,f,m,q));let x=await this.rope(w,o*c,f,c,n,p),y=await this.rope(v,o*l,f,l,n,p),P=B(a,y),U=B(s,h),_=await this.attention(x,P,U,o,c,l,f,n,r.attnScale,C),G=await k(_,t.wo,o,O,u);t.postAttnNorm&&(G=await this.rmsnorm(G,t.postAttnNorm,o,u,m,q));let F=await this.add(e,G),M=await this.rmsnorm(F,t.ffnNorm,o,u,m,q),R=await k(M,t.wgate,o,u,g),T=await k(M,t.wup,o,u,g),D=await j(R,T),E=await k(D,t.wdown,o,g,u);return t.postFfnNorm&&(E=await this.rmsnorm(E,t.postFfnNorm,o,u,m,q)),{out:await this.add(F,E),k:P,v:U}}storage(e){let r=this.bufferPool.get(e);if(r&&r.length){let n=r.pop();return this.pooled.delete(n),n}let t=this.device.createBuffer({size:e,usage:X.STORAGE_USAGE});return this.poolSize.set(t,e),t}release(e){for(let r of e){if(!r)continue;let t=this.poolSize.get(r);if(t!==void 0){if(this.pooled.has(r))continue;this.pooled.add(r);let a=this.bufferPool.get(t);a||(a=[],this.bufferPool.set(t,a)),a.push(r);continue}let n=this.uniformSize.get(r);if(n!==void 0){if(this.pooled.has(r))continue;this.pooled.add(r);let a=this.uniformPool.get(n);a||(a=[],this.uniformPool.set(n,a)),a.push(r);continue}r.destroy?.()}}uploadGpu(e){return e instanceof Float32Array?this.buf(e,X.STORAGE_USAGE):this.f16ToF32Gpu(e.f16,e.n)}uploadGpuF16(e){let r=new Uint16Array(e.length);for(let t=0;t<e.length;t++)r[t]=Se(e[t]);return this.bufU16(r)}f32ToF16Gpu(e,r){let t=globalThis,n=Math.ceil(r/2),a=this.device.createBuffer({size:n*4,usage:X.STORAGE_USAGE}),s=this.device.createBuffer({size:16,usage:t.GPUBufferUsage.UNIFORM|t.GPUBufferUsage.COPY_DST});return this.device.queue.writeBuffer(s,0,new Uint32Array([n])),this.dispatch("packf16",[s,e,a],this.grid1D(n)),a}f32ToQ8Gpu(e,r){let t=globalThis,n=r/32,a=this.device.createBuffer({size:r,usage:X.STORAGE_USAGE}),s=this.device.createBuffer({size:Math.ceil(n/2)*4,usage:X.STORAGE_USAGE}),i=this.device.createBuffer({size:16,usage:t.GPUBufferUsage.UNIFORM|t.GPUBufferUsage.COPY_DST});return this.device.queue.writeBuffer(i,0,new Uint32Array([n])),this.dispatch("quantize_q8",[i,e,a,s],this.grid1D(n)),{codes:a,sc:s}}f32ToQ4Gpu(e,r){let t=globalThis,n=r/32,a=this.device.createBuffer({size:r/2,usage:X.STORAGE_USAGE}),s=this.device.createBuffer({size:Math.ceil(n/2)*4,usage:X.STORAGE_USAGE}),i=this.device.createBuffer({size:Math.ceil(n/2)*4,usage:X.STORAGE_USAGE}),o=this.device.createBuffer({size:16,usage:t.GPUBufferUsage.UNIFORM|t.GPUBufferUsage.COPY_DST});return this.device.queue.writeBuffer(o,0,new Uint32Array([n])),this.dispatch("quantize_q4",[o,e,a,s,i],this.grid1D(n)),{nib:a,sc:s,mn:i}}uploadGpuRawF16(e){let r=Math.ceil(e.byteLength/4)*4,t=this.device.createBuffer({size:r,usage:X.STORAGE_USAGE});if(this.device.queue.writeBuffer(t,0,e,0,e.byteLength-e.byteLength%4),e.byteLength%4){let n=new Uint8Array(4);n.set(e.subarray(e.byteLength-e.byteLength%4)),this.device.queue.writeBuffer(t,e.byteLength-e.byteLength%4,n)}return t}bufU16(e){let r=this.device.createBuffer({size:e.byteLength,usage:X.STORAGE_USAGE});return this.device.queue.writeBuffer(r,0,e),r}uploadGpuRaw(e){let r=Math.ceil(e.byteLength/4)*4,t=this.device.createBuffer({size:r,usage:X.STORAGE_USAGE}),n=e.byteLength-e.byteLength%4;if(this.device.queue.writeBuffer(t,0,e,0,n),e.byteLength%4){let a=new Uint8Array(4);a.set(e.subarray(n)),this.device.queue.writeBuffer(t,n,a)}return t}async matmulQ4(e,r,t,n,a,s,i){let o=globalThis,u=o.GPUBufferUsage.STORAGE|o.GPUBufferUsage.COPY_DST,c=this.device.createBuffer({size:16,usage:o.GPUBufferUsage.UNIFORM|o.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(c,0,new Uint32Array([a,s,i]));let l=this.device.createBuffer({size:a*i*4,usage:u|o.GPUBufferUsage.COPY_SRC});return this.run("matmul_t_q4",[c,this.buf(e,u),r,t,n,l],[Math.ceil(a/8),Math.ceil(i/8),1],l,a*i*4)}async matmulQ4Tiled(e,r,t,n,a,s,i){let o=globalThis,u=o.GPUBufferUsage.STORAGE|o.GPUBufferUsage.COPY_DST,c=this.device.createBuffer({size:16,usage:o.GPUBufferUsage.UNIFORM|o.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(c,0,new Uint32Array([a,s,i]));let l=this.device.createBuffer({size:a*i*4,usage:u|o.GPUBufferUsage.COPY_SRC});return this.run("matmul_t_q4_tiled",[c,this.buf(e,u),r,t,n,l],[Math.ceil(Math.ceil(a/4)/8),Math.ceil(i/8),1],l,a*i*4)}async matmulQ4Shared(e,r,t,n,a,s,i){let o=globalThis,u=o.GPUBufferUsage.STORAGE|o.GPUBufferUsage.COPY_DST,c=this.device.createBuffer({size:16,usage:o.GPUBufferUsage.UNIFORM|o.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(c,0,new Uint32Array([a,s,i]));let l=this.device.createBuffer({size:a*i*4,usage:u|o.GPUBufferUsage.COPY_SRC});return this.run("matmul_t_q4_shared",[c,this.buf(e,u),r,t,n,l],[Math.ceil(i/64),Math.ceil(a/32),1],l,a*i*4)}async matmulQ3(e,r,t,n,a,s,i,o){let u=globalThis,c=u.GPUBufferUsage.STORAGE|u.GPUBufferUsage.COPY_DST,l=this.device.createBuffer({size:16,usage:u.GPUBufferUsage.UNIFORM|u.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(l,0,new Uint32Array([s,i,o]));let f=this.device.createBuffer({size:s*o*4,usage:c|u.GPUBufferUsage.COPY_SRC});return this.run("matmul_t_q3",[l,this.buf(e,c),r,t,n,a,f],[Math.ceil(s/8),Math.ceil(o/8),1],f,s*o*4)}async rwkvWkv7(e,r,t,n,a,s,i,o,u){let c=globalThis,l=c.GPUBufferUsage.STORAGE|c.GPUBufferUsage.COPY_DST,f=this.device.createBuffer({size:8,usage:c.GPUBufferUsage.UNIFORM|c.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(f,0,new Uint32Array([o,u]));let g=this.device.createBuffer({size:e.byteLength,usage:l|c.GPUBufferUsage.COPY_SRC});this.device.queue.writeBuffer(g,0,e);let p=this.device.createBuffer({size:o*u*4,usage:l|c.GPUBufferUsage.COPY_SRC});this.dispatch("rwkv_wkv7",[f,this.buf(r,l),this.buf(t,l),this.buf(n,l),this.buf(a,l),this.buf(s,l),this.buf(i,l),g,p],this.grid1D(o*u));let m=await this.readBack(g,e.byteLength),b=await this.readBack(p,o*u*4);return g.destroy?.(),p.destroy?.(),{S:m,y:b}}async rwkvTokenShift(e,r,t,n){let a=globalThis,s=a.GPUBufferUsage.STORAGE|a.GPUBufferUsage.COPY_DST,i=this.device.createBuffer({size:16,usage:a.GPUBufferUsage.UNIFORM|a.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(i,0,new Uint32Array([n]));let o=this.device.createBuffer({size:6*n*4,usage:s|a.GPUBufferUsage.COPY_SRC});this.dispatch("rwkv_token_shift",[i,this.buf(e,s),this.buf(r,s),this.buf(t,s),o],this.grid1D(n*6));let u=await this.readBack(o,6*n*4);return o.destroy?.(),u}async lfm2ShortConv(e,r,t,n,a){let s=globalThis,i=s.GPUBufferUsage.STORAGE|s.GPUBufferUsage.COPY_DST,o=this.device.createBuffer({size:16,usage:s.GPUBufferUsage.UNIFORM|s.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(o,0,new Uint32Array([n,a]));let u=this.buf(r,i|s.GPUBufferUsage.COPY_SRC),c=this.device.createBuffer({size:n*4,usage:i|s.GPUBufferUsage.COPY_SRC});this.dispatch("lfm2_shortconv",[o,this.buf(e,i),this.buf(t,i),u,c],this.grid1D(n));let l=await this.readBack(c,n*4),f=await this.readBack(u,(a-1)*n*4);return c.destroy?.(),u.destroy?.(),{out:l,state:f}}async matmulQ8(e,r,t,n,a,s){let i=globalThis,o=i.GPUBufferUsage.STORAGE|i.GPUBufferUsage.COPY_DST,u=this.device.createBuffer({size:16,usage:i.GPUBufferUsage.UNIFORM|i.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(u,0,new Uint32Array([n,a,s]));let c=this.device.createBuffer({size:n*s*4,usage:o|i.GPUBufferUsage.COPY_SRC});return this.run("matmul_t_q8",[u,this.buf(e,o),r,t,c],[Math.ceil(n/8),Math.ceil(s/8),1],c,n*s*4)}async matmulQ8Tiled(e,r,t,n,a,s){let i=globalThis,o=i.GPUBufferUsage.STORAGE|i.GPUBufferUsage.COPY_DST,u=this.device.createBuffer({size:16,usage:i.GPUBufferUsage.UNIFORM|i.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(u,0,new Uint32Array([n,a,s]));let c=this.device.createBuffer({size:n*s*4,usage:o|i.GPUBufferUsage.COPY_SRC});return this.run("matmul_t_q8_tiled",[u,this.buf(e,o),r,t,c],[Math.ceil(Math.ceil(n/4)/8),Math.ceil(s/8),1],c,n*s*4)}async matmulQ8Shared(e,r,t,n,a,s){let i=globalThis,o=i.GPUBufferUsage.STORAGE|i.GPUBufferUsage.COPY_DST,u=this.device.createBuffer({size:16,usage:i.GPUBufferUsage.UNIFORM|i.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(u,0,new Uint32Array([n,a,s]));let c=this.device.createBuffer({size:n*s*4,usage:o|i.GPUBufferUsage.COPY_SRC});return this.run("matmul_t_q8_shared",[u,this.buf(e,o),r,t,c],[Math.ceil(s/64),Math.ceil(n/32),1],c,n*s*4)}async matmulQ8Shared2(e,r,t,n,a,s){let i=globalThis,o=i.GPUBufferUsage.STORAGE|i.GPUBufferUsage.COPY_DST,u=this.device.createBuffer({size:16,usage:i.GPUBufferUsage.UNIFORM|i.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(u,0,new Uint32Array([n,a,s]));let c=this.device.createBuffer({size:n*s*4,usage:o|i.GPUBufferUsage.COPY_SRC});return this.run("matmul_t_q8_shared2",[u,this.buf(e,o),r,t,c],[Math.ceil(s/128),Math.ceil(n/64),1],c,n*s*4)}async matmulQ4Shared2(e,r,t,n,a,s,i){let o=globalThis,u=o.GPUBufferUsage.STORAGE|o.GPUBufferUsage.COPY_DST,c=this.device.createBuffer({size:16,usage:o.GPUBufferUsage.UNIFORM|o.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(c,0,new Uint32Array([a,s,i]));let l=this.device.createBuffer({size:a*i*4,usage:u|o.GPUBufferUsage.COPY_SRC});return this.run("matmul_t_q4_shared2",[c,this.buf(e,u),r,t,n,l],[Math.ceil(i/128),Math.ceil(a/64),1],l,a*i*4)}uniformOf(e){let r=globalThis,t=this.uniformPool.get(e);if(t&&t.length){let a=t.pop();return this.pooled.delete(a),a}let n=this.device.createBuffer({size:e,usage:r.GPUBufferUsage.UNIFORM|r.GPUBufferUsage.COPY_DST});return this.uniformSize.set(n,e),n}uniform(e,r){let t=this.uniformOf(32);if(this.device.queue.writeBuffer(t,0,new Uint32Array(e)),r){let n=Array.isArray(r.value)?r.value:[r.value];this.device.queue.writeBuffer(t,r.offset,new Float32Array(n))}return t}attnUniform(e,r,t,n,a,s,i,o,u){let c=this.uniformOf(48);return this.device.queue.writeBuffer(c,0,new Uint32Array([e,r,t,n,a,s])),this.device.queue.writeBuffer(c,24,new Float32Array([i,o])),this.device.queue.writeBuffer(c,32,new Uint32Array([u])),c}recMatmulT(e,r,t,n,a,s,i,o=!1){let u=this.uniform([a,s,i]),c=this.storage(a*i*4),l=this.matmulTPlan(a,s,i,o);return this.recordPass(e,l.shader,[u,t,n,c],l.grid),r.push(u,c),c}recConv2dDirect(e,r,t,n,a,s,i,o,u,c,l,f,g){let p=Math.floor((i+2*g-c)/f)+1,m=Math.floor((o+2*g-l)/f)+1,b=u*p*m,k=this.uniformOf(48);if(this.device.queue.writeBuffer(k,0,new Uint32Array([s,i,o,u,c,l,f,g,p,m])),c===3&&l===3&&f===1&&g===1&&this.convTiledOk){let O=this.storage(b*4);return this.recordPass(e,"conv2d_3x3_tiled",[k,t,n,a,O],[Math.ceil(m/16),Math.ceil(p/16),u]),r.push(k,O),O}let B=this.storage(b*4);return this.recordPass(e,"conv2d_direct",[k,t,n,a,B],this.grid1D(b)),r.push(k,B),B}recConv2dDirectQ8(e,r,t,n,a,s,i,o,u,c,l,f,g){let p=Math.floor((i+2*g-c)/f)+1,m=Math.floor((o+2*g-l)/f)+1,b=u*p*m,k=this.uniformOf(48);if(this.device.queue.writeBuffer(k,0,new Uint32Array([s,i,o,u,c,l,f,g,p,m])),c===3&&l===3&&f===1&&g===1&&this.convTiledQOk){let O=this.storage(b*4);return this.recordPass(e,"conv2d_3x3_tiled_q8",[k,t,n.codes,n.sc,a,O],[Math.ceil(m/16),Math.ceil(p/16),u]),r.push(k,O),O}let B=this.storage(b*4);return this.recordPass(e,"conv2d_direct_q8",[k,t,n.codes,n.sc,a,B],this.grid1D(b)),r.push(k,B),B}recConv2dDirectQ4(e,r,t,n,a,s,i,o,u,c,l,f,g){let p=Math.floor((i+2*g-c)/f)+1,m=Math.floor((o+2*g-l)/f)+1,b=u*p*m,k=this.uniformOf(48);if(this.device.queue.writeBuffer(k,0,new Uint32Array([s,i,o,u,c,l,f,g,p,m])),c===3&&l===3&&f===1&&g===1&&this.convTiledQOk){let O=this.storage(b*4);return this.recordPass(e,"conv2d_3x3_tiled_q4",[k,t,n.nib,n.sc,n.mn,a,O],[Math.ceil(m/16),Math.ceil(p/16),u]),r.push(k,O),O}let B=this.storage(b*4);return this.recordPass(e,"conv2d_direct_q4",[k,t,n.nib,n.sc,n.mn,a,B],this.grid1D(b)),r.push(k,B),B}recGroupNorm(e,r,t,n,a,s,i,o,u){let c=this.uniform([s,i,o],{offset:12,value:u}),l=this.storage(s*i*4);return this.recordPass(e,"group_norm",[c,t,n,a,l],[o,1,1]),r.push(c,l),l}recUnary(e,r,t,n,a){let s=this.storage(a*4);return this.recordPass(e,t,[n,s],this.grid1D(a)),r.push(s),s}recLayernorm(e,r,t,n,a,s,i,o){let u=this.uniform([s,i],{offset:8,value:o}),c=this.storage(s*i*4);return this.recordPass(e,"layernorm",[u,t,n,a,c],[Math.ceil(s/te),1,1]),r.push(u,c),c}recAttentionFull(e,r,t,n,a,s,i,o,u,c,l){let f=this.uniform([s,i,o,u,c,0],{offset:24,value:[l??1/Math.sqrt(u),0]}),g=this.storage(s*i*u*4),p=s*i;return this.attnFullWgOk&&u<=192&&p<=65535?this.recordPass(e,"attention_full_wg",[f,t,n,a,g],[p,1,1]):this.recordPass(e,"attention_full",[f,t,n,a,g],[Math.ceil(p/te),1,1]),r.push(f,g),g}recUpsample(e,r,t,n,a,s,i){let o=this.uniform([n,a,s,i]),u=n*(a*i)*(s*i),c=this.storage(u*4);return this.recordPass(e,"upsample_nearest",[o,t,c],this.grid1D(u)),r.push(o,c),c}recConcat(e,r,t,n,a,s,i){let o=this.storage((a+s)*i*4);return e.copyBufferToBuffer(t,0,o,0,a*i*4),e.copyBufferToBuffer(n,0,o,a*i*4,s*i*4),r.push(o),o}recAddChannelBias(e,r,t,n,a,s){let i=this.uniform([a,s]),o=this.storage(a*s*4);return this.recordPass(e,"add_channel_bias",[i,t,n,o],this.grid1D(a*s)),r.push(i,o),o}recTranspose(e,r,t,n,a){let s=this.uniform([n,a]),i=this.storage(n*a*4);return this.recordPass(e,"transpose2d",[s,t,i],this.grid1D(n*a)),r.push(s,i),i}recGegluSplit(e,r,t,n,a){let s=this.uniform([n,a]),i=this.storage(n*a*4);return this.recordPass(e,"geglu_split",[s,t,i],this.grid1D(n*a)),r.push(s,i),i}recVideoGather(e,r,t,n,a,s){let i=this.uniform([n,a,s]),o=this.storage(s*n*a*4);return this.recordPass(e,"video_motion_gather",[i,t,o],this.grid1D(s*n*a)),r.push(i,o),o}recVideoScatter(e,r,t,n,a,s,i){let o=this.uniform([a,s,i]),u=this.storage(a*s*i*4);return this.recordPass(e,"video_motion_scatter",[o,t,n,u],this.grid1D(a*s*i)),r.push(o,u),u}recVideoAddPe(e,r,t,n,a,s,i){let o=this.uniform([a,s,i]),u=this.storage(i*a*s*4);return this.recordPass(e,"video_add_pe",[o,t,n,u],this.grid1D(i*a*s)),r.push(o,u),u}recAttnTemporal(e,r,t,n,a,s,i,o,u){let c=this.uniform([s,i,o,u],{offset:16,value:1/Math.sqrt(u)}),l=this.storage(s*i*o*u*4);return this.recordPass(e,"attn_temporal",[c,t,n,a,l],this.grid1D(s*i*o)),r.push(c,l),l}recordingSession(){let e=this.device.createCommandEncoder(),r=[],t=n=>{if(n instanceof Float32Array){let a=this.uploadGpu(n);return r.push(a),a}return n};return{conv2d:(n,a,s,i,o,u,c,l,f,g,p)=>a&&a.nib?this.recConv2dDirectQ4(e,r,t(n),a,t(s),i,o,u,c,l,f,g,p):a&&a.codes?this.recConv2dDirectQ8(e,r,t(n),a,t(s),i,o,u,c,l,f,g,p):this.recConv2dDirect(e,r,t(n),t(a),t(s),i,o,u,c,l,f,g,p),groupNorm:(n,a,s,i,o,u,c)=>this.recGroupNorm(e,r,t(n),t(a),t(s),i,o,u,c),silu:(n,a)=>this.recUnary(e,r,"silu",t(n),a),quickGelu:(n,a)=>this.recUnary(e,r,"quick_gelu",t(n),a),gelu:(n,a)=>this.recUnary(e,r,"gelu",t(n),a),relu:(n,a)=>this.recUnary(e,r,"relu",t(n),a),add:(n,a,s)=>this.recBinary(e,r,"add",t(n),t(a),s),geglu:(n,a,s)=>this.recBinary(e,r,"geglu",t(n),t(a),s),matmulT:(n,a,s,i,o)=>this.recMM(e,r,t(n),a instanceof Float32Array?t(a):a,s,i,o,!1),addBias:(n,a,s,i)=>this.recAddBias(e,r,t(n),t(a),s,i),addChannelBias:(n,a,s,i)=>this.recAddChannelBias(e,r,t(n),t(a),s,i),attentionFull:(n,a,s,i,o,u,c,l)=>this.recAttentionFull(e,r,t(n),t(a),t(s),i,o,u,c,l),rope2d:(n,a,s,i,o,u)=>{let c=a instanceof Uint32Array?(()=>{let l=this.uploadGpuRaw(new Uint8Array(a.buffer,a.byteOffset,a.byteLength));return r.push(l),l})():a;return this.recRope2d(e,r,t(n),c,s,i,o,u)},attention:(n,a,s,i,o,u,c,l,f)=>this.recAttention(e,r,t(n),t(a),t(s),i,o,u,c,l,f),upsample:(n,a,s,i,o)=>this.recUpsample(e,r,t(n),a,s,i,o),layernorm:(n,a,s,i,o,u)=>this.recLayernorm(e,r,t(n),t(a),t(s),i,o,u),concat:(n,a,s,i,o)=>this.recConcat(e,r,t(n),t(a),s,i,o),transpose:(n,a,s)=>this.recTranspose(e,r,t(n),a,s),gegluSplit:(n,a,s)=>this.recGegluSplit(e,r,t(n),a,s),videoGather:(n,a,s,i)=>this.recVideoGather(e,r,t(n),a,s,i),videoScatter:(n,a,s,i,o)=>this.recVideoScatter(e,r,t(n),t(a),s,i,o),videoAddPe:(n,a,s,i,o)=>this.recVideoAddPe(e,r,t(n),t(a),s,i,o),attnTemporal:(n,a,s,i,o,u,c)=>this.recAttnTemporal(e,r,t(n),t(a),t(s),i,o,u,c),alloc:n=>{let a=this.storage(n);return r.push(a),a},copy:(n,a,s,i,o)=>{e.copyBufferToBuffer(s,i,n,a,o)},finish:async(n,a)=>{this.device.queue.submit([e.finish()]);let s=await this.readBack(n,a*4);return this.release(r),s},finishKeep:n=>{this.device.queue.submit([e.finish()]);let a=r.indexOf(n);return a>=0&&r.splice(a,1),this.release(r),n},finishKeepMany:n=>{this.device.queue.submit([e.finish()]);for(let a of n){let s=r.indexOf(a);s>=0&&r.splice(s,1)}return this.release(r),n}}}readGpu(e,r){return this.readBack(e,r*4)}trimPool(e=64<<20){let r=[...this.bufferPool.keys()].sort((n,a)=>a-n),t=0;for(let n of this.bufferPool.values())for(let a of n)t+=this.poolSize.get(a)??0;for(let n of r){let a=this.bufferPool.get(n);for(;a.length&&t>e;){let s=a.pop();this.pooled.delete(s),this.poolSize.delete(s),s.destroy?.(),t-=n}}}releaseGpu(e){this.release(e)}waitGpu(){return this.device.queue.onSubmittedWorkDone()}async benchMatmul(e,r,t,n,a,s={}){let{iters:i=10,shared:o=!0,shared2:u=!0,wF16:c=!1}=s,l=this.f16SharedOk,f=this.qSharedOk,g=this.qShared2Ok;this.f16SharedOk=o,this.qSharedOk=o,this.qShared2Ok=o&&u;let p=this.uploadGpu(e),m=[],b=this.device.createCommandEncoder();this.recMM(b,m,p,r,t,n,a,c),this.device.queue.submit([b.finish()]),await this.device.queue.onSubmittedWorkDone();let k=this.device.createCommandEncoder();for(let q=0;q<i;q++)this.recMM(k,m,p,r,t,n,a,c);let B=performance.now();this.device.queue.submit([k.finish()]),await this.device.queue.onSubmittedWorkDone();let O=(performance.now()-B)/i;return this.release(m),p.destroy?.(),this.f16SharedOk=l,this.qSharedOk=f,this.qShared2Ok=g,O}destroy(){try{this.profiler?.destroy()}catch{}this.profiler=null;try{this.device?.destroy?.()}catch{}this.bufferPool.clear(),this.uniformPool.clear()}f16ToF32Gpu(e,r){let t=this.uploadGpuRawF16(e),n=this.device.createBuffer({size:r*4,usage:X.STORAGE_USAGE}),a=this.uniformOf(16);return this.device.queue.writeBuffer(a,0,new Uint32Array([r])),this.dispatch("f16_to_f32",[a,t,n],this.grid1D(Math.ceil(r/2))),t.destroy?.(),this.release([a]),n}quantizeQ8Gpu(e){let r=e instanceof Float32Array?e.length:e.n;if(r%32!==0)return this.uploadGpu(e);let t=e instanceof Float32Array?this.buf(e,X.STORAGE_USAGE):this.f16ToF32Gpu(e.f16,r),n=this.f32ToQ8Gpu(t,r);return t.destroy?.(),n}async validateResidentOps(){let e=globalThis,r=x=>Float32Array.from({length:x},()=>(Math.random()*2-1)*.5),t=(x,y,P=.005)=>x.length===y.length&&x.every((U,_)=>Math.abs(U-y[_])<=P*(1+Math.abs(y[_]))),n=4,a=4,s=4,i=4,o=2,u=1e-5,c=i*a*s,l=r(n*a*s),f=r(i*n*9),g=r(i),p=r(i),m=r(i),b=await this.silu(await this.groupNorm(await this.conv2dDirect(l,f,g,n,a,s,i,3,3,1,1),p,m,i,a*s,o,u)),k=[],B=this.device.createCommandEncoder(),O=this.uploadGpu(l),q=this.uploadGpu(f),C=this.uploadGpu(g),j=this.uploadGpu(p),A=this.uploadGpu(m);k.push(O,q,C,j,A);let w=this.recConv2dDirect(B,k,O,q,C,n,a,s,i,3,3,1,1);w=this.recGroupNorm(B,k,w,j,A,i,a*s,o,u),w=this.recUnary(B,k,"silu",w,c);let v=this.device.createBuffer({size:c*4,usage:e.GPUBufferUsage.COPY_DST|e.GPUBufferUsage.MAP_READ});B.copyBufferToBuffer(w,0,v,0,c*4),this.device.queue.submit([B.finish()]),await v.mapAsync(e.GPUMapMode.READ);let h=new Float32Array(v.getMappedRange().slice(0));return v.unmap(),v.destroy(),this.release(k),t(h,b)?null:"resident_ops"}recMatmulQ4(e,r,t,n,a,s,i){let o=this.uniform([a,s,i]),u=this.storage(a*i*4);if(a===1&&this.gemvOk){let c=this.gemvGrid(i);this.recordPass(e,"matmul_t_q4_vec",[this.uniform([a,s,i,c.stride]),t,n.nib,n.sc,n.mn,u],c.grid)}else a>=64&&this.qSharedOk&&this.qShared2Ok?this.recordPass(e,"matmul_t_q4_shared2",[o,t,n.nib,n.sc,n.mn,u],[Math.ceil(i/128),Math.ceil(a/64),1]):a>=32&&this.qSharedOk?this.recordPass(e,"matmul_t_q4_shared",[o,t,n.nib,n.sc,n.mn,u],[Math.ceil(i/64),Math.ceil(a/32),1]):a>=2?this.recordPass(e,"matmul_t_q4_tiled",[o,t,n.nib,n.sc,n.mn,u],[Math.ceil(Math.ceil(a/4)/8),Math.ceil(i/8),1]):this.recordPass(e,"matmul_t_q4",[o,t,n.nib,n.sc,n.mn,u],[Math.ceil(a/8),Math.ceil(i/8),1]);return r.push(o,u),u}recMatmulQ8(e,r,t,n,a,s,i){let o=this.uniform([a,s,i]),u=this.storage(a*i*4);if(a===1&&this.gemvOk){let c=this.gemvGrid(i);this.recordPass(e,"matmul_t_q8_vec",[this.uniform([a,s,i,c.stride]),t,n.codes,n.sc,u],c.grid)}else a>=64&&this.qSharedOk&&this.qShared2Ok?this.recordPass(e,"matmul_t_q8_shared2",[o,t,n.codes,n.sc,u],[Math.ceil(i/128),Math.ceil(a/64),1]):a>=32&&this.qSharedOk?this.recordPass(e,"matmul_t_q8_shared",[o,t,n.codes,n.sc,u],[Math.ceil(i/64),Math.ceil(a/32),1]):a>=2?this.recordPass(e,"matmul_t_q8_tiled",[o,t,n.codes,n.sc,u],[Math.ceil(Math.ceil(a/4)/8),Math.ceil(i/8),1]):this.recordPass(e,"matmul_t_q8",[o,t,n.codes,n.sc,u],[Math.ceil(a/8),Math.ceil(i/8),1]);return r.push(o,u),u}gemvGrid(e){return e<=32768?{grid:[e,1,1],stride:32768}:{grid:[32768,Math.ceil(e/32768),1],stride:32768}}async matmulQ4Vec(e,r,t,n,a,s){let i=globalThis,o=i.GPUBufferUsage.STORAGE|i.GPUBufferUsage.COPY_DST,u=this.gemvGrid(s),c=this.device.createBuffer({size:16,usage:i.GPUBufferUsage.UNIFORM|i.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(c,0,new Uint32Array([1,a,s,u.stride]));let l=this.device.createBuffer({size:s*4,usage:o|i.GPUBufferUsage.COPY_SRC});return this.run("matmul_t_q4_vec",[c,this.buf(e,o),r,t,n,l],u.grid,l,s*4)}async matmulQ8Vec(e,r,t,n,a){let s=globalThis,i=s.GPUBufferUsage.STORAGE|s.GPUBufferUsage.COPY_DST,o=this.gemvGrid(a),u=this.device.createBuffer({size:16,usage:s.GPUBufferUsage.UNIFORM|s.GPUBufferUsage.COPY_DST});this.device.queue.writeBuffer(u,0,new Uint32Array([1,n,a,o.stride]));let c=this.device.createBuffer({size:a*4,usage:i|s.GPUBufferUsage.COPY_SRC});return this.run("matmul_t_q8_vec",[u,this.buf(e,i),r,t,c],o.grid,c,a*4)}recMatmulQ3(e,r,t,n,a,s,i){let o=this.uniform([a,s,i]),u=this.storage(a*i*4);return this.recordPass(e,"matmul_t_q3",[o,t,n.lo,n.hi,n.sc,n.mn,u],[Math.ceil(a/8),Math.ceil(i/8),1]),r.push(o,u),u}recMM(e,r,t,n,a,s,i,o){return n&&n.q3?this.recMatmulQ3(e,r,t,n,a,s,i):n&&n.nib?this.recMatmulQ4(e,r,t,n,a,s,i):n&&n.codes?this.recMatmulQ8(e,r,t,n,a,s,i):this.recMatmulT(e,r,t,n,a,s,i,o)}recRmsnorm(e,r,t,n,a,s,i,o=!1){let u=this.uniform([a,s,0,o?1:0],{offset:8,value:i}),c=this.storage(a*s*4);return this.rmsVecOk&&a<=65535?this.recordPass(e,"rmsnorm_vec",[u,t,n,c],[a,1,1]):this.recordPass(e,"rmsnorm",[u,t,n,c],[Math.ceil(a/te),1,1]),r.push(u,c),c}recRope(e,r,t,n,a,s,i,o,u=!1){let c=this.uniform([n,a,s,i],{offset:16,value:o});this.device.queue.writeBuffer(c,20,new Uint32Array([u?1:0]));let l=this.storage(n*a*4);return this.recordPass(e,"rope",[c,t,l],[Math.ceil(n/te),1,1]),r.push(c,l),l}recRopeMrope(e,r,t,n,a,s,i,o,u){let c=u[0],l=u[0]+u[1],f=this.uniform([a,s,i,c,l],{offset:20,value:o}),g=this.storage(a*s*4);return this.recordPass(e,"rope_mrope",[f,t,n,g],[Math.ceil(a/te),1,1]),r.push(f,g),g}preparePositions(e,r){if(e.positions&&e.mropeSections){let t=this.storage(e.positions.byteLength);this.device.queue.writeBuffer(t,0,e.positions),r.push(t),e._posGpu=t}if(e.ropeFactors){let t=this.storage(e.ropeFactors.byteLength);this.device.queue.writeBuffer(t,0,e.ropeFactors),r.push(t),e._ffGpu=t}}recRope2d(e,r,t,n,a,s,i,o){let u=this.uniform([a,s,i,0],{offset:16,value:o}),c=this.storage(a*s*4);return this.recordPass(e,"rope_2d",[u,t,n,c],[Math.ceil(a/te),1,1]),r.push(u,c),c}recRopeFactors(e,r,t,n,a,s,i,o,u,c=!1){let l=this.uniform([a,s,i,o],{offset:16,value:u});this.device.queue.writeBuffer(l,20,new Uint32Array([c?1:0]));let f=this.storage(a*s*4);return this.recordPass(e,"rope_factors",[l,t,n,f],[Math.ceil(a/te),1,1]),r.push(l,f),f}recAttention(e,r,t,n,a,s,i,o,u,c,l,f,g=0,p=0){let m=this.attnUniform(s,i,o,u,c,l,f??1/Math.sqrt(u),g,p),b=this.storage(s*i*u*4);return this.attnDecodeOk&&s*i<256&&u<=128?this.recordPass(e,"attention_decode",[m,t,n,a,b],[s*i,1,1]):this.attnPrefillOk&&u<=128?this.recordPass(e,"attention_prefill",[m,t,n,a,b],[Math.ceil(s/4)*i,1,1]):this.recordPass(e,"attention",[m,t,n,a,b],[Math.ceil(s*i/te),1,1]),r.push(m,b),b}recQuantizeKv(e,r,t,n,a,s,i,o,u){let c=this.uniform([s,i,o,u]);this.recordPass(e,"quantize_kv",[c,t,n,a],this.grid1D(s*i)),r.push(c)}recAttentionQ8(e,r,t,n,a,s,i,o,u,c,l,f,g,p,m=0,b=0){let k=this.attnUniform(o,u,c,l,f,g,p??1/Math.sqrt(l),m,b),B=this.storage(o*u*l*4);return this.attnDecodeOk&&o*u<256&&l<=128?this.recordPass(e,"attention_decode_q8kv",[k,t,n,a,s,i,B],[o*u,1,1]):this.attnPrefillOk&&l<=128?this.recordPass(e,"attention_prefill_q8kv",[k,t,n,a,s,i,B],[Math.ceil(o/4)*u,1,1]):this.recordPass(e,"attention_q8kv",[k,t,n,a,s,i,B],[Math.ceil(o*u/te),1,1]),r.push(k,B),B}recAddBias(e,r,t,n,a,s){let i=this.uniform([a,s]),o=this.storage(a*s*4);return this.recordPass(e,"addbias",[i,t,n,o],this.grid1D(a*s)),r.push(i,o),o}recBinary(e,r,t,n,a,s){let i=this.storage(s*4);return this.recordPass(e,t,[n,a,i],this.grid1D(s)),r.push(i),i}recLfm2ShortConv(e,r,t,n,a,s,i){let o=this.uniform([s,i]),u=this.storage(s*4);return this.recordPass(e,"lfm2_shortconv",[o,t,a,n,u],this.grid1D(s)),r.push(o,u),u}recordLayerKV(e,r,t,n,a,s,i){let o=i.k,u=i.v,{seq:c,d:l,nHeads:f,nKvHeads:g,headDim:p,ffn:m,ropeTheta:b,eps:k}=n,B=g*p,O=s+c,q=a.matF16===!0,C=f*p,j=n.rmsGainOnePlus===!0,A=n.attnLogitSoftcap??0,w=n.act==="gelu"?"geglu":"swiglu",v=this.recRmsnorm(e,r,t,a.attnNorm,c,l,k,j),h=this.recMM(e,r,v,a.wq,c,l,C,q),x=this.recMM(e,r,v,a.wk,c,l,B,q),y=this.recMM(e,r,v,a.wv,c,l,B,q);a.bq&&(h=this.recAddBias(e,r,h,a.bq,c,C)),a.bk&&(x=this.recAddBias(e,r,x,a.bk,c,B)),a.bv&&(y=this.recAddBias(e,r,y,a.bv,c,B)),a.qNorm&&(h=this.recRmsnorm(e,r,h,a.qNorm,c*f,p,k,j)),a.kNorm&&(x=this.recRmsnorm(e,r,x,a.kNorm,c*g,p,k,j));let P=n._posGpu,U=n._ffGpu,_=n.ropeInterleaved===!0,G=(N,S,L)=>n.skipRope?N:P?this.recRopeMrope(e,r,N,P,S,p,L,b,n.mropeSections):U?this.recRopeFactors(e,r,N,U,S,p,L,s,b,_):this.recRope(e,r,N,S,p,L,s,b,_),F=G(h,c*f,f),M=G(x,c*g,g),R;if(i.kScale)this.recQuantizeKv(e,r,M,o,i.kScale,c,g,p,s),this.recQuantizeKv(e,r,y,u,i.vScale,c,g,p,s),R=this.recAttentionQ8(e,r,F,o,i.kScale,u,i.vScale,c,f,g,p,O,s,n.attnScale,A,n.window??0);else{let N=B*4;e.copyBufferToBuffer(M,0,o,s*N,c*N),e.copyBufferToBuffer(y,0,u,s*N,c*N),R=this.recAttention(e,r,F,o,u,c,f,g,p,O,s,n.attnScale,A,n.window??0)}let T=this.recMM(e,r,R,a.wo,c,C,l,q);a.postAttnNorm&&(T=this.recRmsnorm(e,r,T,a.postAttnNorm,c,l,k,j));let D=this.recBinary(e,r,"add",t,T,c*l),E=this.recRmsnorm(e,r,D,a.ffnNorm,c,l,k,j),Q=this.recMM(e,r,E,a.wgate,c,l,m,q),$=this.recMM(e,r,E,a.wup,c,l,m,q),V=this.recBinary(e,r,w,Q,$,c*m),Y=this.recMM(e,r,V,a.wdown,c,m,l,q);return a.postFfnNorm&&(Y=this.recRmsnorm(e,r,Y,a.postFfnNorm,c,l,k,j)),this.recBinary(e,r,"add",D,Y,c*l)}setKvQuant(e){this.kvQuant!==e&&(this.kvQuant=e,this.resetKvGpu())}resetKvGpu(){for(let e of this.kvGpu.values())e.k.destroy?.(),e.v.destroy?.(),e.kScale?.destroy?.(),e.vScale?.destroy?.();this.kvGpu.clear(),this.kvSession="";for(let e of this.bufferPool.values())for(let r of e)r.destroy?.();this.bufferPool.clear()}clearKvCache(){this.resetKvGpu()}ensureKv(e,r,t,n){let a=this.kvGpu.get(e);if(a&&a.cap>=r)return a;let s=Math.max(r,(a?.cap??0)+1024,1024),i=this.kvQuant,o=this.storage(s*t*(i?1:4)),u=this.storage(s*t*(i?1:4)),c=i?this.storage(s*n*4):void 0,l=i?this.storage(s*n*4):void 0;if(a){let g=this.device.createCommandEncoder();g.copyBufferToBuffer(a.k,0,o,0,a.cap*t*(i?1:4)),g.copyBufferToBuffer(a.v,0,u,0,a.cap*t*(i?1:4)),i&&a.kScale&&(g.copyBufferToBuffer(a.kScale,0,c,0,a.cap*n*4),g.copyBufferToBuffer(a.vScale,0,l,0,a.cap*n*4)),this.device.queue.submit([g.finish()]),a.k.destroy?.(),a.v.destroy?.(),a.kScale?.destroy?.(),a.vScale?.destroy?.()}let f={k:o,v:u,cap:s,kScale:c,vScale:l};return this.kvGpu.set(e,f),f}async runDecodeGpu(e,r,t,n,a,s){let{seq:i,d:o,nKvHeads:u,headDim:c,eps:l}=r,f=u*c,g=n+i;(s!==this.kvSession||n===0)&&(n>0&&console.error(`[kv] session "${s}" inconnue avec pastLen=${n} : cache perdu, sortie invalide. Le caller doit repartir de pastLen 0.`),this.resetKvGpu(),this.kvSession=s);for(let q=0;q<t.length;q++)this.ensureKv(q,g,f,u);let p=[];this.preparePositions(r,p);let m=this.device.createCommandEncoder(),b=this.storage(e.byteLength);this.device.queue.writeBuffer(b,0,e),p.push(b);for(let q=0;q<t.length;q++){let C=this.kvGpu.get(q);b=this.recordLayerKV(m,p,b,lt(r,i,q,this.swaOk),t[q],n,C)}let k=this.recRmsnorm(m,p,b,a,i,o,l,r.rmsGainOnePlus===!0),B=this.storage(o*4);m.copyBufferToBuffer(k,(i-1)*o*4,B,0,o*4),this.device.queue.submit([m.finish()]);let O=await this.readBack(B,o*4);return p.push(B),this.release(p),O}async decodeLogitsQ8(e,r,t,n,a,s,i,o){let u=globalThis,{seq:c,d:l,nKvHeads:f,headDim:g,eps:p}=r,m=f*g,b=n+c;(s!==this.kvSession||n===0)&&(n>0&&console.error(`[kv] session "${s}" inconnue avec pastLen=${n} : cache perdu, sortie invalide. Le caller doit repartir de pastLen 0.`),this.resetKvGpu(),this.kvSession=s);for(let v=0;v<t.length;v++)this.ensureKv(v,b,m,f);let k=[];this.preparePositions(r,k);let B=this.device.createCommandEncoder(),O=this.storage(e.byteLength);this.device.queue.writeBuffer(O,0,e),k.push(O);for(let v=0;v<t.length;v++){let h=this.kvGpu.get(v);O=this.recordLayerKV(B,k,O,lt(r,c,v,this.swaOk),t[v],n,h)}let q=this.recRmsnorm(B,k,O,a,c,l,p,r.rmsGainOnePlus===!0),C=this.storage(l*4);B.copyBufferToBuffer(q,(c-1)*l*4,C,0,l*4),k.push(C);let j=this.storage(o*4);k.push(j);for(let v of i){let h=this.recMM(B,k,C,v.w,1,l,v.rows,!1);B.copyBufferToBuffer(h,0,j,v.r0*4,v.rows*4)}let A=this.device.createBuffer({size:o*4,usage:u.GPUBufferUsage.COPY_DST|u.GPUBufferUsage.MAP_READ});B.copyBufferToBuffer(j,0,A,0,o*4),this.device.queue.submit([B.finish()]),await A.mapAsync(u.GPUMapMode.READ);let w=new Float32Array(A.getMappedRange().slice(0));return A.unmap(),A.destroy(),this.release(k),w}async decodeTopKQ8(e,r,t,n,a,s,i,o,u,c,l,f=64){let g=globalThis,{seq:p,d:m,nKvHeads:b,headDim:k,eps:B}=r,O=b*k,q=n+p;(s!==this.kvSession||n===0)&&(n>0&&console.error(`[kv] session "${s}" inconnue avec pastLen=${n} : cache perdu, sortie invalide. Le caller doit repartir de pastLen 0.`),this.resetKvGpu(),this.kvSession=s);for(let G=0;G<t.length;G++)this.ensureKv(G,q,O,b);let C=X.timingOn?(G,F)=>console.info(`[timing:gpu] ${G} ${(performance.now()-F).toFixed(0)} ms`):null,j=performance.now(),A=[];this.preparePositions(r,A);let w=this.device.createCommandEncoder(),v=this.storage(e.byteLength);this.device.queue.writeBuffer(v,0,e),A.push(v);for(let G=0;G<t.length;G++){let F=this.kvGpu.get(G);v=this.recordLayerKV(w,A,v,lt(r,p,G,this.swaOk),t[G],n,F)}let h=this.recRmsnorm(w,A,v,a,p,m,B,r.rmsGainOnePlus===!0),x=this.storage(m*4);w.copyBufferToBuffer(h,(p-1)*m*4,x,0,m*4),A.push(x);let y=this.storage(o*4);A.push(y);for(let G of i){let F=this.recMM(w,A,x,G.w,1,m,G.rows,!1);w.copyBufferToBuffer(F,0,y,G.r0*4,G.rows*4)}if(l&&l>0){let G=this.uniform([o],{offset:4,value:l});this.recordPass(w,"softcap_logits",[G,y],this.grid1D(o)),A.push(G)}if(c&&c!==1&&u.length){let G=Uint32Array.from(u),F=this.bufU32(G,g.GPUBufferUsage.STORAGE|g.GPUBufferUsage.COPY_DST),M=this.uniform([G.length],{offset:4,value:c});this.recordPass(w,"penalize_logits",[M,F,y],this.grid1D(G.length)),A.push(M,F)}let P=this.storage(f*2*4);A.push(P);{let G=this.uniform([o,f]);this.recordPass(w,this.topKParOk?"top_k_par":"top_k",[G,y,P],[1,1,1]),A.push(G)}let U=this.device.createBuffer({size:f*2*4,usage:g.GPUBufferUsage.COPY_DST|g.GPUBufferUsage.MAP_READ});w.copyBufferToBuffer(P,0,U,0,f*2*4),C?.("enregistrement des passes (compilation des pipelines incluse)",j),j=performance.now(),this.device.queue.submit([w.finish()]),await U.mapAsync(g.GPUMapMode.READ),C?.("execution GPU (submit + readback)",j);let _=new Uint32Array(U.getMappedRange().slice(0));return U.unmap(),U.destroy(),this.release(A),{ids:_.slice(0,f),vals:new Float32Array(_.buffer,f*4,f)}}resetLfm2State(){for(let e of this.lfm2KvGpu.values())e.k.destroy?.(),e.v.destroy?.();for(let e of this.lfm2ConvGpu.values())e.destroy?.();this.lfm2KvGpu.clear(),this.lfm2ConvGpu.clear(),this.lfm2Session="";for(let e of this.bufferPool.values())for(let r of e)r.destroy?.();this.bufferPool.clear()}clearLfm2State(){this.resetLfm2State()}ensureLfm2Kv(e,r,t){let n=this.lfm2KvGpu.get(e);if(n&&n.cap>=r)return n;let a=Math.max(r,(n?.cap??0)+1024,1024),s=this.storage(a*t*4),i=this.storage(a*t*4);if(n){let u=this.device.createCommandEncoder();u.copyBufferToBuffer(n.k,0,s,0,n.cap*t*4),u.copyBufferToBuffer(n.v,0,i,0,n.cap*t*4),this.device.queue.submit([u.finish()]),n.k.destroy?.(),n.v.destroy?.()}let o={k:s,v:i,cap:a};return this.lfm2KvGpu.set(e,o),o}ensureLfm2Conv(e,r){let t=this.lfm2ConvGpu.get(e);return t||(t=this.storage(r*4),this.device.queue.writeBuffer(t,0,new Float32Array(r)),this.lfm2ConvGpu.set(e,t)),t}recLfm2ShortConvBatch(e,r,t,n,a,s,i,o){let u=this.uniform([s,i,o]),c=this.storage(o*s*4);this.recordPass(e,"lfm2_shortconv_batch",[u,t,a,n,c],this.grid1D(o*s));let l=this.uniform([s,i,o]);return this.recordPass(e,"lfm2_shortconv_state",[l,t,n],this.grid1D((i-1)*s)),r.push(u,l,c),c}recordLfm2(e,r,t,n,a,s,i,o){let{D:u,nHeads:c,nKvHeads:l,headDim:f,ffn:g,eps:p,theta:m,lc:b}=a,k=l*f,B=c*f,O=k*4;for(let C=0;C<s.length;C++)s[C].conv?this.ensureLfm2Conv(C,(b-1)*u):this.ensureLfm2Kv(C,o+n,k);if(n>=b-1&&this.lfm2BatchOk){let C=this.storage(n*u*4);this.device.queue.writeBuffer(C,0,t),r.push(C);for(let A=0;A<s.length;A++){let w=s[A],v=this.recRmsnorm(e,r,C,w.attnNorm,n,u,p),h;if(w.conv){let G=this.recMM(e,r,v,w.inProj,n,u,3*u,!1),F=this.recLfm2ShortConvBatch(e,r,G,this.lfm2ConvGpu.get(A),w.convW,u,b,n);h=this.recMM(e,r,F,w.outProj,n,u,u,!1)}else{let G=this.recMM(e,r,v,w.wq,n,u,B,!1),F=this.recMM(e,r,v,w.wk,n,u,k,!1),M=this.recMM(e,r,v,w.wv,n,u,k,!1);G=this.recRmsnorm(e,r,G,w.qNorm,n*c,f,p),F=this.recRmsnorm(e,r,F,w.kNorm,n*l,f,p),G=this.recRope(e,r,G,n*c,f,c,o,m),F=this.recRope(e,r,F,n*l,f,l,o,m);let R=this.lfm2KvGpu.get(A);e.copyBufferToBuffer(F,0,R.k,o*O,n*O),e.copyBufferToBuffer(M,0,R.v,o*O,n*O);let T=this.recAttention(e,r,G,R.k,R.v,n,c,l,f,o+n,o);h=this.recMM(e,r,T,w.wo,n,B,u,!1)}C=this.recBinary(e,r,"add",C,h,n*u);let x=this.recRmsnorm(e,r,C,w.ffnNorm,n,u,p),y=this.recMM(e,r,x,w.wgate,n,u,g,!1),P=this.recMM(e,r,x,w.wup,n,u,g,!1),U=this.recBinary(e,r,"swiglu",y,P,n*g),_=this.recMM(e,r,U,w.wdown,n,g,u,!1);C=this.recBinary(e,r,"add",C,_,n*u)}let j=this.storage(u*4);return r.push(j),e.copyBufferToBuffer(C,(n-1)*u*4,j,0,u*4),this.recRmsnorm(e,r,j,i,1,u,p)}let q=null;for(let C=0;C<n;C++){let j=o+C,A=this.storage(u*4);this.device.queue.writeBuffer(A,0,t.subarray(C*u,(C+1)*u)),r.push(A);for(let w=0;w<s.length;w++){let v=s[w],h=this.recRmsnorm(e,r,A,v.attnNorm,1,u,p),x;if(v.conv){let F=this.recMM(e,r,h,v.inProj,1,u,3*u,!1),M=this.recLfm2ShortConv(e,r,F,this.lfm2ConvGpu.get(w),v.convW,u,b);x=this.recMM(e,r,M,v.outProj,1,u,u,!1)}else{let F=this.recMM(e,r,h,v.wq,1,u,B,!1),M=this.recMM(e,r,h,v.wk,1,u,k,!1),R=this.recMM(e,r,h,v.wv,1,u,k,!1);F=this.recRmsnorm(e,r,F,v.qNorm,c,f,p),M=this.recRmsnorm(e,r,M,v.kNorm,l,f,p),F=this.recRope(e,r,F,c,f,c,j,m),M=this.recRope(e,r,M,l,f,l,j,m);let T=this.lfm2KvGpu.get(w);e.copyBufferToBuffer(M,0,T.k,j*O,O),e.copyBufferToBuffer(R,0,T.v,j*O,O);let D=this.recAttention(e,r,F,T.k,T.v,1,c,l,f,j+1,j);x=this.recMM(e,r,D,v.wo,1,B,u,!1)}A=this.recBinary(e,r,"add",A,x,u);let y=this.recRmsnorm(e,r,A,v.ffnNorm,1,u,p),P=this.recMM(e,r,y,v.wgate,1,u,g,!1),U=this.recMM(e,r,y,v.wup,1,u,g,!1),_=this.recBinary(e,r,"swiglu",P,U,g),G=this.recMM(e,r,_,v.wdown,1,g,u,!1);A=this.recBinary(e,r,"add",A,G,u)}C===n-1&&(q=this.recRmsnorm(e,r,A,i,1,u,p))}return q}lfm2SessionReset(e,r){(e!==this.lfm2Session||r===0)&&(r>0&&console.error(`[lfm2] session "${e}" inconnue avec pastLen=${r} : \xE9tat perdu, sortie invalide. Repartir de pastLen 0.`),this.resetLfm2State(),this.lfm2Session=e)}async lfm2PrefillGpu(e,r,t,n,a,s,i){this.lfm2SessionReset(i,s);let o=[],u=this.device.createCommandEncoder();this.recordLfm2(u,o,e,r,t,n,a,s),this.device.queue.submit([u.finish()]),await this.device.queue.onSubmittedWorkDone(),this.release(o)}async lfm2LogitsGpu(e,r,t,n,a,s,i,o){let u=globalThis;this.lfm2SessionReset(o,i);let c=[],l=this.device.createCommandEncoder(),f=this.recordLfm2(l,c,e,r,t,n,s,i),g=this.recMM(l,c,f,a,1,t.D,t.vocab,!1),p=this.device.createBuffer({size:t.vocab*4,usage:u.GPUBufferUsage.COPY_DST|u.GPUBufferUsage.MAP_READ});l.copyBufferToBuffer(g,0,p,0,t.vocab*4),this.device.queue.submit([l.finish()]),await p.mapAsync(u.GPUMapMode.READ);let m=new Float32Array(p.getMappedRange().slice(0));return p.unmap(),p.destroy(),this.release(c),m}async lfm2TopKGpu(e,r,t,n,a,s,i,o,u,c,l=64){let f=globalThis;this.lfm2SessionReset(o,i);let g=[],p=this.device.createCommandEncoder(),m=this.recordLfm2(p,g,e,r,t,n,s,i),b=this.recMM(p,g,m,a,1,t.D,t.vocab,!1);if(c&&c!==1&&u.length){let q=Uint32Array.from(u),C=this.bufU32(q,f.GPUBufferUsage.STORAGE|f.GPUBufferUsage.COPY_DST),j=this.uniform([q.length],{offset:4,value:c});this.recordPass(p,"penalize_logits",[j,C,b],this.grid1D(q.length)),g.push(j,C)}let k=this.storage(l*2*4);g.push(k);{let q=this.uniform([t.vocab,l]);this.recordPass(p,this.topKParOk?"top_k_par":"top_k",[q,b,k],[1,1,1]),g.push(q)}let B=this.device.createBuffer({size:l*2*4,usage:f.GPUBufferUsage.COPY_DST|f.GPUBufferUsage.MAP_READ});p.copyBufferToBuffer(k,0,B,0,l*2*4),this.device.queue.submit([p.finish()]),await B.mapAsync(f.GPUMapMode.READ);let O=new Uint32Array(B.getMappedRange().slice(0));return B.unmap(),B.destroy(),this.release(g),{ids:O.slice(0,l),vals:new Float32Array(O.buffer,l*4,l)}}resetRwkvState(){for(let e of this.rwkvStateGpu.values())e.S.destroy?.(),e.tm.destroy?.(),e.cm.destroy?.();this.rwkvStateGpu.clear(),this.rwkvVFirst?.destroy?.(),this.rwkvVFirst=null,this.rwkvSession="";for(let e of this.bufferPool.values())for(let r of e)r.destroy?.();this.bufferPool.clear()}clearRwkvState(){this.resetRwkvState()}ensureRwkvState(e,r,t,n){let a=this.rwkvStateGpu.get(e);if(!a){let s=this.storage(t*n*n*4),i=this.storage(r*4),o=this.storage(r*4);this.device.queue.writeBuffer(s,0,new Float32Array(t*n*n)),this.device.queue.writeBuffer(i,0,new Float32Array(r)),this.device.queue.writeBuffer(o,0,new Float32Array(r)),a={S:s,tm:i,cm:o},this.rwkvStateGpu.set(e,a)}return a}rwkvSessionReset(e,r){(e!==this.rwkvSession||r===0)&&(r>0&&console.error(`[rwkv] session "${e}" inconnue avec pastLen=${r} : \xE9tat perdu, sortie invalide. Repartir de pastLen 0.`),this.resetRwkvState(),this.rwkvSession=e)}recRwkvToken(e,r,t,n,a,s){let{D:i,H:o,NH:u}=n,c=1e-5,l=64e-5;for(let f=0;f<a.length;f++){let g=a[f],p=this.rwkvStateGpu.get(f),m=this.recLayernorm(e,r,t,g.attnNormW,g.attnNormB,1,i,c),b=this.storage(6*i*4);{let L=this.uniform([i]);this.recordPass(e,"rwkv_token_shift",[L,m,p.tm,g.lerpFused,b],this.grid1D(6*i)),r.push(L,b)}e.copyBufferToBuffer(m,0,p.tm,0,i*4);let k=L=>{let K=this.storage(i*4);return e.copyBufferToBuffer(b,L*i*4,K,0,i*4),r.push(K),K},B=k(0),O=k(1),q=k(2),C=k(3),j=k(4),A=k(5),w=this.recMM(e,r,B,g.R,1,i,i,!1),v=this.recMM(e,r,q,g.K,1,i,i,!1),h=this.recMM(e,r,C,g.V,1,i,i,!1),x=this.recUnary(e,r,"tanh_act",this.recMM(e,r,O,g.w1,1,i,g.rw,!1),g.rw),y=this.recMM(e,r,x,g.w2,1,g.rw,i,!1),P=this.storage(i*4);this.recordPass(e,"rwkv_decay",[g.w0,y,P],this.grid1D(i)),r.push(P);let U=this.recMM(e,r,this.recMM(e,r,j,g.a1,1,i,g.ra,!1),g.a2,1,g.ra,i,!1),_=this.storage(i*4);this.recordPass(e,"rwkv_bias_sigmoid",[g.a0,U,_],this.grid1D(i)),r.push(_);let G=this.recUnary(e,r,"sigmoid",this.recMM(e,r,A,g.g1,1,i,g.rg,!1),g.rg),F=this.recMM(e,r,G,g.g2,1,g.rg,i,!1);if(f===0)e.copyBufferToBuffer(h,0,s,0,i*4);else{let L=this.recMM(e,r,this.recMM(e,r,C,g.v1,1,i,g.rv,!1),g.v2,1,g.rv,i,!1);this.recordPass(e,"rwkv_vresid",[h,s,g.v0,L],this.grid1D(i))}let M=this.storage(i*4),R=this.storage(i*4),T=this.storage(i*4);{let L=this.uniform([u,o]);this.recordPass(e,"rwkv_kprep",[L,v,_,g.kk,g.ka,M,R,T],this.grid1D(u)),r.push(L,M,R,T)}let D=this.storage(i*4);{let L=this.uniform([u,o]);this.recordPass(e,"rwkv_wkv7",[L,w,P,M,h,R,T,p.S,D],this.grid1D(u*o)),r.push(L,D)}let E=this.storage(i*4);{let L=this.uniform([u,o],{offset:8,value:l});this.recordPass(e,"rwkv_out_gn",[L,D,w,M,g.rk,h,g.lnWB,E],this.grid1D(u)),r.push(L,E)}let Q=this.recBinary(e,r,"mul",E,F,i),$=this.recMM(e,r,Q,g.O,1,i,i,!1);t=this.recBinary(e,r,"add",t,$,i);let V=this.recLayernorm(e,r,t,g.attnNorm2W,g.attnNorm2B,1,i,c),Y=this.storage(i*4);this.recordPass(e,"rwkv_lerp",[V,p.cm,g.lerpK,Y],this.grid1D(i)),r.push(Y),e.copyBufferToBuffer(V,0,p.cm,0,i*4);let N=this.recUnary(e,r,"sqrelu",this.recMM(e,r,Y,g.cmK,1,i,g.ffn,!1),g.ffn),S=this.recMM(e,r,N,g.cmV,1,g.ffn,i,!1);t=this.recBinary(e,r,"add",t,S,i)}return t}recordRwkv(e,r,t,n,a,s,i){let{D:o,H:u,NH:c}=a;for(let f=0;f<s.length;f++)this.ensureRwkvState(f,o,c,u);this.rwkvVFirst||(this.rwkvVFirst=this.storage(o*4));let l=null;for(let f=0;f<n;f++){let g=this.storage(o*4);this.device.queue.writeBuffer(g,0,t.subarray(f*o,(f+1)*o)),r.push(g);let p=this.recLayernorm(e,r,g,i.tokW,i.tokB,1,o,1e-5),m=this.recRwkvToken(e,r,p,a,s,this.rwkvVFirst);f===n-1&&(l=this.recLayernorm(e,r,m,i.outW,i.outB,1,o,1e-5))}return l}async rwkvPrefillGpu(e,r,t,n,a,s,i){this.rwkvSessionReset(i,s);let o=[],u=this.device.createCommandEncoder();this.recordRwkv(u,o,e,r,t,n,a),this.device.queue.submit([u.finish()]),await this.device.queue.onSubmittedWorkDone(),this.release(o)}async rwkvLogitsGpu(e,r,t,n,a,s,i,o){let u=globalThis;this.rwkvSessionReset(o,i);let c=[],l=this.device.createCommandEncoder(),f=this.recordRwkv(l,c,e,r,t,n,s),g=this.recMM(l,c,f,a,1,t.D,t.vocab,!1),p=this.device.createBuffer({size:t.vocab*4,usage:u.GPUBufferUsage.COPY_DST|u.GPUBufferUsage.MAP_READ});l.copyBufferToBuffer(g,0,p,0,t.vocab*4),this.device.queue.submit([l.finish()]),await p.mapAsync(u.GPUMapMode.READ);let m=new Float32Array(p.getMappedRange().slice(0));return p.unmap(),p.destroy(),this.release(c),m}async rwkvTopKGpu(e,r,t,n,a,s,i,o,u,c,l=64){let f=globalThis;this.rwkvSessionReset(o,i);let g=[],p=this.device.createCommandEncoder(),m=this.recordRwkv(p,g,e,r,t,n,s),b=this.recMM(p,g,m,a,1,t.D,t.vocab,!1);if(c&&c!==1&&u.length){let q=Uint32Array.from(u),C=this.bufU32(q,f.GPUBufferUsage.STORAGE|f.GPUBufferUsage.COPY_DST),j=this.uniform([q.length],{offset:4,value:c});this.recordPass(p,"penalize_logits",[j,C,b],this.grid1D(q.length)),g.push(j,C)}let k=this.storage(l*2*4);g.push(k);{let q=this.uniform([t.vocab,l]);this.recordPass(p,this.topKParOk?"top_k_par":"top_k",[q,b,k],[1,1,1]),g.push(q)}let B=this.device.createBuffer({size:l*2*4,usage:f.GPUBufferUsage.COPY_DST|f.GPUBufferUsage.MAP_READ});p.copyBufferToBuffer(k,0,B,0,l*2*4),this.device.queue.submit([p.finish()]),await B.mapAsync(f.GPUMapMode.READ);let O=new Uint32Array(B.getMappedRange().slice(0));return B.unmap(),B.destroy(),this.release(g),{ids:O.slice(0,l),vals:new Float32Array(O.buffer,l*4,l)}}async argmaxProjection(e,r,t,n,a=!1){let s=globalThis,i=[],o=this.device.createCommandEncoder(),u=this.storage(e.byteLength);this.device.queue.writeBuffer(u,0,e),i.push(u);let c=this.storage(n*4);i.push(c);for(let m of r){let b=this.recMatmulT(o,i,u,m.buf,1,t,m.rows,a);o.copyBufferToBuffer(b,0,c,m.r0*4,m.rows*4)}let l=this.storage(4),f=this.uniform([n]);i.push(l,f),this.recordPass(o,"argmax",[f,c,l],[1,1,1]);let g=this.device.createBuffer({size:4,usage:s.GPUBufferUsage.COPY_DST|s.GPUBufferUsage.MAP_READ});o.copyBufferToBuffer(l,0,g,0,4),this.device.queue.submit([o.finish()]),await g.mapAsync(s.GPUMapMode.READ);let p=new Uint32Array(g.getMappedRange().slice(0))[0];return g.unmap(),g.destroy(),this.release(i),p}async projectLogits(e,r,t,n,a=!1){let s=globalThis,i=[],o=this.device.createCommandEncoder(),u=this.storage(e.byteLength);this.device.queue.writeBuffer(u,0,e),i.push(u);let c=this.storage(n*4);i.push(c);for(let g of r){let p=this.recMatmulT(o,i,u,g.buf,1,t,g.rows,a);o.copyBufferToBuffer(p,0,c,g.r0*4,g.rows*4)}let l=this.device.createBuffer({size:n*4,usage:s.GPUBufferUsage.COPY_DST|s.GPUBufferUsage.MAP_READ});o.copyBufferToBuffer(c,0,l,0,n*4),this.device.queue.submit([o.finish()]),await l.mapAsync(s.GPUMapMode.READ);let f=new Float32Array(l.getMappedRange().slice(0));return l.unmap(),l.destroy(),this.release(i),f}async selfValidate(){this.validationFailure=null;let e=A=>(this.validationFailure=A,console.error("[selfValidate] FAILED at:",A,"(hasF16="+this.hasF16+")"),!1),r=(A,w)=>A.length===w.length&&A.every((v,h)=>Math.abs(v-w[h])<.001),t=A=>Float32Array.from({length:A},()=>Math.random()*2-1),n=3,a=4,s=5,i=t(n*a),o=t(a*s),u=new Float32Array(n*s);for(let A=0;A<n;A++)for(let w=0;w<s;w++){let v=0;for(let h=0;h<a;h++)v+=i[A*a+h]*o[h*s+w];u[A*s+w]=v}if(!r(await this.matmul(i,o,n,a,s),u))return e("matmul");{let A=(v,h,x,y,P)=>{let U=new Float32Array(x*P);for(let _=0;_<x;_++)for(let G=0;G<P;G++){let F=0;for(let M=0;M<y;M++)F+=v[_*y+M]*h[G*y+M];U[_*P+G]=F}return U},w=async(v,h,x)=>{let y=t(v*h),P=t(x*h);return r(await this.matmulT(y,P,v,h,x),A(y,P,v,h,x))};if(!await w(3,8,5))return e("matmulT.vec4(3,8,5)");if(!await w(1,16,7))return e("matmulT.vec4(1,16,7)");if(!await w(2,6,4))return e("matmulT.scalar(2,6,4)");if(this.hasF16){let y=t(16),P=t(112),U=this.uploadGpuF16(P),_=await this.matmulT(y,U,1,16,7,!0),G=new Float32Array(7);for(let D=0;D<7;D++){let E=0;for(let Q=0;Q<16;Q++)E+=y[Q]*P[D*16+Q];G[D]=E}U.destroy?.();let F=D=>D.length===G.length&&D.every((E,Q)=>Math.abs(E-G[Q])<=.03*(1+Math.abs(G[Q])));if(!F(_))return e("matmulT.f16");let M=this.uploadGpu(P),R=this.f32ToF16Gpu(M,112),T=await this.matmulT(y,R,1,16,7,!0);if(M.destroy?.(),R.destroy?.(),!F(T))return e("packf16")}if(this.hasF16&&this.f16SharedOk){let v=[{m:20,k:128,n:18},{m:32,k:64,n:64},{m:70,k:40,n:130},{m:33,k:48,n:7}];for(let h of v){let x=t(h.m*h.k),y=t(h.n*h.k),P=this.uploadGpuF16(y),U=await this.matmulT(x,P,h.m,h.k,h.n,!0);this.f16SharedOk=!1;let _=await this.matmulT(x,P,h.m,h.k,h.n,!0);if(this.f16SharedOk=!0,P.destroy?.(),!(U.length===_.length&&U.every((F,M)=>Math.abs(F-_[M])<=.001*(1+Math.abs(_[M]))))){this.f16SharedOk=!1,console.warn(`[selfValidate] matmul_t_f16w_shared KO sur ce GPU (m=${h.m}, k=${h.k}, n=${h.n}) : repli sur matmul_t_f16w (plus lent, m\xEAme r\xE9sultat).`);break}}}}{let h=t(128),x=t(768),y=Ge(x),P=this.uploadGpuRaw(y.nibbles),U=this.uploadGpuRaw(new Uint8Array(y.scales.buffer,y.scales.byteOffset,y.scales.byteLength)),_=this.uploadGpuRaw(new Uint8Array(y.mins.buffer,y.mins.byteOffset,y.mins.byteLength)),G=await this.matmulQ4(h,P,U,_,1,128,6),F=pe(y),M=new Float32Array(6);for(let Q=0;Q<6;Q++){let $=0;for(let V=0;V<128;V++)$+=h[V]*F[Q*128+V];M[Q]=$}if(P.destroy?.(),U.destroy?.(),_.destroy?.(),!r(G,M))return e("matmulQ4");let R=this.uploadGpu(x),T=this.f32ToQ4Gpu(R,768),D=await this.matmulQ4(h,T.nib,T.sc,T.mn,1,128,6);if(R.destroy?.(),T.nib.destroy?.(),T.sc.destroy?.(),T.mn.destroy?.(),!(D.length===M.length&&D.every((Q,$)=>Math.abs(Q-M[$])<=.06*(1+Math.abs(M[$]))+.02)))return e("quantize_q4")}{let h=t(640),x=t(768),y=Xt(x),P=this.uploadGpuRaw(new Uint8Array(y.lo.buffer,y.lo.byteOffset,y.lo.byteLength)),U=this.uploadGpuRaw(new Uint8Array(y.hi.buffer,y.hi.byteOffset,y.hi.byteLength)),_=this.uploadGpuRaw(new Uint8Array(y.scales.buffer,y.scales.byteOffset,y.scales.byteLength)),G=this.uploadGpuRaw(new Uint8Array(y.mins.buffer,y.mins.byteOffset,y.mins.byteLength)),F=await this.matmulQ3(h,P,U,_,G,5,128,6),M=We(y),R=new Float32Array(30);for(let T=0;T<5;T++)for(let D=0;D<6;D++){let E=0;for(let Q=0;Q<128;Q++)E+=h[T*128+Q]*M[D*128+Q];R[T*6+D]=E}if(P.destroy?.(),U.destroy?.(),_.destroy?.(),G.destroy?.(),!r(F,R))return e("matmulQ3")}{let h=t(640),x=t(768),y=Ge(x),P=this.uploadGpuRaw(y.nibbles),U=this.uploadGpuRaw(new Uint8Array(y.scales.buffer,y.scales.byteOffset,y.scales.byteLength)),_=this.uploadGpuRaw(new Uint8Array(y.mins.buffer,y.mins.byteOffset,y.mins.byteLength)),G=await this.matmulQ4Tiled(h,P,U,_,5,128,6),F=pe(y),M=new Float32Array(30);for(let R=0;R<5;R++)for(let T=0;T<6;T++){let D=0;for(let E=0;E<128;E++)D+=h[R*128+E]*F[T*128+E];M[R*6+T]=D}if(P.destroy?.(),U.destroy?.(),_.destroy?.(),!r(G,M))return e("matmul_q4_tiled")}for(let A of[{m:20,n:18},{m:32,n:64},{m:70,n:130}]){let w=A.m,v=128,h=A.n,x=t(w*v),y=t(h*v),P=Ge(y),U=this.uploadGpuRaw(P.nibbles),_=this.uploadGpuRaw(new Uint8Array(P.scales.buffer,P.scales.byteOffset,P.scales.byteLength)),G=this.uploadGpuRaw(new Uint8Array(P.mins.buffer,P.mins.byteOffset,P.mins.byteLength)),F=await this.matmulQ4Shared(x,U,_,G,w,v,h),M=pe(P),R=new Float32Array(w*h);for(let T=0;T<w;T++)for(let D=0;D<h;D++){let E=0;for(let Q=0;Q<v;Q++)E+=x[T*v+Q]*M[D*v+Q];R[T*h+D]=E}if(U.destroy?.(),_.destroy?.(),G.destroy?.(),!r(F,R))return e(`matmul_q4_shared(${w},${h})`)}{let h=t(128),x=t(768),y=Be(x),P=this.uploadGpuRaw(new Uint8Array(y.codes.buffer,y.codes.byteOffset,y.codes.byteLength)),U=this.uploadGpuRaw(new Uint8Array(y.scales.buffer,y.scales.byteOffset,y.scales.byteLength)),_=await this.matmulQ8(h,P,U,1,128,6),G=me(y),F=new Float32Array(6);for(let D=0;D<6;D++){let E=0;for(let Q=0;Q<128;Q++)E+=h[Q]*G[D*128+Q];F[D]=E}if(P.destroy?.(),U.destroy?.(),!r(_,F))return e("matmulQ8");let M=this.uploadGpu(x),R=this.f32ToQ8Gpu(M,768),T=await this.matmulQ8(h,R.codes,R.sc,1,128,6);if(M.destroy?.(),R.codes.destroy?.(),R.sc.destroy?.(),!r(T,F))return e("quantize_q8")}{let h=t(640),x=t(768),y=Be(x),P=this.uploadGpuRaw(new Uint8Array(y.codes.buffer,y.codes.byteOffset,y.codes.byteLength)),U=this.uploadGpuRaw(new Uint8Array(y.scales.buffer,y.scales.byteOffset,y.scales.byteLength)),_=await this.matmulQ8Tiled(h,P,U,5,128,6),G=me(y),F=new Float32Array(30);for(let M=0;M<5;M++)for(let R=0;R<6;R++){let T=0;for(let D=0;D<128;D++)T+=h[M*128+D]*G[R*128+D];F[M*6+R]=T}if(P.destroy?.(),U.destroy?.(),!r(_,F))return e("matmul_q8_tiled")}for(let A of[{k:128,n:6},{k:128,n:130},{k:4096,n:17}]){let w=A.k,v=A.n,h=t(w),x=t(v*w),y=Ge(x),P=this.uploadGpuRaw(y.nibbles),U=this.uploadGpuRaw(new Uint8Array(y.scales.buffer,y.scales.byteOffset,y.scales.byteLength)),_=this.uploadGpuRaw(new Uint8Array(y.mins.buffer,y.mins.byteOffset,y.mins.byteLength)),G=await this.matmulQ4Vec(h,P,U,_,w,v),F=pe(y),M=new Float32Array(v);for(let V=0;V<v;V++){let Y=0;for(let N=0;N<w;N++)Y+=h[N]*F[V*w+N];M[V]=Y}if(P.destroy?.(),U.destroy?.(),_.destroy?.(),!r(G,M))return e(`matmul_q4_vec(${w},${v})`);let R=Be(x),T=this.uploadGpuRaw(new Uint8Array(R.codes.buffer,R.codes.byteOffset,R.codes.byteLength)),D=this.uploadGpuRaw(new Uint8Array(R.scales.buffer,R.scales.byteOffset,R.scales.byteLength)),E=await this.matmulQ8Vec(h,T,D,w,v),Q=me(R),$=new Float32Array(v);for(let V=0;V<v;V++){let Y=0;for(let N=0;N<w;N++)Y+=h[N]*Q[V*w+N];$[V]=Y}if(T.destroy?.(),D.destroy?.(),!r(E,$))return e(`matmul_q8_vec(${w},${v})`)}for(let A of[{m:20,n:18},{m:32,n:64},{m:70,n:130}]){let w=A.m,v=128,h=A.n,x=t(w*v),y=t(h*v),P=Be(y),U=this.uploadGpuRaw(new Uint8Array(P.codes.buffer,P.codes.byteOffset,P.codes.byteLength)),_=this.uploadGpuRaw(new Uint8Array(P.scales.buffer,P.scales.byteOffset,P.scales.byteLength)),G=await this.matmulQ8Shared(x,U,_,w,v,h),F=me(P),M=new Float32Array(w*h);for(let R=0;R<w;R++)for(let T=0;T<h;T++){let D=0;for(let E=0;E<v;E++)D+=x[R*v+E]*F[T*v+E];M[R*h+T]=D}if(U.destroy?.(),_.destroy?.(),!r(G,M))return e(`matmul_q8_shared(${w},${h})`)}if(this.qShared2Ok){let A=[{m:64,k:128,n:128},{m:65,k:128,n:130},{m:100,k:160,n:18},{m:70,k:96,n:200}];for(let w of A){let v=w.m,h=w.k,x=w.n,y=t(v*h),P=t(x*h),U=new Float32Array(v*x),_=Be(P),G=me(_);for(let N=0;N<v;N++)for(let S=0;S<x;S++){let L=0;for(let K=0;K<h;K++)L+=y[N*h+K]*G[S*h+K];U[N*x+S]=L}let F=this.uploadGpuRaw(new Uint8Array(_.codes.buffer,_.codes.byteOffset,_.codes.byteLength)),M=this.uploadGpuRaw(new Uint8Array(_.scales.buffer,_.scales.byteOffset,_.scales.byteLength)),R=await this.matmulQ8Shared2(y,F,M,v,h,x);F.destroy?.(),M.destroy?.();let T=Ge(P),D=pe(T),E=new Float32Array(v*x);for(let N=0;N<v;N++)for(let S=0;S<x;S++){let L=0;for(let K=0;K<h;K++)L+=y[N*h+K]*D[S*h+K];E[N*x+S]=L}let Q=this.uploadGpuRaw(T.nibbles),$=this.uploadGpuRaw(new Uint8Array(T.scales.buffer,T.scales.byteOffset,T.scales.byteLength)),V=this.uploadGpuRaw(new Uint8Array(T.mins.buffer,T.mins.byteOffset,T.mins.byteLength)),Y=await this.matmulQ4Shared2(y,Q,$,V,v,h,x);if(Q.destroy?.(),$.destroy?.(),V.destroy?.(),!r(R,U)||!r(Y,E)){this.qShared2Ok=!1,console.warn(`[selfValidate] matmul_t_q8/q4_shared2 KO sur ce GPU (m=${v}, k=${h}, n=${x}) : repli sur les tuiles 32\xD764 v1 (plus lentes, m\xEAme r\xE9sultat).`);break}}}{let w=t(1632),v=new Uint8Array(w.buffer,w.byteOffset,w.byteLength),h=(x,y)=>x.length===y.length&&x.every((P,U)=>P===y[U]);if(!h(await this.quantizeToBytes("F32",v,1632,"q8"),await this.quantizeToBytes("F32",v,1632,"q8",256)))return e("quantize_chunk_q8");if(!h(await this.quantizeToBytes("F32",v,1632,"q4"),await this.quantizeToBytes("F32",v,1632,"q4",256)))return e("quantize_chunk_q4")}let c=2,l=8,f=t(c*l),g=t(l),p=new Float32Array(c*l);for(let A=0;A<c;A++){let w=0;for(let h=0;h<l;h++)w+=f[A*l+h]**2;let v=1/Math.sqrt(w/l+1e-5);for(let h=0;h<l;h++)p[A*l+h]=f[A*l+h]*v*g[h]}if(!r(await this.rmsnorm(f,g,c,l),p))return e("rmsnorm");if(!r(await this.rmsnorm(f,g,c,l,1e-5,!0),qe(f,g,c,l,1e-5,!0)))return e("rmsnorm.onePlus");let m=t(16),b=t(16),k=m.map((A,w)=>A/(1+Math.exp(-A))*b[w]);if(!r(await this.swiglu(m,b),k))return e("swiglu");let B=m.map((A,w)=>sr(A)*b[w]);if(!r(await this.geglu(m,b),B))return e("geglu");let O=m.map((A,w)=>A+b[w]);if(!r(await this.add(m,b),O))return e("add");{let A=X.MAX_WG_DIM*te+257,w=new Float32Array(A),v=new Float32Array(A),h=[0,1,te-1,te,X.MAX_WG_DIM*te-1,X.MAX_WG_DIM*te,A-1];for(let P of h)w[P]=P%7-3,v[P]=P%5-2;let x=await this.add(w,v),y=x.length===A;for(let P of h)Math.abs(x[P]-(w[P]+v[P]))>1e-5&&(y=!1);if(!y)return e("grid1D.add(2D)")}let q=(A,w,v=.003)=>A.length===w.length&&A.every((h,x)=>Math.abs(h-w[x])<=v*(1+Math.abs(w[x])));{let y=t(8);if(!q(await this.rope(y,2,4,2,1,1e4),Le(y,2,4,2,1,1e4)))return e("rope")}{let y=t(384),P=new Float32Array(64/2).fill(1);if(!q(await this.ropeFactors(y,P,6,64,2,7,5e5),Le(y,6,64,2,7,5e5)))return e("rope_factors.ones");let U=Float32Array.from({length:64/2},(_,G)=>1+G%5*.7);if(!q(await this.ropeFactors(y,U,6,64,2,7,5e5),cn(y,U,6,64,2,7,5e5)))return e("rope_factors")}{let y=t(384);if(!q(await this.rope(y,6,64,2,7,5e5,!0),Ve(y,6,64,2,7,5e5)))return e("rope.interleaved");let P=t(8);if(!q(await this.rope(P,2,4,2,3,1e4,!0),Ve(P,2,4,2,3,1e4)))return e("rope.interleaved.hd4");let U=t(384);if(!q(await this.rope(U,6,64,2,0,5e5,!0),Ve(U,6,64,2,0,5e5)))return e("rope.interleaved.pos0");let _=64/2,G=new Float32Array(384);for(let D=0;D<6;D++)for(let E=0;E<_;E++)G[D*64+2*E]=y[D*64+E],G[D*64+2*E+1]=y[D*64+E+_];let F=await this.rope(G,6,64,2,7,5e5,!0),M=await this.rope(y,6,64,2,7,5e5,!1),R=new Float32Array(384);for(let D=0;D<6;D++)for(let E=0;E<_;E++)R[D*64+2*E]=M[D*64+E],R[D*64+2*E+1]=M[D*64+E+_];if(!q(F,R))return e("rope.interleaved.equivalence");let T=Float32Array.from({length:_},(D,E)=>1+E%5*.7);if(!q(await this.ropeFactors(y,T,6,64,2,7,5e5,!0),Ve(y,6,64,2,7,5e5,T)))return e("rope_factors.interleaved")}{let v=[16,24,24],h=1e6,x=3,y=x*2,P=5,U=t(y*128),_=new Uint32Array(x*3);for(let R=0;R<x;R++){let T=P+R;_.set([T,T,T],R*3)}let G=new Uint32Array([5,5,5,5,6,9,5,7,5]),F=q(await this.ropeMrope(U,_,y,128,2,v,h),Le(U,y,128,2,P,h)),M=q(await this.ropeMrope(U,G,y,128,2,v,h),un(U,G,y,128,2,v,h));(!F||!M)&&(this.mropeOk=!1,console.error(`[selfValidate] rope_mrope KO sur ce GPU (${F?"positions 3D":"d\xE9g\xE9n\xE9r\xE9\u2260rope"}). Vision d\xE9sactiv\xE9e, chat texte intact.`))}{let P=t(32),U=t(32),_=t(32);if(!q(await this.attention(P,U,_,2,4,2,4,2),ve(P,U,_,2,4,2,4,2)))return e("attention");let G=.3,F=5;if(!q(await this.attention(P,U,_,2,4,2,4,2,G,F),ve(P,U,_,2,4,2,4,2,G,F)))return e("attention.softcap");{let $=t(24),V=t(48),Y=t(48);for(let N of[1,4,8,64]){if(!q(await this.attention($,V,Y,3,2,1,4,9,void 0,0,N),ve($,V,Y,3,2,1,4,9,void 0,0,N)))return e(`attention.window(${N})`);if(!q(await this.attentionDecode($,V,Y,3,2,1,4,9,void 0,0,N),ve($,V,Y,3,2,1,4,9,void 0,0,N)))return e(`attention_decode.window(${N})`)}}{let M=await this.quantizeKvReadback(U,4,2,4),R=await this.quantizeKvReadback(_,4,2,4),T=await this.attentionQ8Kv(P,M.codes,M.scales,R.codes,R.scales,2,4,2,4,2),D=(Y,N)=>{let S=new Float32Array(32);for(let L=0;L<4;L++)for(let K=0;K<2;K++){let z=N[L*2+K];for(let I=0;I<4;I++){let W=L*2*4+K*4+I,H=Y[W>>2]>>(W&3)*8&255;S[W]=(H<128?H:H-256)*z}}return S},E=D(M.codes,M.scales),Q=D(R.codes,R.scales),$=ve(P,E,Q,2,4,2,4,2);if(!q(T,$,.005))return e("attention.q8kv");let V=0;for(let Y=0;Y<U.length;Y++)V=Math.max(V,Math.abs(E[Y]-U[Y]));if(V>.05)return e("quantize_kv.error")}}{let A=v=>{this.attnDecodeOk=!1,console.error("[selfValidate] attention d\xE9codage HS sur ce GPU (\xE9tape :",v,") \u2192 repli kernels classiques (plus lents \xE0 contexte long, corrects)")},w=[{nT:1,nH:14,nKv:2,hd:64,past:300},{nT:10,nH:14,nKv:2,hd:64,past:173}];for(let v of w){if(!this.attnDecodeOk)break;let h=v.past+v.nT,x=t(v.nT*v.nH*v.hd),y=t(h*v.nKv*v.hd),P=t(h*v.nKv*v.hd);if(!q(await this.attentionDecode(x,y,P,v.nT,v.nH,v.nKv,v.hd,v.past),ve(x,y,P,v.nT,v.nH,v.nKv,v.hd,v.past))){A(`decode(nT=${v.nT})`);break}let U=await this.quantizeKvReadback(y,h,v.nKv,v.hd),_=await this.quantizeKvReadback(P,h,v.nKv,v.hd),G=await this.attentionQ8KvDecode(x,U.codes,U.scales,_.codes,_.scales,v.nT,v.nH,v.nKv,v.hd,v.past),F=await this.attentionQ8Kv(x,U.codes,U.scales,_.codes,_.scales,v.nT,v.nH,v.nKv,v.hd,v.past);if(!q(G,F,.005)){A(`decode.q8kv(nT=${v.nT})`);break}}if(this.attnDecodeOk){let U=t(64),_=t(350*8),G=t(350*8);q(await this.attentionDecode(U,_,G,2,4,2,8,173,.3,5),ve(U,_,G,2,4,2,8,173,.3,5))||A("decode.softcap")}if(this.attnDecodeOk){let U=t(256),_=t(9088),G=t(9088);q(await this.attentionDecode(U,_,G,1,2,1,128,70),ve(U,_,G,1,2,1,128,70))||A("decode.hd128")}}{let A=h=>{this.attnPrefillOk=!1,console.error("[selfValidate] attention prefill tuil\xE9e HS sur ce GPU (\xE9tape :",h,") \u2192 repli kernel classique (plus lent en prefill, correct)")},w=[{nT:37,nH:14,nKv:2,hd:64,past:0,sc:void 0,cap:0,win:0},{nT:13,nH:14,nKv:2,hd:64,past:173,sc:void 0,cap:0,win:0},{nT:1,nH:14,nKv:2,hd:64,past:300,sc:void 0,cap:0,win:0},{nT:4,nH:4,nKv:2,hd:32,past:7,sc:void 0,cap:0,win:0},{nT:5,nH:4,nKv:2,hd:32,past:0,sc:void 0,cap:0,win:0},{nT:9,nH:2,nKv:1,hd:128,past:70,sc:void 0,cap:0,win:0},{nT:6,nH:4,nKv:2,hd:8,past:17,sc:.3,cap:5,win:0}];for(let h of w){let x=h.past+h.nT,y=t(h.nT*h.nH*h.hd),P=t(x*h.nKv*h.hd),U=t(x*h.nKv*h.hd);if(!q(await this.attentionPrefill(y,P,U,h.nT,h.nH,h.nKv,h.hd,h.past,h.sc,h.cap,h.win),ve(y,P,U,h.nT,h.nH,h.nKv,h.hd,h.past,h.sc,h.cap,h.win))){A(`prefill(nT=${h.nT},hd=${h.hd},past=${h.past}${h.cap>0?",softcap":""})`);break}}if(this.attnPrefillOk){let G=t(80),F=t(76),M=t(76);for(let R of[1,4,8,64])if(!q(await this.attentionPrefill(G,F,M,10,2,1,4,9,void 0,0,R),ve(G,F,M,10,2,1,4,9,void 0,0,R))){A(`prefill.window(${R})`);break}}let v=[{nT:37,nH:14,nKv:2,hd:64,past:0,win:0},{nT:13,nH:14,nKv:2,hd:64,past:173,win:0},{nT:10,nH:2,nKv:1,hd:8,past:9,win:4}];for(let h of v){if(!this.attnPrefillOk)break;let x=h.past+h.nT,y=t(h.nT*h.nH*h.hd),P=t(x*h.nKv*h.hd),U=t(x*h.nKv*h.hd),_=await this.quantizeKvReadback(P,x,h.nKv,h.hd),G=await this.quantizeKvReadback(U,x,h.nKv,h.hd),F=await this.attentionQ8KvPrefill(y,_.codes,_.scales,G.codes,G.scales,h.nT,h.nH,h.nKv,h.hd,h.past,void 0,0,h.win),M=await this.attentionQ8Kv(y,_.codes,_.scales,G.codes,G.scales,h.nT,h.nH,h.nKv,h.hd,h.past,void 0,0,h.win);if(!q(F,M,.005)){A(`prefill.q8kv(nT=${h.nT},win=${h.win})`);break}}}{let A=v=>{this.rmsVecOk=!1,console.error("[selfValidate] RMSNorm parall\xE8le HS sur ce GPU (\xE9tape :",v,") \u2192 repli kernel une-ligne-par-thread (correct, plus lent en d\xE9codage)")},w=[{rows:1,dim:1024,onePlus:!1},{rows:1,dim:1536,onePlus:!1},{rows:1,dim:100,onePlus:!1},{rows:14,dim:64,onePlus:!1},{rows:37,dim:2048,onePlus:!1},{rows:3,dim:128,onePlus:!0}];for(let v of w){let h=t(v.rows*v.dim),x=t(v.dim),y=await this.rmsnormVec(h,x,v.rows,v.dim,1e-6,v.onePlus),P=await this.rmsnorm(h,x,v.rows,v.dim,1e-6,v.onePlus);if(!q(y,P,.005)){A(`rmsnorm_vec(${v.rows}\xD7${v.dim}${v.onePlus?",1+w":""})`);break}}}{let A=v=>{this.topKParOk=!1,console.error("[selfValidate] top-K parall\xE8le HS sur ce GPU (\xE9tape :",v,") \u2192 repli s\xE9lection sur un thread (correcte, plus lente)")},w=[{n:151936,k:64,ties:!1,label:"vocab Qwen (151936)"},{n:65536,k:64,ties:!1,label:"vocab World (65536)"},{n:1e3,k:64,ties:!1,label:"n non multiple de 128"},{n:300,k:64,ties:!1,label:"n < 1024 candidats"},{n:4096,k:8,ties:!1,label:"petit K"},{n:8192,k:64,ties:!0,label:"EX \xC6QUO (d\xE9partage)"}];for(let v of w){if(!this.topKParOk)break;let h=v.ties?Float32Array.from({length:v.n},(U,_)=>Math.round(Math.random()*6)+(_%7===0?3:0)):t(v.n),x=await this.topKReadback(h,v.k,"top_k"),y=await this.topKReadback(h,v.k,"top_k_par");if(!(x.length===y.length&&x.every((U,_)=>U===y[_]))){let U=x.findIndex((_,G)=>_!==y[G]);A(`top_k_par(${v.label}). Premier \xE9cart au rang ${U} : ${x[U]} vs ${y[U]}`);break}}}{let U={seq:3,d:16,nHeads:4,nKvHeads:2,headDim:4,ffn:16,ropeTheta:1e4,eps:1e-6},_={attnNorm:t(16),wq:t(256),wk:t(128),wv:t(128),wo:t(256),bq:t(16),bk:t(8),bv:t(8),ffnNorm:t(16),wgate:t(256),wup:t(256),wdown:t(256)},G=t(48);if(!q(await this.layerForward(G,U,_),dt(G,U,_),.005))return e("layerForward")}{let _={seq:3,d:12,nHeads:4,nKvHeads:2,headDim:4,ffn:16,ropeTheta:1e4,eps:1e-6,attnScale:1/Math.sqrt(4),attnLogitSoftcap:5,act:"gelu",rmsGainOnePlus:!0},G={attnNorm:t(12),wq:t(192),wk:t(96),wv:t(96),wo:t(192),ffnNorm:t(12),wgate:t(192),wup:t(192),wdown:t(192),postAttnNorm:t(12),postFfnNorm:t(12)},F=t(36);if(!q(await this.layerForward(F,_,G),dt(F,_,G),.005))return e("layerForward.gemma2")}{let _={seq:3,d:12,nHeads:4,nKvHeads:2,headDim:4,ffn:16,ropeTheta:1e6,eps:1e-6},G={attnNorm:t(12),wq:t(192),wk:t(96),wv:t(96),wo:t(192),ffnNorm:t(12),wgate:t(192),wup:t(192),wdown:t(192),qNorm:t(4),kNorm:t(4)},F=t(36);if(!q(await this.layerForward(F,_,G),dt(F,_,G),.005))return e("layerForward.qwen3")}{let w=new Uint8Array(720);for(let h=0;h<5;h++){let x=h*144,y=new DataView(w.buffer);y.setUint16(x,Se(.005+Math.random()*.05),!0),y.setUint16(x+2,Se(.001+Math.random()*.02),!0);for(let P=4;P<144;P++)w[x+P]=Math.random()*256|0}let v=await this.dequantizeQ4K(w,5*256);if(!q(v,tn(w,5),1e-4))return e("dequant.Q4_K")}{let A=G=>{let F=new Uint8Array(G);for(let M=0;M<G;M++)F[M]=Math.random()*256|0;return F},w=(G,F)=>{let M=new DataView(G.buffer),R=T=>F===210?T*210+208:T*F;for(let T=0;T*F<G.length;T++)M.setUint16(R(T),Se(.005+Math.random()*.05),!0);return G},h=w(A(136),34);if(!q(await this.dequantizeByType("Q8_0",h,128),rn(h,4),1e-4))return e("dequant.Q8_0");let x=w(A(88),22);if(!q(await this.dequantizeByType("Q5_0",x,128),nn(x,4),1e-4))return e("dequant.Q5_0");let y=w(A(840),210);if(!q(await this.dequantizeByType("Q6_K",y,4*256),on(y,4),1e-4))return e("dequant.Q6_K");let P=w(A(72),18);if(!q(await this.dequantizeByType("Q4_0",P,128),an(P,4),1e-4))return e("dequant.Q4_0");let U=A(704),_=new DataView(U.buffer);for(let G=0;G<4;G++)_.setUint16(G*176,Se(.005+Math.random()*.05),!0),_.setUint16(G*176+2,Se(.001+Math.random()*.02),!0);if(!q(await this.dequantizeByType("Q5_K",U,4*256),sn(U,4),1e-4))return e("dequant.Q5_K")}{let P={d:16,nHeads:4,nKvHeads:2,headDim:4,ffn:16,ropeTheta:1e4,eps:1e-6},U={attnNorm:t(16),wq:t(256),wk:t(128),wv:t(128),wo:t(256),bq:t(16),bk:t(8),bv:t(8),ffnNorm:t(16),wgate:t(256),wup:t(256),wdown:t(256)},_=t(48),F=(await this.layerForward(_,{...P,seq:3},U)).slice(32,48),M=new Float32Array(0),R=await this.layerForwardKV(_.slice(0,32),{...P,seq:2},U,0,M,M),T=await this.layerForwardKV(_.slice(32,48),{...P,seq:1},U,2,R.k,R.v);if(!q(T.out,F,.005))return e("layerForwardKV")}{let v=t(4),h=t(40),x=new Float32Array(10);for(let _=0;_<10;_++){let G=0;for(let F=0;F<4;F++)G+=v[F]*h[_*4+F];x[_]=G}let y=0;for(let _=1;_<10;_++)x[_]>x[y]&&(y=_);let P=this.uploadGpu(h),U=await this.argmaxProjection(v,[{buf:P,rows:10,r0:0}],4,10,!1);if(P.destroy?.(),U!==y)return e("argmaxProjection")}{let P={seq:4,d:16,nHeads:4,nKvHeads:2,headDim:4,ffn:16,ropeTheta:1e4,eps:1e-6},U={attnNorm:t(16),wq:t(256),wk:t(128),wv:t(128),wo:t(256),bq:t(16),bk:t(8),bv:t(8),ffnNorm:t(16),wgate:t(256),wup:t(256),wdown:t(256)},_=t(16),G=t(64),F=new Float32Array(0),M=await this.layerForwardKV(G,{...P,seq:4},U,0,F,F,!0),R=qe(M.out.slice(48,64),_,1,16,1e-6),T={attnNorm:this.uploadGpu(U.attnNorm),wq:this.uploadGpu(U.wq),wk:this.uploadGpu(U.wk),wv:this.uploadGpu(U.wv),wo:this.uploadGpu(U.wo),ffnNorm:this.uploadGpu(U.ffnNorm),wgate:this.uploadGpu(U.wgate),wup:this.uploadGpu(U.wup),wdown:this.uploadGpu(U.wdown),bq:this.uploadGpu(U.bq),bk:this.uploadGpu(U.bk),bv:this.uploadGpu(U.bv)},D=this.uploadGpu(_),E=this.kvQuant;this.kvQuant=!1,this.resetKvGpu();let Q=await this.runDecodeGpu(G,{...P,seq:4},[T],0,D,"selftest-A");if(!q(Q,R,.008))return this.resetKvGpu(),this.kvQuant=E,e("runDecodeGpu.prefill");await this.runDecodeGpu(G.slice(0,48),{...P,seq:3},[T],0,D,"selftest-B");let $=await this.runDecodeGpu(G.slice(48,64),{...P,seq:1},[T],3,D,"selftest-B");if(!q($,R,.008))return this.resetKvGpu(),this.kvQuant=E,e("runDecodeGpu.decode");this.kvQuant=E,this.resetKvGpu();for(let V of Object.values(T))V?.destroy?.();D.destroy?.()}{let x=Float32Array.from({length:152064},()=>(Math.random()*2-1)*8),y=[...new Set(Array.from({length:40},()=>Math.floor(Math.random()*152064)))],P=x.slice();for(let S=0;S<152064;S++)P[S]=30*Math.tanh(P[S]/30);for(let S of y)P[S]=P[S]>0?P[S]/1.15:P[S]*1.15;let U=Array.from(P.keys()).sort((S,L)=>P[L]-P[S]).slice(0,64),_=globalThis,G=[],F=this.storage(152064*4);this.device.queue.writeBuffer(F,0,x),G.push(F);let M=this.device.createCommandEncoder(),R=this.uniform([152064],{offset:4,value:30});this.recordPass(M,"softcap_logits",[R,F],this.grid1D(152064));let T=this.bufU32(Uint32Array.from(y),_.GPUBufferUsage.STORAGE|_.GPUBufferUsage.COPY_DST),D=this.uniform([y.length],{offset:4,value:1.15});this.recordPass(M,"penalize_logits",[D,T,F],this.grid1D(y.length));let E=this.storage(512),Q=this.uniform([152064,64]);this.recordPass(M,this.topKParOk?"top_k_par":"top_k",[Q,F,E],[1,1,1]),G.push(R,T,D,Q,E);let $=this.device.createBuffer({size:512,usage:_.GPUBufferUsage.COPY_DST|_.GPUBufferUsage.MAP_READ});M.copyBufferToBuffer(E,0,$,0,512),this.device.queue.submit([M.finish()]),await $.mapAsync(_.GPUMapMode.READ);let V=new Uint32Array($.getMappedRange().slice(0));$.unmap(),$.destroy(),this.release(G);let Y=V.slice(0,64),N=new Float32Array(V.buffer,256,64);this.topKOk=!0;for(let S=0;S<64;S++){let L=Math.abs(N[S]-P[U[S]])<=1e-4*(1+Math.abs(P[U[S]])),K=Math.abs(P[Y[S]]-N[S])<=1e-4*(1+Math.abs(N[S]));if(!L||!K){this.topKOk=!1,console.error(`[selfValidate] top_k KO sur ce GPU (rang ${S}) : repli sur le sampling CPU plein-vocab (plus lent, m\xEAme r\xE9sultat).`);break}}}if(this.rwkvWkv7Ok){let h=t(128),x=t(16),y=t(16),P=t(16),U=t(16),_=t(16),G=Float32Array.from({length:16},()=>Math.random()*.5+.5),F=h.slice(),M=new Float32Array(16);for(let N=0;N<2;N++){let S=N*8;for(let L=0;L<8;L++){let K=N*8*8+L*8,z=P[S+L],I=0;for(let H=0;H<8;H++)I+=_[S+H]*F[K+H];let W=0;for(let H=0;H<8;H++){let J=G[S+H]*F[K+H]+z*y[S+H]+U[S+H]*I;F[K+H]=J,W+=x[S+H]*J}M[S+L]=W}}let R=await this.rwkvWkv7(h.slice(),x,G,y,P,_,U,2,8),T=(N,S)=>N.length===S.length&&N.every((L,K)=>Math.abs(L-S[K])<=.001*(1+Math.abs(S[K])));!T(R.S,F)||!T(R.y,M)?(this.rwkvWkv7Ok=!1,console.error("[selfValidate] RWKV-7 WKV KO sur ce GPU : une archi RWKV (moteur v2) refuserait de charger (non bloquant pour le chat texte).")):console.log("[selfValidate] RWKV-7 WKV OK (r\xE9currence \xE0 \xE9tat fixe, moteur v2)");let D=16,E=t(D),Q=t(D),$=t(D*6),V=new Float32Array(D*6);for(let N=0;N<6;N++)for(let S=0;S<D;S++){let L=N*D+S;V[L]=E[S]+(Q[S]-E[S])*$[L]}let Y=await this.rwkvTokenShift(E,Q,$,D);if(T(Y,V)?console.log("[selfValidate] RWKV-7 token-shift OK"):(this.rwkvWkv7Ok=!1,console.error("[selfValidate] RWKV-7 token-shift KO sur ce GPU (non bloquant pour le chat texte).")),this.rwkvResidentOk){let N=globalThis,S=N.GPUBufferUsage.STORAGE|N.GPUBufferUsage.COPY_DST|N.GPUBufferUsage.COPY_SRC,L=2,K=8,z=L*K,I=(H,J)=>{let ae=Math.max(16,Math.ceil((H.length*4+(J?4:0))/16)*16),re=this.device.createBuffer({size:ae,usage:N.GPUBufferUsage.UNIFORM|N.GPUBufferUsage.COPY_DST});return this.device.queue.writeBuffer(re,0,new Uint32Array(H)),J&&this.device.queue.writeBuffer(re,J.off,new Float32Array([J.val])),re},W=H=>this.device.createBuffer({size:H*4,usage:S});try{let H=t(z),J=t(z),ae=t(z),re=Float32Array.from({length:z},()=>Math.random()),ue=new Float32Array(z),we=new Float32Array(z),he=new Float32Array(z);for(let ce=0;ce<L;ce++){let Z=0;for(let ge=0;ge<K;ge++){let le=H[ce*K+ge]*J[ce*K+ge];Z+=le*le}Z=Math.sqrt(Z)||1e-12;for(let ge=0;ge<K;ge++){let le=ce*K+ge,Ne=H[le]*J[le]/Z;we[le]=-Ne,he[le]=Ne*re[le],ue[le]=H[le]*(1+(re[le]-1)*ae[le])}}let ee=W(z),Ce=W(z),ie=W(z);this.dispatch("rwkv_kprep",[I([L,K]),this.buf(H,S),this.buf(re,S),this.buf(J,S),this.buf(ae,S),ee,Ce,ie],this.grid1D(L));let Ue=T(await this.readBack(ee,z*4),ue)&&T(await this.readBack(Ce,z*4),we)&&T(await this.readBack(ie,z*4),he);ee.destroy?.(),Ce.destroy?.(),ie.destroy?.();let fe=t(z),Pt=t(z),Ut=t(z),xt=t(z),Gt=t(z),_t=t(z),Bt=new Float32Array(z);for(let ce=0;ce<L;ce++){let Z=ce*K,ge=0;for(let se=0;se<K;se++)ge+=fe[Z+se];ge/=K;let le=0;for(let se=0;se<K;se++){let Wt=fe[Z+se]-ge;le+=Wt*Wt}le/=K;let Ne=1/Math.sqrt(le+64e-5),Nt=0;for(let se=0;se<K;se++)Nt+=Pt[Z+se]*ue[Z+se]*Ut[Z+se];for(let se=0;se<K;se++)Bt[Z+se]=(fe[Z+se]-ge)*Ne*Gt[Z+se]+_t[Z+se]+Nt*xt[Z+se]}let et=new Float32Array(2*z);et.set(Gt,0),et.set(_t,z);let tt=W(z);this.dispatch("rwkv_out_gn",[I([L,K],{off:8,val:64e-5}),this.buf(fe,S),this.buf(Pt,S),this.buf(ue,S),this.buf(Ut,S),this.buf(xt,S),this.buf(et,S),tt],this.grid1D(L));let qt=T(await this.readBack(tt,z*4),Bt);tt.destroy?.();let Ft=t(z),St=t(z),Qr=Float32Array.from(Ft,(ce,Z)=>Math.exp(-.606531/(1+Math.exp(-(ce+St[Z]))))),rt=W(z);this.dispatch("rwkv_decay",[this.buf(Ft,S),this.buf(St,S),rt],this.grid1D(z));let Ot=T(await this.readBack(rt,z*4),Qr);rt.destroy?.();let Tt=t(z),Mt=t(z),Ct=t(z),Rt=t(z),Vr=Float32Array.from(Tt,(ce,Z)=>ce+(Mt[Z]-ce)*(1/(1+Math.exp(-(Ct[Z]+Rt[Z]))))),nt=this.buf(Tt,S);this.dispatch("rwkv_vresid",[nt,this.buf(Mt,S),this.buf(Ct,S),this.buf(Rt,S)],this.grid1D(z));let Dt=T(await this.readBack(nt,z*4),Vr);nt.destroy?.();let Lt=t(z),Kt=t(z),jt=t(z),$r=Float32Array.from(Lt,(ce,Z)=>ce+(Kt[Z]-ce)*jt[Z]),at=W(z);this.dispatch("rwkv_lerp",[this.buf(Lt,S),this.buf(Kt,S),this.buf(jt,S),at],this.grid1D(z));let zt=T(await this.readBack(at,z*4),$r);at.destroy?.();let Ht=t(z),Yr=Float32Array.from(Ht,ce=>{let Z=Math.max(ce,0);return Z*Z}),it=W(z);this.dispatch("sqrelu",[this.buf(Ht,S),it],this.grid1D(z));let Et=T(await this.readBack(it,z*4),Yr);it.destroy?.(),!Ue||!qt||!Ot||!Dt||!zt||!Et?(this.rwkvResidentOk=!1,console.error(`[selfValidate] glu RWKV r\xE9sidente KO sur ce GPU (kprep:${Ue} gn:${qt} decay:${Ot} vresid:${Dt} lerp:${zt} sqrelu:${Et}). Repli forwardToken JS+readback (correct, lent).`)):console.log("[selfValidate] glu RWKV r\xE9sidente OK (kprep, out_gn, decay, vresid, lerp, sqrelu)")}catch(H){this.rwkvResidentOk=!1,console.error("[selfValidate] glu RWKV r\xE9sidente : erreur d\u2019ex\xE9cution. Repli forwardToken JS+readback.",H)}}}if(this.lfm2ShortConvOk){let A=F=>Float32Array.from({length:F},()=>Math.random()*2-1),w=(F,M)=>F.length===M.length&&F.every((R,T)=>Math.abs(R-M[T])<=.001*(1+Math.abs(M[T]))),x=A(96),y=A(64),P=A(96),U=new Float32Array(32),_=y.slice();for(let F=0;F<32;F++){let M=x[F]*x[64+F],R=P[F*3+2]*M;for(let T=0;T<2;T++)R+=P[F*3+T]*y[T*32+F];for(let T=0;T+2<3;T++)_[T*32+F]=y[(T+1)*32+F];_[32+F]=M,U[F]=R*x[32+F]}let G=await this.lfm2ShortConv(x,y.slice(),P,32,3);!w(G.out,U)||!w(G.state,_)?(this.lfm2ShortConvOk=!1,console.error("[selfValidate] LFM2 shortconv KO sur ce GPU : une archi lfm2 refuserait de charger (non bloquant pour le reste).")):console.log("[selfValidate] LFM2 shortconv OK (conv courte gat\xE9e, moteur v2)")}let C=await this.validateDiffusion();C?console.warn("[selfValidate] image-gen primitive KO:",C,"(non bloquant: chemin texte intact)"):console.log(`[selfValidate] image-gen primitives OK (silu, group_norm, conv2d, conv2d_direct, conv2d_direct_q8/q4, conv 3\xD73 tuil\xE9 q8/q4 ${this.convTiledQOk?"OK":"KO (repli direct)"}, relu, upsample_nearest, layernorm, quick_gelu, attention_full)`);let j=await this.validateVideoResident();return j?(this.videoResidentOk=!1,console.warn("[selfValidate] motion r\xE9sident KO:",j,", repli JS+readback (plus lent, m\xEAme r\xE9sultat).")):console.log("[selfValidate] motion r\xE9sident OK (video_motion_gather, video_motion_scatter, video_add_pe, attn_temporal)"),!0}async validateVideoResident(){let e=o=>Float32Array.from({length:o},()=>Math.random()*2-1),r=(o,u,c=.005)=>o.length===u.length&&o.every((l,f)=>Math.abs(l-u[f])<=c*(1+Math.abs(u[f])));{let o=e(120),u=new Float32Array(120);for(let f=0;f<5;f++)for(let g=0;g<3;g++)for(let p=0;p<8;p++)u[(f*3+g)*8+p]=o[(g*8+p)*5+f];let c=this.recordingSession(),l=await c.finish(c.videoGather(o,3,8,5),120);if(!r(l,u,1e-6))return"video_motion_gather"}{let o=e(120),u=e(120),c=new Float32Array(120);for(let g=0;g<3;g++)for(let p=0;p<8;p++)for(let m=0;m<5;m++)c[(g*8+p)*5+m]=o[(m*3+g)*8+p]+u[(g*8+p)*5+m];let l=this.recordingSession(),f=await l.finish(l.videoScatter(o,u,3,8,5),120);if(!r(f,c,1e-6))return"video_motion_scatter"}{let o=e(120),u=e(24),c=new Float32Array(120);for(let g=0;g<5;g++)for(let p=0;p<3;p++)for(let m=0;m<8;m++)c[(g*3+p)*8+m]=o[(g*3+p)*8+m]+u[p*8+m];let l=this.recordingSession(),f=await l.finish(l.videoAddPe(o,u,3,8,5),120);if(!r(f,c,1e-6))return"video_add_pe"}{let o=e(120),u=e(120),c=e(120),l=1/Math.sqrt(4),f=new Float32Array(120);for(let m=0;m<5;m++)for(let b=0;b<2;b++){let k=b*4,B=m*3;for(let O=0;O<3;O++){let q=(B+O)*8+k,C=new Float32Array(3),j=-1e30;for(let w=0;w<3;w++){let v=0,h=(B+w)*8+k;for(let x=0;x<4;x++)v+=o[q+x]*u[h+x];C[w]=v*l,C[w]>j&&(j=C[w])}let A=0;for(let w=0;w<3;w++)C[w]=Math.exp(C[w]-j),A+=C[w];for(let w=0;w<3;w++){let v=C[w]/A,h=(B+w)*8+k;for(let x=0;x<4;x++)f[q+x]+=v*c[h+x]}}}let g=this.recordingSession(),p=await g.finish(g.attnTemporal(o,u,c,5,3,2,4),120);if(!r(p,f))return"attn_temporal"}return null}async validateDiffusion(){let e=S=>Float32Array.from({length:S},()=>Math.random()*2-1),r=(S,L,K=.005)=>S.length===L.length&&S.every((z,I)=>Math.abs(z-L[I])<=K*(1+Math.abs(L[I]))),t=e(70),n=t.map(S=>S/(1+Math.exp(-S)));if(!r(await this.silu(t),n))return"silu";let a=4,s=5,i=2,o=1e-5,u=e(a*s),c=e(a),l=e(a),f=new Float32Array(a*s),g=a/i;for(let S=0;S<i;S++){let L=S*g*s,K=g*s,z=0;for(let H=0;H<K;H++)z+=u[L+H];z/=K;let I=0;for(let H=0;H<K;H++){let J=u[L+H]-z;I+=J*J}I/=K;let W=1/Math.sqrt(I+o);for(let H=0;H<K;H++){let J=S*g+Math.floor(H/s);f[L+H]=(u[L+H]-z)*W*c[J]+l[J]}}if(!r(await this.groupNorm(u,c,l,a,s,i,o),f))return"group_norm";let p=2,m=4,b=4,k=3,B=3,O=1,q=1,C=4,j=4,A=e(p*m*b),w=e(k*p*B*B),v=e(k),h=new Float32Array(k*C*j);for(let S=0;S<k;S++)for(let L=0;L<C;L++)for(let K=0;K<j;K++){let z=v[S];for(let I=0;I<p;I++)for(let W=0;W<B;W++)for(let H=0;H<B;H++){let J=L*O+W-q,ae=K*O+H-q;J>=0&&J<m&&ae>=0&&ae<b&&(z+=A[I*m*b+J*b+ae]*w[((S*p+I)*B+W)*B+H])}h[(S*C+L)*j+K]=z}if(!r(await this.conv2d(A,w,v,p,m,b,k,B,B,O,q),h))return"conv2d";if(!r(await this.conv2dDirect(A,w,v,p,m,b,k,B,B,O,q),h))return"conv2d_direct";{let I=e(1200),W=e(108),H=e(4),J=await this.conv2dDirect(I,W,H,3,20,20,4,3,3,1,1),ae=this.convTiledOk;this.convTiledOk=!0;let re=this.recordingSession(),ue=await re.finish(re.conv2d(I,W,H,3,20,20,4,3,3,1,1),1600);this.convTiledOk=ae,r(ue,J)||(this.convTiledOk=!1,console.warn("[selfValidate] conv2d_3x3_tiled KO sur ce GPU : repli sur conv2d_direct (plus lent, m\xEAme r\xE9sultat)."))}{let K=e(8*m*b),z=e(32*B*B),I=e(4),W=Be(z),H=await this.conv2dDirect(K,me(W),I,8,m,b,4,B,B,O,q),J={codes:this.uploadGpuRaw(new Uint8Array(W.codes.buffer,W.codes.byteOffset,W.codes.byteLength)),sc:this.uploadGpuRaw(new Uint8Array(W.scales.buffer,W.scales.byteOffset,W.scales.byteLength))},ae=this.convTiledQOk;this.convTiledQOk=!1;let re=this.recordingSession(),ue=await re.finish(re.conv2d(K,J,I,8,m,b,4,B,B,O,q),4*m*b);if(this.convTiledQOk=ae,this.releaseGpu([J.codes,J.sc]),!r(ue,H))return"conv2d_direct_q8"}{let K=e(8*m*b),z=e(32*B*B),I=e(4),W=Ge(z),H=await this.conv2dDirect(K,pe(W),I,8,m,b,4,B,B,O,q),J={nib:this.uploadGpuRaw(W.nibbles),sc:this.uploadGpuRaw(new Uint8Array(W.scales.buffer,W.scales.byteOffset,W.scales.byteLength)),mn:this.uploadGpuRaw(new Uint8Array(W.mins.buffer,W.mins.byteOffset,W.mins.byteLength))},ae=this.convTiledQOk;this.convTiledQOk=!1;let re=this.recordingSession(),ue=await re.finish(re.conv2d(K,J,I,8,m,b,4,B,B,O,q),4*m*b);if(this.convTiledQOk=ae,this.releaseGpu([J.nib,J.sc,J.mn]),!r(ue,H))return"conv2d_direct_q4"}{let I=e(3200),W=e(288),H=e(4),J=this.convTiledQOk;for(let ae of["q8","q4"]){let re=ae==="q8"?(()=>{let ee=Be(W);return{deq:me(ee),gpu:{codes:this.uploadGpuRaw(new Uint8Array(ee.codes.buffer,ee.codes.byteOffset,ee.codes.byteLength)),sc:this.uploadGpuRaw(new Uint8Array(ee.scales.buffer,ee.scales.byteOffset,ee.scales.byteLength))}}})():(()=>{let ee=Ge(W);return{deq:pe(ee),gpu:{nib:this.uploadGpuRaw(ee.nibbles),sc:this.uploadGpuRaw(new Uint8Array(ee.scales.buffer,ee.scales.byteOffset,ee.scales.byteLength)),mn:this.uploadGpuRaw(new Uint8Array(ee.mins.buffer,ee.mins.byteOffset,ee.mins.byteLength))}}})(),ue=await this.conv2dDirect(I,re.deq,H,8,20,20,4,3,3,1,1);this.convTiledQOk=!0;let we=this.recordingSession(),he=await we.finish(we.conv2d(I,re.gpu,H,8,20,20,4,3,3,1,1),1600);if(this.releaseGpu(Object.values(re.gpu)),!r(he,ue)){J&&console.warn(`[selfValidate] conv2d_3x3_tiled_${ae} KO sur ce GPU : repli sur conv2d_direct_${ae} (plus lent, m\xEAme r\xE9sultat).`),this.convTiledQOk=!1;break}}this.convTiledQOk=this.convTiledQOk&&J}{let L=e(66),K=new Uint16Array(66);for(let H=0;H<66;H++)K[H]=Se(L[H]);let z=new Float32Array(66);for(let H=0;H<66;H++)z[H]=be(K[H]);let I=this.f16ToF32Gpu(new Uint8Array(K.buffer,K.byteOffset,K.byteLength),66),W=await this.readGpu(I,66);if(I.destroy?.(),!r(W,z,1e-6))return"f16_to_f32"}let x=e(70);if(!r(await this.relu(x),x.map(S=>Math.max(S,0))))return"relu";let y=2,P=2,U=2,_=2,G=P*_,F=U*_,M=e(y*P*U),R=new Float32Array(y*G*F);for(let S=0;S<y;S++)for(let L=0;L<G;L++)for(let K=0;K<F;K++)R[S*G*F+L*F+K]=M[S*P*U+Math.floor(L/_)*U+Math.floor(K/_)];if(!r(await this.upsampleNearest(M,y,P,U,_),R))return"upsample_nearest";let T=2,D=8,E=1e-5,Q=e(T*D),$=e(D),V=e(D),Y=new Float32Array(T*D);for(let S=0;S<T;S++){let L=S*D,K=0;for(let W=0;W<D;W++)K+=Q[L+W];K/=D;let z=0;for(let W=0;W<D;W++){let H=Q[L+W]-K;z+=H*H}z/=D;let I=1/Math.sqrt(z+E);for(let W=0;W<D;W++)Y[L+W]=(Q[L+W]-K)*I*$[W]+V[W]}if(!r(await this.layernorm(Q,$,V,T,D,E),Y))return"layernorm";let N=e(70);if(!r(await this.quickGelu(N),N.map(S=>S/(1+Math.exp(-1.702*S)))))return"quick_gelu";{let W=1/Math.sqrt(4),H=e(24),J=e(40),ae=e(40),re=new Float32Array(24);for(let ue=0;ue<2;ue++)for(let we=0;we<3;we++){let he=new Float32Array(5),ee=-1/0;for(let ie=0;ie<5;ie++){let Ue=0;for(let fe=0;fe<4;fe++)Ue+=H[we*8+ue*4+fe]*J[ie*8+ue*4+fe];he[ie]=Ue*W,he[ie]>ee&&(ee=he[ie])}let Ce=0;for(let ie=0;ie<5;ie++)he[ie]=Math.exp(he[ie]-ee),Ce+=he[ie];for(let ie=0;ie<4;ie++){let Ue=0;for(let fe=0;fe<5;fe++)Ue+=he[fe]/Ce*ae[fe*8+ue*4+ie];re[we*8+ue*4+ie]=Ue}}if(!r(await this.attentionFull(H,J,ae,3,2,2,4,5),re))return"attention_full"}if(this.attnFullWgOk){let S=[{nT:70,kvL:70,nH:5,hd:64},{nT:16,kvL:77,nH:5,hd:64},{nT:9,kvL:9,nH:8,hd:160}];for(let L of S){let K=L.nH*L.hd,z=e(L.nT*K),I=e(L.kvL*K),W=e(L.kvL*K),H=await this.attentionFull(z,I,W,L.nT,L.nH,L.nH,L.hd,L.kvL),J=await this.attentionFullWg(z,I,W,L.nT,L.nH,L.nH,L.hd,L.kvL);if(!r(J,H)){this.attnFullWgOk=!1,console.warn(`[selfValidate] attention_full_wg KO sur ce GPU (hd=${L.hd}, kv=${L.kvL}) : repli sur attention_full (plus lent, m\xEAme r\xE9sultat).`);break}}}return null}};X.timingOn=(()=>{try{return oe("timing")==="1"}catch{return!1}})(),X.profileOn=(()=>{try{return oe("gpuprofile")==="1"}catch{return!1}})(),X.MAX_WG_DIM=65535,X.BLOCK_ELEMS={Q4_K:256,Q5_K:256,Q6_K:256,Q8_0:32,Q5_0:32,Q4_0:32,F32:1,F16:1},X.DEQUANT_SHADER={Q4_K:"dequant_q4k",Q8_0:"dequant_q8_0",Q5_0:"dequant_q5_0",Q6_K:"dequant_q6k",Q4_0:"dequant_q4_0",Q5_K:"dequant_q5k"},X.STORAGE_USAGE=140;$e=X});function ur(d,e){let r=new DataView(d.buffer,d.byteOffset,d.byteLength),t=new Float32Array(e);for(let n=0;n<e;n++)t[n]=de(r.getUint16(n*2,!0));return t}function cr(d,e){let r=new DataView(d.buffer,d.byteOffset,d.byteLength),t=new Float32Array(e);for(let n=0;n<e;n++)t[n]=r.getFloat32(n*4,!0);return t}function Ke(d,e,r,t){let n=0;for(let i=0;i<r;i++)n+=d[i]*d[i];let a=1/Math.sqrt(n/r+t),s=new Float32Array(r);for(let i=0;i<r;i++)s[i]=d[i]*a*e[i];return s}var ln,Te,Ye,lr=ne(()=>{"use strict";st();ot();Re();ln=d=>d/(1+Math.exp(-d)),Te=class Te{constructor(e,r,t){this.engine=e;this.manifest=r;this.raw=t;this.w=new Map;this.g=new Map;this.pos=0;this.rLayers=[];this.tokNormGpu=null;this.normBufs=[];this.ffn=0}isBigProj(e){return/\.(shortconv\.(in_proj|out_proj)|attn_(q|k|v|output)|ffn_(gate|up|down))\.weight$/.test(e)}async load(e){if(!this.engine.lfm2ShortConvOk)throw new Error("kernel shortconv LFM2 invalid\xE9 sur ce GPU (selfValidate) : archi lfm2 refus\xE9e.");let r=this.manifest.arch;if(this.D=r.d,this.NH=r.nHeads,this.NKV=r.nKvHeads,this.HD=r.headDim,this.NL=r.blockCount,this.vocab=r.vocab,this.EPS=r.rmsEps,this.THETA=r.ropeTheta,!r.lfm2)throw new Error("manifest sans profil lfm2");this.LC=r.lfm2.lCache,this.convLayer=r.lfm2.kvHeadsPerLayer.map(t=>t===0),this.tok=e,this.stops=new Set(this.manifest.chat?.stopTokenIds?.length?this.manifest.chat.stopTokenIds:[7]);for(let[t,n]of Object.entries(this.manifest.tensors)){if(t==="token_embd.weight"){if(this.embedBytes=await this.raw(t),this.embedDtype=n.dtype,n.dtype==="q4"){let s=_e(this.embedBytes,n.nElems);this.g.set("head",{kind:"q4",nib:this.engine.uploadGpuRaw(s.nibbles),sc:this.up(s.scales),mn:this.up(s.mins),IN:this.D,OUT:this.vocab})}else if(n.dtype==="q8"){let s=Fe(this.embedBytes,n.nElems);this.g.set("head",{kind:"q8",codes:this.upI8(s.codes),sc:this.up(s.scales),IN:this.D,OUT:this.vocab})}continue}let a=await this.raw(t);if(this.isBigProj(t)&&(n.dtype==="q4"||n.dtype==="q8")){let s=n.shape[0],i=n.nElems/s;if(n.dtype==="q8"){let o=Fe(a,n.nElems);this.g.set(t,{kind:"q8",codes:this.upI8(o.codes),sc:this.up(o.scales),IN:s,OUT:i})}else{let o=_e(a,n.nElems);this.g.set(t,{kind:"q4",nib:this.engine.uploadGpuRaw(o.nibbles),sc:this.up(o.scales),mn:this.up(o.mins),IN:s,OUT:i})}}else this.w.set(t,n.dtype==="f32"?cr(a,n.nElems):n.dtype==="f16"?ur(a,n.nElems):n.dtype==="q8"?me(Fe(a,n.nElems)):pe(_e(a,n.nElems)))}this.buildResidentLayers(),this.reset()}buildResidentLayers(){let e=r=>{let t=this.engine.uploadGpu(this.w.get(r));return this.normBufs.push(t),t};this.tokNormGpu=e("token_embd_norm.weight"),this.ffn=this.g.get("blk.0.ffn_gate.weight")?.OUT??0,this.rLayers=[];for(let r=0;r<this.NL;r++){let t=`blk.${r}.`,n={attnNorm:e(t+"attn_norm.weight"),ffnNorm:e(t+"ffn_norm.weight"),wgate:this.g.get(t+"ffn_gate.weight"),wup:this.g.get(t+"ffn_up.weight"),wdown:this.g.get(t+"ffn_down.weight")};this.convLayer[r]?this.rLayers.push({conv:!0,...n,convW:e(t+"shortconv.conv.weight"),inProj:this.g.get(t+"shortconv.in_proj.weight"),outProj:this.g.get(t+"shortconv.out_proj.weight")}):this.rLayers.push({conv:!1,...n,qNorm:e(t+"attn_q_norm.weight"),kNorm:e(t+"attn_k_norm.weight"),wq:this.g.get(t+"attn_q.weight"),wk:this.g.get(t+"attn_k.weight"),wv:this.g.get(t+"attn_v.weight"),wo:this.g.get(t+"attn_output.weight")})}}residentAvailable(){return this.engine.lfm2ResidentOk!==!1&&!!this.g.get("head")&&this.rLayers.length===this.NL&&this.ffn>0}cfg(){return{D:this.D,nHeads:this.NH,nKvHeads:this.NKV,headDim:this.HD,ffn:this.ffn,eps:this.EPS,theta:this.THETA,lc:this.LC,vocab:this.vocab}}embedsFor(e){let r=this.D,t=new Float32Array(e.length*r);for(let n=0;n<e.length;n++)t.set(this.embedRow(e[n]),n*r);return t}async logitsGpu(e,r,t){return this.pos=r+e.length,this.engine.lfm2LogitsGpu(this.embedsFor(e),e.length,this.cfg(),this.rLayers,this.g.get("head"),this.tokNormGpu,r,t)}async topKGpu(e,r,t,n,a,s=40){return this.pos=r+e.length,this.engine.lfm2TopKGpu(this.embedsFor(e),e.length,this.cfg(),this.rLayers,this.g.get("head"),this.tokNormGpu,r,t,n,a,s)}async prefillGpu(e,r,t){this.pos=r+e.length,await this.engine.lfm2PrefillGpu(this.embedsFor(e),e.length,this.cfg(),this.rLayers,this.tokNormGpu,r,t)}up(e){return this.engine.uploadGpuRaw(new Uint8Array(e.buffer,e.byteOffset,e.byteLength))}upI8(e){return this.engine.uploadGpuRaw(new Uint8Array(e.buffer,e.byteOffset,e.byteLength))}unload(){for(let e of this.g.values())for(let r of["nib","sc","mn","codes"])e[r]?.destroy?.();for(let e of this.normBufs)e?.destroy?.();this.normBufs=[],this.rLayers=[],this.tokNormGpu=null,this.engine.clearLfm2State?.(),this.g.clear(),this.w.clear()}reset(){this.pos=0,this.state=Array.from({length:this.NL},(e,r)=>this.convLayer[r]?{conv:new Float32Array((this.LC-1)*this.D)}:{K:[],V:[]})}async gemm(e,r){let t=this.g.get(e);if(!t){let n=this.w.get(e==="head"?"token_embd.weight":e),a=n.length/r.length,s=new Float32Array(a);for(let i=0;i<a;i++){let o=0,u=i*r.length;for(let c=0;c<r.length;c++)o+=n[u+c]*r[c];s[i]=o}return s}return t.kind==="q8"?this.engine.matmulQ8(r,t.codes,t.sc,1,t.IN,t.OUT):this.engine.matmulQ4(r,t.nib,t.sc,t.mn,1,t.IN,t.OUT)}embedRow(e){let r=this.D;if(this.embedDtype==="f16")return ur(this.embedBytes.subarray(e*r*2,e*r*2+r*2),r);if(this.embedDtype==="f32")return cr(this.embedBytes.subarray(e*r*4,e*r*4+r*4),r);if(this.embedDtype==="q8"){let o=this.vocab*r,u=r/32,c=new Int8Array(this.embedBytes.buffer,this.embedBytes.byteOffset+e*r,r),l=this.embedBytes.subarray(o+e*u*2,o+e*u*2+u*2),f=new DataView(l.buffer,l.byteOffset,l.byteLength),g=new Float32Array(r);for(let p=0;p<u;p++){let m=de(f.getUint16(p*2,!0));for(let b=0;b<32;b++)g[p*32+b]=c[p*32+b]*m}return g}let t=this.vocab*r,n=r/32,a=t/2,s=t/2+t/32*2,i=new Uint8Array(r/2+n*2*2);return i.set(this.embedBytes.subarray(e*r/2,e*r/2+r/2),0),i.set(this.embedBytes.subarray(a+e*n*2,a+e*n*2+n*2),r/2),i.set(this.embedBytes.subarray(s+e*n*2,s+e*n*2+n*2),r/2+n*2),pe(_e(i,r))}rope(e,r,t){let n=this.HD,a=e.slice();for(let s=0;s<r;s++){let i=s*n;for(let o=0;o<n/2;o++){let u=Math.pow(this.THETA,-2*o/n),c=Math.cos(t*u),l=Math.sin(t*u),f=e[i+o],g=e[i+o+n/2];a[i+o]=f*c-g*l,a[i+o+n/2]=f*l+g*c}}return a}async forwardToken(e){let r=this.D,t=this.pos++,n=this.embedRow(e);for(let a=0;a<this.NL;a++){let s=`blk.${a}.`,i=this.state[a],o=Ke(n,this.w.get(s+"attn_norm.weight"),r,this.EPS),u;if(this.convLayer[a]){let p=await this.gemm(s+"shortconv.in_proj.weight",o),m=await this.engine.lfm2ShortConv(p,i.conv,this.w.get(s+"shortconv.conv.weight"),r,this.LC);i.conv=m.state,u=await this.gemm(s+"shortconv.out_proj.weight",m.out)}else{let p=await this.gemm(s+"attn_q.weight",o),m=await this.gemm(s+"attn_k.weight",o),b=await this.gemm(s+"attn_v.weight",o),k=this.w.get(s+"attn_q_norm.weight"),B=this.w.get(s+"attn_k_norm.weight");for(let A=0;A<this.NH;A++)p.set(Ke(p.slice(A*this.HD,(A+1)*this.HD),k,this.HD,this.EPS),A*this.HD);for(let A=0;A<this.NKV;A++)m.set(Ke(m.slice(A*this.HD,(A+1)*this.HD),B,this.HD,this.EPS),A*this.HD);p=this.rope(p,this.NH,t),m=this.rope(m,this.NKV,t),i.K.push(m),i.V.push(b);let O=new Float32Array(this.NH*this.HD),q=i.K.length,C=1/Math.sqrt(this.HD),j=this.NH/this.NKV;for(let A=0;A<this.NH;A++){let w=Math.floor(A/j),v=A*this.HD,h=w*this.HD,x=new Float32Array(q),y=-1e30;for(let U=0;U<q;U++){let _=0;for(let G=0;G<this.HD;G++)_+=p[v+G]*i.K[U][h+G];x[U]=_*C,x[U]>y&&(y=x[U])}let P=0;for(let U=0;U<q;U++)x[U]=Math.exp(x[U]-y),P+=x[U];for(let U=0;U<q;U++){let _=x[U]/P;for(let G=0;G<this.HD;G++)O[v+G]+=_*i.V[U][h+G]}}u=await this.gemm(s+"attn_output.weight",O)}for(let p=0;p<r;p++)n[p]+=u[p];let c=Ke(n,this.w.get(s+"ffn_norm.weight"),r,this.EPS),l=await this.gemm(s+"ffn_gate.weight",c),f=await this.gemm(s+"ffn_up.weight",c);for(let p=0;p<l.length;p++)l[p]=ln(l[p])*f[p];let g=await this.gemm(s+"ffn_down.weight",l);for(let p=0;p<r;p++)n[p]+=g[p]}return n=Ke(n,this.w.get("token_embd_norm.weight"),r,this.EPS),this.gemm("head",n)}async classify(e,r){this.reset();let t;for(let a of this.tok.encode(e))t=await this.forwardToken(a);let n=r.map(a=>{let s=this.tok.encode(a);return{label:a,logit:t[s[1]??s[0]]}}).sort((a,s)=>s.logit-a.logit);return{label:n[0].label,scores:n}}banTools(e){for(let r of Te.TOOL_BAN)r<e.length&&(e[r]=-1e30);return e}sampleTok(e,r,t){let{temperature:n=.8,topK:a=40,repeatPenalty:s=1.3}=t,i=new Set(r),o=[];for(let f=0;f<e.length;f++){let g=e[f];i.has(f)&&(g=g>0?g/s:g*s),o.push({i:f,v:g})}o.sort((f,g)=>g.v-f.v),o.length=a;let u=o[0].v,c=0;for(let f of o)f.p=Math.exp((f.v-u)/n),c+=f.p;let l=Math.random()*c;for(let f of o)if(l-=f.p,l<=0)return f.i;return o[0].i}async generate(e,r,t,n,a){this.reset();let s=this.tok.encode(e),i;for(let u of s)i=await this.forwardToken(u);let o=[];for(let u=0;u<r&&!n?.();u++){this.banTools(i);let c;if(a?.sample)c=this.sampleTok(i,o.slice(-64),a);else{c=0;for(let l=1;l<i.length;l++)i[l]>i[c]&&(c=l)}if(this.stops.has(c))break;o.push(c),t&&t(this.tok.decode(o)),i=await this.forwardToken(c)}return o.length?this.tok.decode(o):""}pickFromTopK(e,r){let t=[],n=[];for(let f=0;f<e.ids.length;f++)if(!Te.TOOL_BAN.includes(e.ids[f])){if(e.vals[f]===-1/0)break;t.push(e.ids[f]),n.push(e.vals[f])}if(!t.length)return e.ids[0];if(!r?.sample)return t[0];let{temperature:a=.8,topK:s=40}=r,i=Math.min(s,t.length),o=n[0],u=0,c=new Array(i);for(let f=0;f<i;f++)c[f]=Math.exp((n[f]-o)/a),u+=c[f];let l=Math.random()*u;for(let f=0;f<i;f++)if(l-=c[f],l<=0)return t[f];return t[0]}async generateResident(e,r,t,n,a){if(!this.residentAvailable())return this.generate(e,r,t,n,a);let s="gen",i=a?.repeatPenalty??(a?.sample?1.3:1),o=this.tok.encode(e),u,c=0;for(;c<o.length;){if(n?.())return"";let g=Math.min(c+Te.PREFILL_CHUNK,o.length),p=o.slice(c,g);g<o.length?await this.prefillGpu(p,c,s):u=await this.topKGpu(p,c,s,[],1,48),c=g}let l=o.length,f=[];for(let g=0;g<r&&!n?.();g++){let p=this.pickFromTopK(u,a);if(this.stops.has(p))break;f.push(p),t&&t(this.tok.decode(f)),u=await this.topKGpu([p],l,s,i!==1?[...new Set(f.slice(-64))]:[],i,48),l++}return f.length?this.tok.decode(f):""}};Te.TOOL_BAN=[8,10,12],Te.PREFILL_CHUNK=128;Ye=Te});function dr(d){if(!d.length)return null;let e=1/0,r=0,t=0;for(let n of d)e=Math.min(e,n.offset),r=Math.max(r,n.offset+n.bytes),t+=n.bytes;return r-e>64<<20||r-e>t*1.5?null:{start:e,end:r}}function fr(d,e){let r=new Map;for(let a of Object.keys(d)){let s=a.match(/^blk\.(\d+)\./);if(!s)continue;let i=r.get(s[1]);i||r.set(s[1],i=[]),i.push(a)}let t=new Map,n=new Map;return async a=>{let s=d[a];if(!s)throw new Error(`tenseur absent : ${a}`);let i=a.match(/^blk\.(\d+)\./),o=i?r.get(i[1]):void 0,u=o?dr(o.map(b=>d[b])):null;if(!i||!o||!u)return e.bytes(s.offset,s.bytes);let c=i[1],l=t.get(c);l||(l=e.bytes(u.start,u.end-u.start).then(b=>({start:u.start,bytes:b})),t.set(c,l),n.set(c,o.length));let{start:f,bytes:g}=await l,p=g.subarray(s.offset-f,s.offset-f+s.bytes),m=(n.get(c)??1)-1;return m<=0?(t.delete(c),n.delete(c),new Uint8Array(p)):(n.set(c,m),p)}}var ft=ne(()=>{"use strict"});var gr=ne(()=>{"use strict"});function pr(d,e=16){return Math.ceil(d/e)*e}var hr=ne(()=>{"use strict"});function fn(d){return pr(je+d)}function gt(d){if(d.length<je)throw new Error("BRIK: fichier tronqu\xE9 (en-t\xEAte)");let e=String.fromCharCode(d[0],d[1],d[2],d[3]);if(e!==dn)throw new Error(`BRIK: sceau magique absent (${e})`);let r=new DataView(d.buffer,d.byteOffset,d.byteLength),t=r.getUint32(4,!0),n=r.getUint32(8,!0);if(je+n>d.length)throw new Error("BRIK: manifeste tronqu\xE9");return{manifest:JSON.parse(new TextDecoder().decode(d.subarray(je,je+n))),version:t,dataStart:fn(n)}}function mr(d){let{manifest:e,version:r,dataStart:t}=gt(d);return{manifest:e,version:r,dataStart:t,data:d.subarray(t)}}var dn,je,vr=ne(()=>{"use strict";hr();dn="BRIK",je=12});function br(d){let e=[...d].sort((n,a)=>n.id-a.id),r=[],t=0;for(let n of e)r[n.id]=t,t+=n.byteLength;return r}function wr(d){let e=br(d.shards),r={};for(let[n,a]of Object.entries(d.tensors)){let s=gn[a.dtype];if(!s)throw new Error(`dtype BRIK inconnu pour ${n} : ${a.dtype}`);if(e[a.shard]===void 0)throw new Error(`shard ${a.shard} absent du manifeste (tenseur ${n})`);r[n]={offset:e[a.shard]+a.offset,bytes:a.byteLength,nElems:a.nElems,type:s,shape:a.shape}}let t=d.arch;return{arch:t.arch,config:{d:t.d,nHeads:t.nHeads,nKvHeads:t.nKvHeads,headDim:t.headDim,ffn:t.ffn,blockCount:t.blockCount,ropeTheta:t.ropeTheta,rmsEps:t.rmsEps,attnLogitSoftcap:t.attnLogitSoftcap,finalLogitSoftcap:t.finalLogitSoftcap,attnScale:t.attnScale,act:t.act,rmsGainOnePlus:t.rmsGainOnePlus,embedScale:t.embedScale,rwkv:t.rwkv,lfm2:t.lfm2},tensors:r}}var gn,yr=ne(()=>{"use strict";gn={f16:"F16",f32:"F32",q4:"Q4W",q8:"Q8W",q3:"Q3W"}});function hn(d,e,r){return`${d}${d.includes("?")?"&":"?"}__brik=${e}-${r}`}async function mn(){try{return await caches.open(pn)}catch{return null}}async function pt(d,e,r,t){let n=e+r-1,a=await mn(),s=hn(d,e,n);if(a){let o=await a.match(s);if(o)return{bytes:new Uint8Array(await o.arrayBuffer()),ranged:!0}}let i;for(let o=0;o<4;o++)try{let u=await fetch(d,{headers:{Range:`bytes=${e}-${n}`},signal:t});if(!u.ok&&u.status!==206)throw new Error(`range fetch ${e}-${n} \xE9chou\xE9 : HTTP ${u.status}`);let c=u.status===206,l=new Uint8Array(await u.arrayBuffer()),f=c?l:l.subarray(e,e+r);if(a&&c)try{await a.put(s,new Response(f,{headers:{"Content-Length":String(f.byteLength)}}))}catch(g){Ur(g)}return{bytes:f,ranged:c}}catch(u){if(t?.aborted)throw u;i=u,o<3&&await new Promise(c=>setTimeout(c,500*2**o))}throw i instanceof Error?i:new Error(String(i))}function Ur(d){kr||(kr=!0,console.warn("[cache] \xE9criture refus\xE9e (quota plein ? navigation priv\xE9e ?) : les t\xE9l\xE9chargements de mod\xE8les ne seront PAS r\xE9utilisables \xE0 la prochaine visite. Lib\xE9rez de l'espace via le panneau Stockage.",d))}async function vn(d){try{let n=await(await caches.open(Ar)).match(d);if(n)return new Uint8Array(await n.arrayBuffer())}catch{}let e=await fetch(d);if(!e.ok)throw new Error(`HTTP ${e.status}`);let r=new Uint8Array(await e.arrayBuffer());try{await(await caches.open(Ar)).put(d,new Response(r.slice(),{headers:{"Content-Length":String(r.byteLength)}}))}catch(t){Ur(t)}return r}function bn(d,e){return{bytes:async(r,t)=>(await pt(d,e+r,t)).bytes}}function wn(d){return{bytes:async(e,r)=>d.subarray(e,e+r)}}async function xr(d){let e=await pt(d,0,12);if(!e.ranged){let s=await vn(d),{manifest:i,data:o}=mr(s);return Pr(i,wn(o))}let r=new DataView(e.bytes.buffer,e.bytes.byteOffset,12).getUint32(8,!0),t=await pt(d,0,12+r),{manifest:n,dataStart:a}=gt(t.bytes);return Pr(n,bn(d,a))}function Pr(d,e){if(d.model?.uiArch==="image")throw new Error("Ce fichier est un BRIK image (UNet/CLIP) : il se charge via la tuile de g\xE9n\xE9ration d'image, pas comme un LLM.");return{source:e,manifest:wr(d),tokenizerId:d.tokenizer?.id,tokenizer:d.tokenizer,uiArch:d.model?.uiArch,modelName:d.model.name}}var pn,kr,Ar,Gr=ne(()=>{"use strict";"use client";ft();gr();vr();yr();pn="brik-range-v1";kr=!1;Ar="brimkern-model-cache"});function yn(d){let e=d.indexOf("<think>");if(e===-1)return d;let r=d.indexOf("</think>",e);return(r===-1?d.slice(0,e):d.slice(0,e)+d.slice(r+8)).trim()}function _r(d,e,r){d=d.map(n=>n.role==="assistant"?{...n,content:yn(n.content)}:n);let t="";if(e==="deepseek"){t+="<\uFF5Cbegin\u2581of\u2581sentence\uFF5C>",r.trim()&&(t+=r);for(let n of d)n.role==="user"?t+=`<\uFF5CUser\uFF5C>${n.content}`:n.role==="assistant"&&(t+=`<\uFF5CAssistant\uFF5C>${n.content}<\uFF5Cend\u2581of\u2581sentence\uFF5C>`);return t+="<\uFF5CAssistant\uFF5C>",t}if(e==="rwkv7"){r.trim()&&(t+=`System: ${r.trim()}
...
`}return t}var Br=ne(()=>{"use strict"});function kn(){let d=[];for(let a=33;a<=126;a++)d.push(a);for(let a=161;a<=172;a++)d.push(a);for(let a=174;a<=255;a++)d.push(a);let e=d.slice(),r=0;for(let a=0;a<256;a++)d.includes(a)||(d.push(a),e.push(256+r),r++);let t=new Array(256),n=new Map;for(let a=0;a<d.length;a++)t[d[a]]=String.fromCodePoint(e[a]),n.set(String.fromCodePoint(e[a]),d[a]);return{enc:t,dec:n}}var qr,Ie,Fr=ne(()=>{"use strict";qr="'(?:[sdmt]|ll|ve|re)| ?\\p{L}+| ?\\p{N}+| ?[^\\s\\p{L}\\p{N}]+|\\s+(?!\\S)|\\s+",Ie=class d{constructor(e){this.vocab=new Map;this.idToTok=new Map;this.ranks=new Map;this.added=[];this.specialIds=new Set;this.addedRe=null;this.bosIds=[];this.cache=new Map;let r=typeof e=="string"?JSON.parse(e):e;if(r?.model?.type!=="BPE")throw new Error(`BpeTokenizer : model.type ${r?.model?.type} non couvert (BPE uniquement)`);({enc:this.byteEnc,dec:this.byteDec}=kn());for(let[i,o]of Object.entries(r.model.vocab))this.vocab.set(i,o),this.idToTok.set(o,i);(r.model.merges??[]).forEach((i,o)=>this.ranks.set(Array.isArray(i)?`${i[0]} ${i[1]}`:i,o));for(let i of r.added_tokens??[])this.added.push(i),this.vocab.set(i.content,i.id),this.idToTok.set(i.id,i.content),i.special&&this.specialIds.add(i.id);if(this.added.length){let i=this.added.map(o=>o.content.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).sort((o,u)=>u.length-o.length);this.addedRe=new RegExp(`(${i.join("|")})`,"g")}let n=d.findSplitPattern(r.pre_tokenizer)??qr;this.splitRe=new RegExp(n,"gu");let a=i=>{if(!i)return null;if(i.type==="TemplateProcessing")return i.single;if(i.type==="Sequence")for(let o of i.processors??[]){let u=a(o);if(u)return u}return null},s=a(r.post_processor);if(Array.isArray(s))for(let i of s)if(i.SpecialToken){let o=this.vocab.get(i.SpecialToken.id);o!==void 0&&this.bosIds.push(o)}else break}static findSplitPattern(e){if(!e)return null;if(e.type==="Split"&&e.pattern?.Regex)return e.pattern.Regex;if(e.type==="ByteLevel"&&e.use_regex!==!1)return qr;if(e.type==="Sequence")for(let r of e.pretokenizers??[]){let t=d.findSplitPattern(r);if(t)return t}return null}bpe(e){let r=this.cache.get(e);if(r)return r;let t=Array.from(e);for(;t.length>1;){let a=-1,s=1/0;for(let i=0;i<t.length-1;i++){let o=this.ranks.get(`${t[i]} ${t[i+1]}`);o!==void 0&&o<s&&(s=o,a=i)}if(a<0)break;t=[...t.slice(0,a),t[a]+t[a+1],...t.slice(a+2)]}let n=[];for(let a of t){let s=this.vocab.get(a);if(s!==void 0)n.push(s);else for(let i of a){let o=this.vocab.get(i);o!==void 0&&n.push(o)}}return this.cache.set(e,n),n}encodeChunk(e){let r=[];for(let t of e.match(this.splitRe)??[]){let n=new TextEncoder().encode(t),a="";for(let s of n)a+=this.byteEnc[s];r.push(...this.bpe(a))}return r}encode(e){let r=[...this.bosIds];if(this.addedRe)for(let t of e.split(this.addedRe)){if(!t)continue;let n=this.vocab.get(t);n!==void 0&&this.added.some(a=>a.content===t)?r.push(n):r.push(...this.encodeChunk(t))}else r.push(...this.encodeChunk(e));return r}decode(e){let r=[];for(let t of e){if(this.specialIds.has(t))continue;let n=this.idToTok.get(t);if(n!==void 0)for(let a of n){let s=this.byteDec.get(a);if(s!==void 0)r.push(s);else for(let i of new TextEncoder().encode(a))r.push(i)}}return new TextDecoder("utf-8",{fatal:!1}).decode(new Uint8Array(r))}}});async function xn(d,e){let r=new $e;if(!await r.init())throw new Error("WebGPU indisponible sur ce navigateur.");r.onLost=g=>{console.warn("[brimkern] device GPU perdu ("+(g?.reason||"unknown")+"): rechargement au prochain appel"),Pe.delete(d)},await r.selfValidate(),e("t\xE9l\xE9chargement du mod\xE8le\u2026");let t=await xr(d),n=t.manifest;if(!n?.config?.lfm2){let g=n?.arch??n?.config?.arch??"unknown";throw new Error(`Brimkern SDK v0 runs LFM2 .brik models only: this file's architecture is "${g}". Use the default model (omit \`model\`), or convert/pick an LFM2 .brik. Full model support lives in the app: https://brimkern.com/chat`)}let a=n.tensors["token_embd.weight"],s={arch:{...n.config,arch:"lfm2",vocab:a?a.nElems/n.config.d:0},tensors:Object.fromEntries(Object.entries(n.tensors).map(([g,p])=>[g,{dtype:Pn[p.type]??p.type,shape:p.shape,nElems:p.nElems,shard:0,offset:p.offset,byteLength:p.bytes}])),shards:[{id:0,file:"",byteLength:0}],chat:{template:"chatml",stopTokenIds:[7,2,8,10,12]}},i=Object.values(n.tensors).reduce((g,p)=>g+p.bytes,0),o=0,u=fr(n.tensors,t.source),c=async g=>{let p=n.tensors[g];if(!p)throw new Error(`tenseur absent : ${g}`);let m=await u(g);return o+=p.bytes,e("t\xE9l\xE9chargement du mod\xE8le\u2026",{loaded:o,total:i}),m};e("tokenizer\u2026");let l;try{let g=new Ie(t.tokenizer.json);l={encode:p=>g.encode(p),decode:p=>g.decode(p)}}catch(g){console.warn("[brimkern] tokenizer.json non couvert par le BPE bundl\xE9 : repli transformers.js (CDN)",g);let p=await import(An),m=new p.PreTrainedTokenizer(JSON.parse(t.tokenizer.json),JSON.parse(t.tokenizer.config));l={encode:b=>Array.from(m(b).input_ids.data,k=>Number(k)),decode:b=>m.decode(b,{skip_special_tokens:!0})}}let f=new Ye(r,s,c);return e("poids sur le GPU\u2026"),await f.load(l),{core:f,engine:r}}function ze(d){return d&&(d.startsWith("https://")||/^http:\/\/(localhost|127\.0\.0\.1)[:/]/.test(d))?d:Sr[d||"lfm2.5-230m"]||Sr["lfm2.5-230m"]}function Je(d,e){let r=Pe.get(d);if(!r){let t={status:"initialisation\u2026",state:"loading",listeners:new Set,promise:null};t.promise=xn(d,(n,a)=>{t.status=n,t.progress=a,t.listeners.forEach(s=>s(n,a))}).then(n=>(t.state="ready",n)).catch(n=>{throw t.state="error",Pe.delete(d),n}),Pe.set(d,t),r=t}return e&&(e(r.status,r.progress),r.listeners.add(e),r.promise.finally(()=>r.listeners.delete(e)).catch(()=>{})),r.promise}async function Or(d,e){let r=await Je(d,e);return r.engine.lost?(Pe.delete(d),(await Je(d,e)).core):r.core}async function Tr(d,e){let r=await Or(d);try{return await e(r)}catch(t){let n=Pe.get(d);if(!(!n||await n.promise.then(s=>s.engine.lost).catch(()=>!0)))throw t;return console.warn("[brimkern] g\xE9n\xE9ration interrompue par une perte de device : nouvelle tentative"),Pe.delete(d),e(await Or(d))}}function Gn(d,e){let r=d.replace(/<\|[a-z_]+\|>/g,"");if(e){let t=r.replace(/^\s*(hello|hi|hey|bonjour|salut)\s*[!,.]\s*/i,"");t.trim()&&(r=t)}return r.trimEnd()}async function Mr(d,e,r,t,n,a,s,i=[]){let o=_r([...i,...e.slice(-Un)],"lfm2",r),u=i.some(f=>f.role==="assistant")||e.some(f=>f.role==="assistant"),c="";return await(d.residentAvailable?.()?d.generateResident.bind(d):d.generate.bind(d))(o,t,f=>{c=Gn(f,u),a?.(c)},s,{sample:!0,temperature:n,topK:40,repeatPenalty:1.3}),c}var An,Sr,Pn,Un,Pe,ht=ne(()=>{"use strict";or();lr();Gr();ft();Br();Fr();An="https://esm.sh/@huggingface/transformers@4.2.0",Sr={"lfm2.5-230m":"https://huggingface.co/romainkh14/LFM2.5-230M_BRIK/resolve/main/lfm25-230m-q4.brik"},Pn={F16:"f16",F32:"f32",Q4W:"q4",Q8W:"q8",Q3W:"q3"},Un=12;Pe=new Map});var Cr={};Qt(Cr,{LocalBackend:()=>He});var He,mt=ne(()=>{"use strict";ht();He=class{constructor(){this.kind="main"}async preload(e,r){await Je(e,r)}state(e){return Pe.get(e)?.state}turn(e,r,t){return Tr(e.url,n=>Mr(n,e.history,e.system,e.maxTokens,e.temperature,r,()=>!!t?.aborted,e.pinned))}dispose(){}}});function _n(){try{if(typeof document>"u")return"";let d=document.currentScript;if(d?.src)return new URL(d.src,document.baseURI).href}catch{}return""}function Dr(d){Rr=d}function Lr(){return Rr||Bn}var Bn,Rr,vt=ne(()=>{"use strict";Bn=_n(),Rr=""});var Kr={};Qt(Kr,{WorkerBackend:()=>bt});var bt,jr=ne(()=>{"use strict";vt();bt=class{constructor(){this.kind="worker";this.seq=0;this.pending=new Map;this.states=new Map;if(typeof Worker>"u")throw new Error("Worker indisponible");let e=Lr();if(!e)throw new Error("URL du script introuvable (import ESM ?) : passez workerUrl");let r=(()=>{try{return location.search}catch{return""}})(),t=`self.__brimkernSearch=${JSON.stringify(r)};importScripts(${JSON.stringify(e)});`,n=new Blob([t],{type:"text/javascript"});this.url=URL.createObjectURL(n),this.worker=new Worker(this.url);let a,s;this.hello=new Promise((i,o)=>{a=i,s=o}),this.worker.onerror=i=>s(new Error(`worker: ${i.message||"\xE9chec de chargement"}`)),this.worker.onmessage=i=>{let o=i.data;if(o.type==="hello"){a();return}let u=this.pending.get(o.id);if(u){if(o.type==="progress"){u.onProgress?.(o.status,o.progress);return}if(o.type==="token"){u.onToken?.(o.text);return}this.pending.delete(o.id),o.type==="error"?u.reject(new Error(o.message)):o.type==="state"?u.resolve(o.state):u.resolve(o.text??"")}}}ready(){return this.hello}send(e,r={}){let t=++this.seq,n=new Promise((a,s)=>{this.pending.set(t,{resolve:a,reject:s,...r}),this.worker.postMessage({...e,id:t})});return{id:t,done:n}}async preload(e,r){await this.hello,this.states.get(e)!=="ready"&&this.states.set(e,"loading");try{await this.send({type:"preload",url:e},{onProgress:r}).done,this.states.set(e,"ready")}catch(t){throw this.states.set(e,"error"),t}}state(e){return this.states.get(e)}async turn(e,r,t){await this.hello;let{id:n,done:a}=this.send({type:"turn",req:e},{onToken:r}),s=()=>this.worker.postMessage({type:"stop",id:n});t?.aborted?s():t?.addEventListener("abort",s,{once:!0});try{let i=await a;return this.states.set(e.url,"ready"),i}finally{t?.removeEventListener("abort",s)}}dispose(){this.worker.terminate(),URL.revokeObjectURL(this.url);for(let e of this.pending.values())e.reject(new Error("worker arr\xEAt\xE9"));this.pending.clear()}}});var qn={};var wt,Xe,Me,Hr=ne(()=>{"use strict";mt();wt=new He,Xe=new Set,Me=d=>self.postMessage(d);self.onmessage=async d=>{let e=d.data;if(e.type==="stop"){Xe.add(e.id);return}if(e.type==="state"){Me({type:"state",id:e.id,state:wt.state(e.url)});return}try{if(e.type==="preload"){await wt.preload(e.url,(r,t)=>Me({type:"progress",id:e.id,status:r,progress:t})),Me({type:"done",id:e.id});return}if(e.type==="turn"){let r=new AbortController,t=new Proxy(r.signal,{get:(u,c)=>c==="aborted"?Xe.has(e.id):Reflect.get(u,c)}),n=16,a=0,s=null,i=()=>{s!==null&&(Me({type:"token",id:e.id,text:s}),s=null,a=Date.now())},o=await wt.turn(e.req,u=>{s=u,Date.now()-a>=n&&i()},t);i(),Me({type:"done",id:e.id,text:o}),Xe.delete(e.id);return}}catch(r){Xe.delete(e.id),Me({type:"error",id:e.id,message:r instanceof Error?r.message:String(r)})}};Me({type:"hello"})});var Jr=new Set(["avec","pour","dans","les","des","une","est","sur","par","que","qui","quoi","comment","pourquoi","quand","vous","nous","votre","notre","mais","plus","tout","tous","cette","sont","avez","puis","faire","fait","the","and","for","with","what","who","how","why","when","about","your","our","you","are","can","does","did","this","that","from","have"]);function Vt(d){let e=(d.toLowerCase().match(/[\p{L}\p{N}]{3,}/gu)??[]).filter(r=>!Jr.has(r));return[...new Set(e)]}function $t(d,e=600){let r=[];return d.forEach((t,n)=>{let a=(t.title||"").trim(),s=(t.text||"").split(/\n\s*\n+/).map(u=>u.trim()).filter(Boolean),i="",o=()=>{i.trim()&&r.push({title:a,text:i.trim(),doc:n}),i=""};for(let u of s){if(u.length>e*1.6){o();let c=u.split(/(?<=[.!?])\s+/),l="";for(let f of c)l&&(l+" "+f).length>e?(r.push({title:a,text:l.trim(),doc:n}),l=f):l=l?`${l} ${f}`:f;l.trim()&&r.push({title:a,text:l.trim(),doc:n});continue}i&&(i+`

`+u).length>e&&o(),i=i?`${i}

${u}`:u}o()}),r}function Xr(d,e,r){if(!d.length)return 0;let t=`${e.title} ${e.text}`.toLowerCase(),n=e.title.toLowerCase(),a=0,s=0;for(let i of d){let o=r.get(i)??1;s+=o,t.includes(i)&&(a+=o*(n.includes(i)?1.5:1))}return s?a/s:0}function Zr(d){let e=new Map;for(let n of d)for(let a of Vt(`${n.title} ${n.text}`))e.set(a,(e.get(a)??0)+1);let r=new Map,t=Math.max(1,d.length);for(let[n,a]of e)r.set(n,Math.log(1+t/a));return r}function Yt(d,e,r=1200,t=3,n=.34){let a=Vt(d);if(!a.length||!e.length)return[];let s=Zr(e),i=e.map(l=>({c:l,s:Xr(a,l,s)})).filter(l=>l.s>=n).sort((l,f)=>f.s-l.s),o=[],u=new Set,c=r;for(let{c:l}of i)o.length>=t||l.text.length>c||u.has(l.doc)||(o.push(l),u.add(l.doc),c-=l.text.length);for(let{c:l}of i){if(o.length>=t)break;o.includes(l)||l.text.length>c||(o.push(l),c-=l.text.length)}return o}function It(d){return d.length?`
...
No reference note matches this question. Say that you do not have this information: do not guess.`}function Jt(d){let e=Array.isArray(d)?d:[d],r=[];for(let t of e)typeof t=="string"&&t.trim()?r.push({text:t}):t&&typeof t=="object"&&typeof t.text=="string"&&t.text.trim()&&r.push({title:t.title,text:t.text});return r}ht();async function zr(d){let{LocalBackend:e}=await Promise.resolve().then(()=>(mt(),Cr));if(d!==!0)return new e;try{let{WorkerBackend:r}=await Promise.resolve().then(()=>(jr(),Kr)),t=new r;return await t.ready(),t}catch(r){return console.warn("[brimkern] Web Worker indisponible : inf\xE9rence sur le thread principal",r),new e}}vt();var Fn=typeof self<"u"&&typeof self.importScripts=="function"&&typeof document>"u";Fn&&Promise.resolve().then(()=>(Hr(),qn));var Ze=null,kt=null,yt;function Ee(){return Ze||(Ze=zr(yt).then(d=>(kt=d,d))),Ze}var Sn=()=>kt?.kind??"pending";function At(d){if(d.workerUrl&&Dr(d.workerUrl),d.worker!==void 0){if(Ze&&yt!==d.worker){console.warn("[brimkern] option `worker` ignor\xE9e : le backend est d\xE9j\xE0 d\xE9marr\xE9 et partag\xE9 par la page.");return}yt=d.worker}}var On=`
Answer briefly and honestly. If you do not know something, say so: never invent facts or details.
You have no tools and no internet access: never emit tool calls, reply in plain text only.`;function Nr(d){let e=(d.system||"You are a helpful assistant.")+On,r=s=>s.flatMap(i=>[{role:"user",content:i.user},{role:"assistant",content:i.assistant}]);if(!d.knowledge)return{system:()=>e,userTurn:s=>s,pinned:r(d.examples||[])};let t=$t(Jt(d.knowledge)),n=d.knowledgeBudget??1200,a=e+`

The user message may include reference notes between --- markers. When it does, answer from those notes and quote their figures exactly. When it says no note matches, say you do not have that information.`;return{system:()=>a,userTurn:s=>It(Yt(s,t,n)).trim()+`

Question: ${s}`,pinned:r([...Tn(),...d.examples||[]])}}function Tn(){return[{user:`--- NOTES ---
[1] Opening hours
...
Question: Who won the 1998 World Cup?`,assistant:"I do not have that information in my notes."}]}function Wr(d={}){At(d);let e=ze(d.model),r=d.maxTokens||220,t=d.temperature??.55,n=Nr(d),a=n.pinned,s=[],i=!1,o=!1;return{async ask(u,c={}){if(o)throw new Error("session d\xE9truite");if(i)throw new Error("g\xE9n\xE9ration d\xE9j\xE0 en cours sur cette session");i=!0,s.push({role:"user",content:u});try{let l=[...s.slice(0,-1),{role:"user",content:n.userTurn(u)}],f={url:e,history:l,system:n.system(u),maxTokens:r,temperature:t,pinned:a},g=await(await Ee()).turn(f,c.onToken,c.signal);return c.signal?.aborted?(s.pop(),""):(s.push({role:"assistant",content:g}),g)}catch(l){throw s.pop(),l}finally{i=!1}},reset(){s=[]},destroy(){o=!0,s=[]},get history(){return s.slice()}}}function Mn(d){if(document.getElementById("bk-style"))return;let e=document.createElement("style");e.id="bk-style",e.textContent=`
  ...
  `,document.head.appendChild(e)}function Cn(d){if(!d)return"#c72c1e";if(/^#[0-9a-fA-F]{3,8}$/.test(d))return d;try{if(typeof CSS<"u"&&CSS.supports("color",d)&&!/[{};()]/.test(d))return d}catch{}return"#c72c1e"}function Er(d){let e=Nr(d),r=Cn(d.accent),t=d.title||"Assistant",n=d.maxTokens||220;Mn(r);let a=document.createElement("button");a.className="bk-fab",a.setAttribute("aria-label","Ouvrir le chat"),a.textContent="\u{1F4AC}";let s=document.createElement("div");s.className="bk-panel",s.innerHTML=`
    <div class="bk-hd"><span class="bk-dot"></span><span>${Rn(t)}</span><button class="bk-x" aria-label="Fermer">\xD7</button></div>
    ...
    <div class="bk-note">IA locale \u2014 tourne sur votre GPU, aucune donn\xE9e envoy\xE9e.</div>`,document.body.appendChild(a),document.body.appendChild(s);let i=s.querySelector(".bk-msgs"),o=s.querySelector(".bk-in"),u=s.querySelector(".bk-send"),c=[],l=!1,f=!1,g=(k,B)=>{let O=document.createElement("div");return O.className=`bk-m ${k==="user"?"bk-u":"bk-a"}`,O.textContent=B,i.appendChild(O),i.scrollTop=i.scrollHeight,O};d.greeting&&(c.push({role:"assistant",content:d.greeting}),g("assistant",d.greeting));let p=ze(d.model),m=()=>{if(!f){f=!0;let k=g("assistant","Initialisation\u2026");k.classList.add("bk-status"),Ee().then(B=>B.preload(p,(O,q)=>{k.textContent=q?.total?`${O} ${Math.round(q.loaded/1048576)} / ${Math.round(q.total/1048576)} Mo`:O})).then(()=>k.remove()).catch(B=>{k.textContent="Erreur : "+(B?.message||B),f=!1})}return Ee()},b=async()=>{let k=o.value.trim();if(!k||l)return;l=!0,u.disabled=!0,o.value="",c.push({role:"user",content:k}),g("user",k);let B=g("assistant","\u2026");try{await m();let O=[...c.slice(0,-1),{role:"user",content:e.userTurn(k)}],q={url:p,history:O,system:e.system(k),maxTokens:n,temperature:.55,pinned:e.pinned},C=await(await Ee()).turn(q,j=>{B.textContent=j||"\u2026",i.scrollTop=i.scrollHeight});C||(C="Sorry, I can only answer in plain text here: could you rephrase?"),B.textContent=C,c.push({role:"assistant",content:C})}catch(O){B.textContent="Erreur : "+(O?.message||String(O))}finally{l=!1,u.disabled=!1,o.focus()}};a.onclick=()=>{s.classList.toggle("bk-open")&&(o.focus(),m())},s.querySelector(".bk-x").onclick=()=>s.classList.remove("bk-open"),u.onclick=()=>{b()},o.onkeydown=k=>{k.key==="Enter"&&!k.shiftKey&&(k.preventDefault(),b())}}function Rn(d){return d.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}var Dn=(d={})=>{if(typeof window>"u"||typeof document>"u"){console.warn("[brimkern] embed() ignor\xE9 : aucun DOM (rendu serveur ?). Appelez-le dans un effet client.");return}At(d),document.body?Er(d):window.addEventListener("DOMContentLoaded",()=>Er(d))};var Ln=async d=>{if(typeof d!="object"||d===null||typeof d.prompt!="string")throw new TypeError(`Brimkern.generate expects a single object: generate({ prompt: "\u2026", model?, system? }). Received ${typeof d}${typeof d=="object"&&d?" without a `prompt` string":""}.`);return Wr(d).ask(d.prompt,{onToken:d.onToken,signal:d.signal})},Kn=(d={})=>(At(d),typeof navigator<"u"&&"gpu"in navigator?Ee().then(e=>e.preload(ze(d.model),d.onProgress)).then(()=>!0).catch(()=>!1):Promise.resolve(!1)),jn=d=>typeof navigator>"u"||!("gpu"in navigator)?"unavailable":kt?.state(ze(d))??"idle";typeof window<"u"&&(window.Brimkern={embed:Dn,createSession:Wr,generate:Ln,preload:Kn,status:jn,runtime:Sn});})();
