"use strict";(()=>{var un=Object.defineProperty;var ae=(l,e,r)=>()=>{if(r)throw r[0];try{return l&&(e=l(l=0)),e}catch(t){throw r=[t],t}};var Jt=(l,e)=>{for(var r in e)un(l,r,{get:e[r],enumerable:!0})};function Be(l){let e=new Float32Array(1),r=new Uint32Array(e.buffer);e[0]=l;let t=r[0],n=t>>16&32768,i=(t>>23&255)-127+15,a=t&8388607;return i<=0?n:i>=31?n|31743:(a=(a>>13)+(a>>12&1),a===1024&&(a=0,i+=1),n|i<<10|a&1023)}function ge(l){let e=l>>15&1,r=l>>10&31,t=l&1023,n;return r===0?n=t*59604645e-15:r===31?n=t?NaN:1/0:n=(1+t/1024)*2**(r-15),e===1?-n:n}var De=ae(()=>{"use strict"});function ke(l){let e=l.length;if(e%ye!==0)throw new Error(`q4web: length ${e} not a multiple of ${ye}`);let r=e/ye,t=new Uint8Array(e/2),n=new Uint16Array(r),i=new Uint16Array(r);for(let a=0;a<r;a++){let s=a*ye,o=1/0,u=-1/0;for(let m=0;m<ye;m++){let b=l[s+m];b<o&&(o=b),b>u&&(u=b)}let c=(u-o)/15||1e-8,d=Be(c),f=Be(o);n[a]=d,i[a]=f;let g=ge(d)||1e-8,p=ge(f);for(let m=0;m<ye;m++){let b=Math.round((l[s+m]-p)/g);b=b<0?0:b>15?15:b;let k=s+m;(m&1)===0?t[k>>1]=b:t[k>>1]|=b<<4}}return{nibbles:t,scales:n,mins:i,nElems:e}}function qe(l,e){let r=e/ye,t=e/2,n=l.slice(0,t),i=new Uint16Array(r),a=new Uint16Array(r),s=new DataView(l.buffer,l.byteOffset);for(let o=0;o<r;o++)i[o]=s.getUint16(t+o*2,!0);for(let o=0;o<r;o++)a[o]=s.getUint16(t+r*2+o*2,!0);return{nibbles:n,scales:i,mins:a,nElems:e}}function pe(l){let e=new Float32Array(l.nElems),r=l.nElems/ye;for(let t=0;t<r;t++){let n=ge(l.scales[t]),i=ge(l.mins[t]),a=t*ye;for(let s=0;s<ye;s++){let o=a+s,u=l.nibbles[o>>1],c=(s&1)===0?u&15:u>>4;e[o]=c*n+i}}return e}var ye,dt=ae(()=>{"use strict";De();ye=32});function Pe(l){let e=l.length;if(e%Ae!==0)throw new Error(`q8web: length ${e} not a multiple of ${Ae}`);let r=e/Ae,t=new Int8Array(e),n=new Uint16Array(r);for(let i=0;i<r;i++){let a=i*Ae,s=0;for(let d=0;d<Ae;d++){let f=Math.abs(l[a+d]);f>s&&(s=f)}let o=s/127||1e-8,u=Be(o);n[i]=u;let c=ge(u)||1e-8;for(let d=0;d<Ae;d++){let f=Math.round(l[a+d]/c);f=f<-127?-127:f>127?127:f,t[a+d]=f}}return{codes:t,scales:n,nElems:e}}function Oe(l,e){let r=e/Ae,t=new Int8Array(l.buffer.slice(l.byteOffset,l.byteOffset+e)),n=new Uint16Array(r),i=new DataView(l.buffer,l.byteOffset);for(let a=0;a<r;a++)n[a]=i.getUint16(e+a*2,!0);return{codes:t,scales:n,nElems:e}}function me(l){let e=new Float32Array(l.nElems),r=l.nElems/Ae;for(let t=0;t<r;t++){let n=ge(l.scales[t]),i=t*Ae;for(let a=0;a<Ae;a++)e[i+a]=l.codes[i+a]*n}return e}var Ae,ft=ae(()=>{"use strict";De();Ae=32});function sr(l){let e=l.length;if(e%Ue!==0)throw new Error(`q3web: length ${e} not a multiple of ${Ue}`);let r=e/Ue,t=new Uint32Array(e/16),n=new Uint32Array(e/32),i=new Uint16Array(r),a=new Uint16Array(r);for(let s=0;s<r;s++){let o=s*Ue,u=1/0,c=-1/0;for(let b=0;b<Ue;b++){let k=l[o+b];k<u&&(u=k),k>c&&(c=k)}let d=(c-u)/7||1e-8,f=Be(d),g=Be(u);i[s]=f,a[s]=g;let p=ge(f)||1e-8,m=ge(g);for(let b=0;b<Ue;b++){let k=Math.round((l[o+b]-m)/p);k=k<0?0:k>7?7:k;let B=o+b;t[B>>4]|=(k&3)<<(B&15)*2,n[B>>5]|=k>>2<<(B&31)}}return{lo:t,hi:n,scales:i,mins:a,nElems:e}}function gt(l,e){let r=e/Ue,t=e/16,n=e/32,i=t*4,a=n*4,s=new DataView(l.buffer,l.byteOffset),o=new Uint32Array(t),u=new Uint32Array(n),c=new Uint16Array(r),d=new Uint16Array(r);for(let p=0;p<t;p++)o[p]=s.getUint32(p*4,!0);for(let p=0;p<n;p++)u[p]=s.getUint32(i+p*4,!0);let f=i+a,g=f+r*2;for(let p=0;p<r;p++)c[p]=s.getUint16(f+p*2,!0);for(let p=0;p<r;p++)d[p]=s.getUint16(g+p*2,!0);return{lo:o,hi:u,scales:c,mins:d,nElems:e}}function Ie(l){let e=new Float32Array(l.nElems),r=l.nElems/Ue;for(let t=0;t<r;t++){let n=ge(l.scales[t]),i=ge(l.mins[t]),a=t*Ue;for(let s=0;s<Ue;s++){let o=a+s,u=l.lo[o>>4]>>(o&15)*2&3|(l.hi[o>>5]>>(o&31)&1)<<2;e[o]=u*n+i}}return e}var Ue,ar=ae(()=>{"use strict";De();Ue=32});var or,ur,cr=ae(()=>{"use strict";or={matmul:`
...
--- NOTES ---
${l.map((t,n)=>`[${n+1}]${t.title?` ${t.title}`:""}
${t.text}`).join(`

`)}
--- END OF NOTES ---`:`

No reference note matches this question. Say that you do not have this information: do not guess.`}function ir(l){let e=Array.isArray(l)?l:[l],r=[];for(let t of e)typeof t=="string"&&t.trim()?r.push({text:t}):t&&typeof t=="object"&&typeof t.text=="string"&&t.text.trim()&&r.push({title:t.title,text:t.text});return r}kt();async function Jr(l){let{LocalBackend:e}=await Promise.resolve().then(()=>(At(),Qr));if(l!==!0)return new e;try{let{WorkerBackend:r}=await Promise.resolve().then(()=>(Xr(),Yr)),t=new r;return await t.ready(),t}catch(r){return console.warn("[brimkern] Web Worker indisponible : inf\xE9rence sur le thread principal",r),new e}}Pt();var Zn=typeof self<"u"&&typeof self.importScripts=="function"&&typeof document>"u";Zn&&Promise.resolve().then(()=>(Zr(),Jn));var nt=null,Gt=null,_t;function Ne(){return nt||(nt=Jr(_t).then(l=>(Gt=l,l))),nt}var ei=()=>Gt?.kind??"pending";function Bt(l){if(l.workerUrl&&Ir(l.workerUrl),l.worker!==void 0){if(nt&&_t!==l.worker){console.warn("[brimkern] option `worker` ignor\xE9e : le backend est d\xE9j\xE0 d\xE9marr\xE9 et partag\xE9 par la page.");return}_t=l.worker}}var ti=`
Answer briefly and honestly. If you do not know something, say so: never invent facts or details.
You have no tools and no internet access: never emit tool calls, reply in plain text only.`;function tn(l){let e=(l.system||"You are a helpful assistant.")+ti,r=s=>s.flatMap(o=>[{role:"user",content:o.user},{role:"assistant",content:o.assistant}]);if(!l.knowledge)return{system:()=>e,userTurn:s=>s,pinned:r(l.examples||[])};let t=tr(ir(l.knowledge)),n=l.knowledgeBudget??1200,i=l.system?/[àéèêîôùç]|bonjour|conseiller|boutique|aide/i.test(l.system):!1,a=i?e+`
...
The user message may include reference notes between --- markers. When it does, answer from those notes and quote their figures exactly. When it says no note matches, say you do not have that information.`;return{system:()=>a,userTurn:s=>{let o=nr(rr(s,t,n),s).trim();return o?`${o}

Question: ${s}`:s},pinned:r([...ri(i),...l.examples||[]])}}function ri(l=!1){return l?[{user:"Bonjour !",assistant:"Bonjour ! Comment puis-je vous aider ?"},{user:`--- NOTES ---
[1] Horaires
L\u2019atelier est ouvert le jeudi jusqu\u2019\xE0 20h.
--- END OF NOTES ---

Question: \xCAtes-vous ouverts le jeudi soir ?`,assistant:"Oui, l\u2019atelier est ouvert le jeudi jusqu\u2019\xE0 20h."},{user:`No reference note matches this question. Say that you do not have this information: do not guess.

Question: Qui a gagn\xE9 la Coupe du Monde 1998 ?`,assistant:"Je n\u2019ai pas cette information dans mes fiches."}]:[{user:"Hello!",assistant:"Hello! How can I help you today?"},{user:`--- NOTES ---
[1] Opening hours
The workshop is open on Thursday until 8pm.
--- END OF NOTES ---

Question: Are you open on Thursday evening?`,assistant:"Yes: the workshop is open on Thursday until 8pm."},{user:`No reference note matches this question. Say that you do not have this information: do not guess.

Question: Who won the 1998 World Cup?`,assistant:"I do not have that information in my notes."}]}function rn(l={}){Bt(l);let e=Ke(l.model),r=l.maxTokens||220,t=l.temperature??.55,n=tn(l),i=n.pinned,a=[],s=!1,o=!1;return{async ask(u,c={}){if(o)throw new Error("session d\xE9truite");if(s)throw new Error("g\xE9n\xE9ration d\xE9j\xE0 en cours sur cette session");s=!0,a.push({role:"user",content:u});try{let d=[...a.slice(0,-1),{role:"user",content:n.userTurn(u)}],f={url:e,history:d,system:n.system(u),maxTokens:r,temperature:t,pinned:i},g=await(await Ne()).turn(f,c.onToken,c.signal);return c.signal?.aborted?(a.pop(),""):(a.push({role:"assistant",content:g}),g)}catch(d){throw a.pop(),d}finally{s=!1}},reset(){a=[]},destroy(){o=!0,a=[]},get history(){return a.slice()}}}function ni(l){if(document.getElementById("bk-style"))return;let e=document.createElement("style");e.id="bk-style",e.textContent=`
  ...
  `,document.head.appendChild(e)}function ii(l){if(!l)return"#c72c1e";if(/^#[0-9a-fA-F]{3,8}$/.test(l))return l;try{if(typeof CSS<"u"&&CSS.supports("color",l)&&!/[{};()]/.test(l))return l}catch{}return"#c72c1e"}function en(l){let e=tn(l),r=ii(l.accent),t=l.title||"Assistant",n=l.maxTokens||220;ni(r);let i=document.createElement("button");i.className="bk-fab",i.setAttribute("aria-label","Ouvrir le chat"),i.textContent="\u{1F4AC}";let a=document.createElement("div");a.className="bk-panel",a.innerHTML=`
    ...
    <div class="bk-note">IA locale \u2014 tourne sur votre GPU, aucune donn\xE9e envoy\xE9e.</div>`,document.body.appendChild(i),document.body.appendChild(a);let s=a.querySelector(".bk-msgs"),o=a.querySelector(".bk-in"),u=a.querySelector(".bk-send"),c=[],d=!1,f=!1,g=(k,B)=>{let S=document.createElement("div");return S.className=`bk-m ${k==="user"?"bk-u":"bk-a"}`,S.textContent=B,s.appendChild(S),s.scrollTop=s.scrollHeight,S};l.greeting&&(c.push({role:"assistant",content:l.greeting}),g("assistant",l.greeting));let p=Ke(l.model),m=()=>{if(!f){f=!0;let k=g("assistant","Initialisation\u2026");k.classList.add("bk-status"),Ne().then(B=>B.preload(p,(S,q)=>{k.textContent=q?.total?`${S} ${Math.round(q.loaded/1048576)} / ${Math.round(q.total/1048576)} Mo`:S})).then(()=>k.remove()).catch(B=>{k.textContent="Erreur : "+(B?.message||B),f=!1})}return Ne()},b=async()=>{let k=o.value.trim();if(!k||d)return;d=!0,u.disabled=!0,o.value="",c.push({role:"user",content:k}),g("user",k);let B=g("assistant","\u2026");try{await m();let S=[...c.slice(0,-1),{role:"user",content:e.userTurn(k)}],q={url:p,history:S,system:e.system(k),maxTokens:n,temperature:.55,pinned:e.pinned},M=await(await Ne()).turn(q,E=>{B.textContent=E||"\u2026",s.scrollTop=s.scrollHeight});M||(M="Sorry, I can only answer in plain text here: could you rephrase?"),B.textContent=M,c.push({role:"assistant",content:M})}catch(S){B.textContent="Erreur : "+(S?.message||String(S))}finally{d=!1,u.disabled=!1,o.focus()}};i.onclick=()=>{a.classList.toggle("bk-open")&&(o.focus(),m())},a.querySelector(".bk-x").onclick=()=>a.classList.remove("bk-open"),u.onclick=()=>{b()},o.onkeydown=k=>{k.key==="Enter"&&!k.shiftKey&&(k.preventDefault(),b())}}function si(l){return l.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}var ai=(l={})=>{if(typeof window>"u"||typeof document>"u"){console.warn("[brimkern] embed() ignor\xE9 : aucun DOM (rendu serveur ?). Appelez-le dans un effet client.");return}Bt(l),document.body?en(l):window.addEventListener("DOMContentLoaded",()=>en(l))};var oi=async l=>{if(typeof l!="object"||l===null||typeof l.prompt!="string")throw new TypeError(`Brimkern.generate expects a single object: generate({ prompt: "\u2026", model?, system? }). Received ${typeof l}${typeof l=="object"&&l?" without a `prompt` string":""}.`);return rn(l).ask(l.prompt,{onToken:l.onToken,signal:l.signal})},ui=(l={})=>(Bt(l),typeof navigator<"u"&&"gpu"in navigator?Ne().then(e=>e.preload(Ke(l.model),l.onProgress)).then(()=>!0).catch(()=>!1):Promise.resolve(!1)),ci=l=>typeof navigator>"u"||!("gpu"in navigator)?"unavailable":Gt?.state(Ke(l))??"idle";typeof window<"u"&&(window.Brimkern={embed:ai,createSession:rn,generate:oi,preload:ui,status:ci,runtime:ei});})();
