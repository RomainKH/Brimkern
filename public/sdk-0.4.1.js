...
- Size EU 41: 26.0 cm (US 8.0)`)],"I wear a 41, what is that in cm?"),assistant:"A size 41 is 26.0 cm."},{user:r([e("Returns","Returns are free within 14 days. Refunds are issued within 3 working days.")],"How long do I have to return an item?"),assistant:"You have 14 days to return an item."},{user:r([],"Who won the 1998 World Cup?"),assistant:"I do not have that information in my notes."},{user:t([],"Are you a robot?"),assistant:"I am an automated assistant, yes. How can I help?"}]}function ss(l={}){pr(l);let e=st(l.model),r=l.maxTokens||220,t=l.knowledge,n=Ft(l),s=ot(l),i=ut(l.history),a=[],o=rs(),u=!1,c=!1,d=!1,f=()=>l.temperature??(t?.25:.55),p=pt(l.tools),g=m=>{if(u)throw new Error(`brimkern: ${m} impossible pendant une g\xE9n\xE9ration`)};return{async ask(m,b={}){if(c)throw new Error("session d\xE9truite");if(u)throw new Error("g\xE9n\xE9ration d\xE9j\xE0 en cours sur cette session");u=!0,i.push({role:"user",content:m}),o.emit("message",{role:"user",content:m});try{let v=await Et(p,m,s);for(let w of v)o.emit("tool",w);let{text:_,sources:G,conversationnel:q}=n.userTurn(m,gt(v,s));a=G,b.onSources?.(G);let C=[...i.slice(0,-1),{role:"user",content:_}],E=await at();await E.preload(e,(w,h)=>o.emit("progress",w,h)),d||(d=!0,o.emit("ready"));let A={url:e,history:C,system:n.system(m),maxTokens:r,temperature:f(),pinned:n.pinned},k=await E.turn(A,b.onToken,b.signal);return b.signal?.aborted?(i.pop(),""):(q&&jt(k,s)&&(k=ns[s?"fr":"en"].aide),i.push({role:"assistant",content:k}),o.emit("message",{role:"assistant",content:k,sources:G}),k)}catch(v){throw i.pop(),o.emit("error",v instanceof Error?v:new Error(String(v))),v}finally{u=!1}},reset(){i=[],a=[]},destroy(){c=!0,i=[],a=[],o.clear()},get history(){return i.slice()},get lastSources(){return a.slice()},setHistory(m){g("setHistory"),i=ut(m)},setKnowledge(m){g("setKnowledge"),t=m,n=Ft({...l,knowledge:m}),a=[]},on:o.on}}function wi(){if(document.getElementById("bk-style"))return;let l=document.createElement("style");l.id="bk-style",l.textContent=`
